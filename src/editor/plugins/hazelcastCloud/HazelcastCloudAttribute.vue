<template>
  <div class="hazelcastNode nodeStyle">
    <head>
    ...
    <div class="nodeBody">
      ...
      <el-form class="e-form" label-position="top" :model="model" ref="form" :disabled="disabled">
        ...
        <el-form-item :label="$t('editor.choose') + ' Hazelcast'" prop="connectionId" :rules="rules" required>
          <el-select
            :filterable="!databaseLoading"
            :loading="databaseLoading"
            v-model="model.connectionId"
            :placeholder="$t('message.placeholderSelect') + 'Hazelcast'"
            :clearable="true"
          >
            <el-option
  ...
  data() {
    return {
      ...
      model: {
        ...
        databaseType: 'hazelcast_cloud_cluster',
        tableName: '',
        field_process: [],
        stageId: '',
        showBtn: true,
