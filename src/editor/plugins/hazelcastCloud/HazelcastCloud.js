...
import HazelcastCloudAttribute from './HazelcastCloudAttribute'
import { FORM_DATA_KEY } from '../../constants'
import i18n from '@/i18n'

export const HazelcastCloudNodeConfig = {
  type: 'app.HazelcastCloud',
  shape: {
    extends: 'app.BaseElement',
    defaultInstanceProperties: {
      attrs: {
        image: {
          xlinkHref: 'static/editor/hazelcast.svg'
        },
        label: {
          text: 'Hazelcast Cloud'
        }
      },
      [FORM_DATA_KEY]: {
  ...
  stencil: {
    ...
    attrs: {
      root: {
        dataTooltip: i18n.t('dag_data_node_label_dameng'),
   ...
   */
  settingFormConfig: {
    component: HazelcastCloudAttribute
  }
}
