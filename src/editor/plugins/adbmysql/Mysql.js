...
import MySQLAttribute from './MysqlAttribute'
import { FORM_DATA_KEY } from '../../constants'
import i18n from '@/i18n'

export const AdbMySQLConfig = {
  type: 'app.ADBMysqlNode',
  shape: {
    extends: 'app.BaseElement',
    defaultInstanceProperties: {
      attrs: {
        image: {
          xlinkHref: 'static/editor/adb_mysql.svg'
        },
        label: {
          text: 'ADB MySQL'
        }
