...
import VikaAttribute from './VikaAttribute'
import { FORM_DATA_KEY } from '../../constants'
import i18n from '@/i18n'

export const VikaNodeConfig = {
  type: 'app.VikaNode',
  shape: {
    ...
    defaultInstanceProperties: {
      attrs: {
        image: {
          xlinkHref: 'static/editor/o-vika.svg'
        },
        label: {
          text: 'Vika'
        }
  ...
  stencil: {
    ...
    attrs: {
      root: {
        dataTooltip: i18n.t('editor.cell.data_node.VikaText'),
      ...
      image: {
        xlinkHref: 'static/editor/vika.svg',
        refWidth: '60%',
        refHeight: '60%',
        refX: '2%',
        refY: '0%'
