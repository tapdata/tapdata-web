  ...
  <div class="hiveNode nodeStyle">
    ...
    <div class="nodeBody">
      ...
      <el-form class="e-form" label-position="top" :model="model" ref="form" :disabled="disabled">
        ...
        <el-form-item :label="$t('editor.choose') + ' ADB Postgres'" prop="connectionId" :rules="rules" required>
          <el-select
            :filterable="!databaseLoading"
            :loading="databaseLoading"
            v-model="model.connectionId"
            :placeholder="$t('message.placeholderSelect') + 'ADB Postgres'"
            :clearable="true"
          >
            <el-option
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      result.name = result.tableName || 'ADB PostgreSQL'
      return result
    },
