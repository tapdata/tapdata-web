...
import PostgresAttribute from './PostgresAttribute'
import { FORM_DATA_KEY } from '../../constants'
import i18n from '@/i18n'

export const PostgresConfig = {
  type: 'app.AdbPostgres',
  shape: {
    extends: 'app.BaseElement',
    defaultInstanceProperties: {
      attrs: {
        image: {
          xlinkHref: 'static/editor/adb_postgres.svg'
        },
        label: {
          text: 'ADB Postgres'
        }
  ...
  stencil: {
    ...
    attrs: {
      root: {
        dataTooltip: i18n.t('editor.cell.data_node.kuduText'),
