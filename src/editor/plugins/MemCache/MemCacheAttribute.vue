    ...
    <div class="nodeBody">
      ...
      >
        ...
        <div class="code-template">
          ...
          <div class="code">
            <span class="color-primary">var</span> cache = CacheService.getCache( "<span class="color-danger">{{ model.cacheName || "cachename" }}</span>" );<br />
  ...
  methods: {
    setData(data, cell, isSourceDataNode, vueAdapter) {
      ...
      if (schema && schema.sourceSchema) {
        ...
        if (!cacheKeys) {
          let field = this.sourceSchemaFields.find(
            field => field.primary_key_position === 1
          );
          cacheKeys = field
            ? field.field_name
            : this.sourceSchemaFields[0].field_name;
        }
      }
