export default {
  ...
  connection_list_creat_connection: '创建连接',
  ...
  connection_form_hazecast_name_rules: '以中英文开头，1-100个字符，包括中英文，数字，下划线，下划线，空格',
  connection_form_hazecast_no_name: '连接名不能为空',
  connection_form_hazecast_name_exists: '名字已经存在',
  ...
  connection_form_hazecast_confirm_create_content: '你想放弃连接的创建吗？', //是否必须放弃创建该连接？
  connection_form_hazecast_confirm_edit_content: '要放弃修改内容吗？', //是否放弃修改内容？
