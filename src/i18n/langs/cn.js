...
const cn = {
	...
	role: {
		...
		roleNavName: {
			...
			migration_category_management: '迁移任务分类管理',
			migration_category_application: '迁移任务分类应用',
			migration_job_creation: '迁移任务创建',
			migration_job_delete: '迁移任务删除',
			migration_job_edition: '迁移任务编辑',
			...
			SYNC_job_creation: '同步任务创建',
			SYNC_job_delete: '同步任务删除',
			SYNC_job_edition: '同步任务编辑',
			SYNC_job_operation: '同步任务操作',
			SYNC_job_import: '同步任务导入',
			SYNC_job_export: '同步任务导出',
