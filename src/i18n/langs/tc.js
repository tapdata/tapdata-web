...
const tc = {
	...
	role: {
		...
		roleNavName: {
			...
			database_migration: '數據庫遷移',
			migration_category_management: '遷移任務分類管理',
			migration_category_application: '遷移任務分類應用',
			migration_job_creation: '遷移任務創建',
			migration_job_delete: '遷移任務刪除',
			migration_job_edition: '遷移任務編輯',
			migration_job_operation: '遷移任務操作',
			migration_job_import: '遷移任務導入',
			migration_job_export: '遷移任務導出',
			migration_Function_management: '函數管理',
			Data_SYNC: '數據同步',
			SYNC_category_management: '同步任務分類管理',
			SYNC_category_application: '同步任務分類應用',
			SYNC_job_creation: '同步任務創建',
			SYNC_job_delete: '同步任務刪除',
			SYNC_job_edition: '同步任務編輯',
			SYNC_job_operation: '同步任務操作',
			SYNC_job_import: '同步任務導入',
			SYNC_job_export: '同步任務導出',
			SYNC_Function_management: '函數管理',
			Data_verify: '數據校驗',
			verify_job_creation: '校驗任務創建',
			verify_job_edition: '校驗任務編輯',
			verify_job_delete: '校驗任務刪除',
			...
			data_catalog_edition: '數據目錄編輯',
			new_model_creation: '模型新建',
			data_quality: '數據質量',
			data_quality_edition: '數據質量編輯',
			data_rules: '數據規則',
			...
			API_category_application: 'API發布分類應用',
			API_category_management: 'API發布分類管理',
			API_creation: 'API創建',
			API_delete: 'API刪除',
			API_edition: 'API編輯',
			API_publish: 'API發布',
			...
			API_stats: 'API統計分析',
			API_clients: 'API客戶端',
			API_clients_amangement: 'API客戶端管理',
			API_server: 'API服務器',
