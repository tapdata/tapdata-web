...
const tc = {
	...
	role: {
		...
		roleNavName: {
			...
			Data_SYNC: '遷移 & 數據同步',
			SYNC_category_management: '遷移 & 同步任務分類管理',
			SYNC_category_application: '遷移 & 同步任務分類應用',
			SYNC_job_creation: '遷移 & 同步任務創建',
			SYNC_job_delete: '遷移 & 同步任務刪除',
			SYNC_job_edition: '遷移 & 同步任務編輯',
			SYNC_job_operation: '遷移 & 同步任務操作',
			SYNC_job_import: '遷移 & 同步任務導入',
			SYNC_job_export: '遷移 & 同步任務導出',
