	...
	dataForm: {
		...
		form: {
			...
			file: {
				...
				agentLocationFileTip: '以URI的方式配置MongoDB數據庫，支持批量輸入',
				ftpTip: '按照Host, port, 賬號, 密碼的方式配置MongoDB數據庫，支持批量輸入',
				shared: '共享文件夾',
				sharedTip: '按照Host, port, 賬號, 密碼的方式配置MongoDB數據庫，支持批量輸入',
				activeConnectionMode: '主動連接模式',
				activeConnectionModeTip: '按照Host, port, 賬號, 密碼的方式配置MongoDB數據庫，支持批量輸入',
				passiveConnectionMode: '被動連接模式',
				passiveConnectionModeTip: '按照Host, port, 賬號, 密碼的方式配置MongoDB數據庫，支持批量輸入',
				input_number: '請輸入數字',
