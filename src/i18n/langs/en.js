...
const en = {
	...
	role: {
		...
		page: {
			Dashboard_menu: 'Console (Home)',
			datasource_menu: 'Datasource',
			Data_SYNC_menu: 'Migration & Data Synchronization',
			Data_verify_menu: 'Data verification',
			data_catalog_menu: 'Data Catalog',
			data_quality_menu: 'Data Quality',
			data_rules_menu: 'Data rules',
			time_to_live_menu: 'Data life cycle',
			data_lineage_menu: 'Data Map',
			API_management_menu: 'API release',
			API_data_explorer_menu: 'API data explorer',
			API_doc_test_menu: 'API document test',
			API_stats_menu: 'API statistical analysis',
			API_clients_menu: 'API client',
			API_server_menu: 'API server',
			data_collect_menu: 'Data collection (old version)',
			schedule_jobs_menu: 'Scheduled tasks',
			Cluster_management_menu: 'Cluster Management',
			agents_menu: 'Process Management',
			user_management_menu: 'User Management',
			role_management_menu: 'Role Management',
			system_settings_menu: 'System Settings',
			dictionary_menu: 'Dictionary template management',
			Topology_menu: 'Network Topology',
			servers_oversee_menu: 'Browse operation and maintenance'
		},
		moduleMeun: {
			Dashboard: 'Browse console (home page)',
			datasource: 'Data source',
			Data_SYNC: 'Migration & Data Synchronization',
			SYNC_Function_management: 'Function management',
			Data_verify: 'Data verification',
			data_government: 'Data governance classification',
			data_catalog: 'Data catalog',
			data_quality: 'Data quality',
			data_rules: 'Data rules',
			time_to_live: 'Data life cycle',
			data_lineage: 'Data Map',
			API_management: 'API release',
			API_data_explorer: 'API data explorer',
			API_doc_test: 'API document test',
			API_stats: 'API statistical analysis',
			API_clients: 'API clients',
			API_server: 'API server',
			data_collect: 'Data collection (old version)',
			schedule_jobs: 'Scheduled tasks',
