...
const en = {
	...
	metadata: {
		...
		details: {
			...
			typesOf: 'Type',
			owningConnection: 'Owning Connection',
			...
			foreignKeySetting: 'Foreign Key Setting',
			associationTable: 'Association Table',
			associationField: 'Association Field',
			connectionRelation: 'Relationship',
			oneone: 'one to one',
			onemany: 'one to many',
			manyone: 'many to one',
			addRelatedTable: 'Add a related table',
			enter: 'Please enter',
			...
			foreignKeyAssociation: 'Foreign key association',
			tableLayering: 'Table Layering',
			theme: 'Theme',
