...
const en = {
	...
	role: {
		...
		roleNavName: {
			...
			migration_category_management: 'migration category management',
			migration_category_application: 'migration category application',
			migration_job_creation: 'migration job creation',
			migration_job_delete: 'migration job deleting',
			migration_job_edition: 'migration job editing',
			migration_job_operation: 'migration job operation',
			migration_job_import: 'migration job import',
			migration_job_export: 'migration job export ',
			migration_Function_management: 'Function management',
			Data_SYNC: 'Data SYNC ',
			SYNC_category_management: 'SYNC category management',
			SYNC_category_application: 'SYNC category application',
			SYNC_job_creation: 'SYNC job creation',
			SYNC_job_delete: 'SYNC job deleting',
			SYNC_job_edition: 'SYNC job editing',
			SYNC_job_operation: 'SYNC job operation',
			SYNC_job_import: 'SYNC job import ',
			SYNC_job_export: 'SYNC job export ',
