...
const en = {
	...
	dataVerify: {
		...
		verifyStatusWaiting: 'Verifying phase 3-1:  verification job queuing, please wait....   Click',
		verifyStatusDraft: 'Verifying phase 3-2:  verification job scheduling, please wait...   Click',
