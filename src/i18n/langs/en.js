...
const en = {
	...
	role: {
		...
		tip: {
			system_notice: '收取系统消息通知功能',
			notice_settings: '系统消息通知设置功能',
			account_operation_history: '查看用户操作历史功能',
			datasource_category_management: '对数据源分类的新建、编辑、删除操作',
			datasource_category_application: '分类对数据源的应用操作',
			datasource_creation: '创建新的数据源功能',
			datasource_delete: '删除数据源功能',
			datasource_edition: '编辑数据源功能',
			data_transmission: '数据传输模块，关闭此模块及相关功能不可见',
			database_migration: '数据库迁移模块，关闭此模块及相关功能不可见',
			migration_category_management: '对迁移任务分类的新建、编辑、删除操作',
			migration_category_application: '分类对迁移任务的应用操作',
			migration_job_creation: '创建新的数据库迁移任务',
			migration_job_delete: '删除迁移任务功能',
			migration_job_edition: '编辑迁移任务功能',
			migration_job_operation: '对迁移任务的启动、停止、重置等操作',
			migration_job_import: '迁移任务导入功能',
			migration_job_export: '迁移任务导出功能',
			Function_management: '全局函数的应用和管理',
			Data_SYNC: '数据同步模块，关闭此模块及相关功能不可见',
			SYNC_category_management: '对同步任务分类的新建、编辑、删除操作',
			SYNC_category_application: '分类对同步任务的应用操作',
			SYNC_job_creation: '创建新的同步任务功能',
			SYNC_job_delete: '删除同步任务功能',
			SYNC_job_edition: '编辑同步任务功能',
			SYNC_job_operation: '对同步任务的启动、停止、重置等操作',
			SYNC_job_import: '同步任务导入功能',
			SYNC_job_export: '同步任务导出功能',
			Data_verify: '数据校验模块，关闭此模块及相关功能不可见',
			verify_job_creation: '创建校验任务功能',
			verify_job_edition: '编辑校验任务功能',
			verify_job_delete: '删除校验任务功能',
			verify_job_execution: '执行任务的数据校验功能',
			data_government: '数据治理模块，关闭此模块及相关功能不可见',
			data_catalog: '数据目录模块，关闭此模块及相关功能不可见',
			data_catalog_category_management: '对元数据分类的新建、编辑、删除操作',
			data_catalog_category_application: '分类对元数据的应用操作',
			data_catalog_edition: '对元数据的编辑功能',
			new_model_creation: '创建新模型的功能',
			data_quality: '数据质量模块，关闭此模块及相关功能不可见',
			data_rules: '数据规则模块，关闭此模块及相关功能不可见',
			time_to_live: '数据生命周期模块，关闭此模块及相关功能不可见',
			data_lineage: '数据地图模块，关闭此模块及相关功能不可见',
			data_publish: '数据发布模块，关闭此模块及相关功能不可见',
			API_management: 'API发布模块，关闭此模块及相关功能不可见',
			API_data_explorer: 'API数据浏览模块，关闭此模块及相关功能不可见',
			API_doc_test: 'API文档测试模块，关闭此模块及相关功能不可见',
			API_stats: 'API统计分析模块，关闭此模块及相关功能不可见',
			API_clients: 'API客户端模块，关闭此模块及相关功能不可见',
			API_server: 'API服务器模块，关闭此模块及相关功能不可见',
			data_collect: '数据采集旧版模块，关闭此模块及相关功能不可见',
			system_management: '系统管理模块，关闭此模块及相关功能不可见',
			schedule_jobs: '调度任务模块，关闭此模块及相关功能不可见',
			Cluster_management: '集群管理模块，关闭此模块及相关功能不可见',
			agents: '进程管理模块，关闭此模块及相关功能不可见',
			user_management: '用户管理模块，关闭此模块及相关功能不可见',
			role_management: '角色管理模块，关闭此模块及相关功能不可见',
			system_settings: '系统设置模块，关闭此模块及相关功能不可见'
		}
	}
};
