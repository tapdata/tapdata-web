	...
	<section class="drs-dashboard-wrapper" v-loading="loading">
		...
		<ElCard v-if="$PLATFORM !== 'dfs'">
			...
			<div class="info">
				<div>
					<span @click="jump()">
						<span class="title">总数：</span><span class="blue">{{ agentStatus.total || 0 }}</span>
					</span>
				</div>
				<div>
					<span @click="jump()">
						<span class="title">运行：</span><span class="blue">{{ agentStatus.running || 0 }}</span>
					</span>
				</div>
				<div>
					<span @click="jump()">
						<span class="title">停止：</span><span class="blue">{{ agentStatus.stopped || 0 }}</span>
					</span>
				</div>
				<div>
					<span @click="jump()">
						<span class="title">离线：</span><span class="orange">{{ agentStatus.down || 0 }}</span>
					</span>
				</div>
				<div></div>
			</div>
