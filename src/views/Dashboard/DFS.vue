      ...
      <div class="info">
        <div>
          <span @click="jump()">
            ...
            ><span class="blue">{{ totalStatus.total || 0 }}</span>
          </span>
        </div>
        <div>
          <span @click="jump()">
            <span class="title">运行：</span
            ><span class="green">{{ totalStatus.running || 0 }}</span>
          </span>
        </div>
        <div>
          <span @click="jump()">
            <span class="title">停止：</span
            ><span class="blue">{{ totalStatus.stop || 0 }}</span>
          </span>
        </div>
        <div>
          <span @click="jump()">
            <span class="title">错误：</span
            ><span class="red">{{ totalStatus.error || 0 }}</span>
          </span>
        </div>
        <div></div>
      </div>
    ...
    <ElCard>
      ...
      <div class="info">
        <div>
          <span @click="jump()">
            <span class="title">总数：</span
            ><span class="blue">{{ runningStatus.total || 0 }}</span>
          </span>
        </div>
        <div>
          <span @click="jump()">
            <span class="title">全量：</span
            ><span class="blue">{{ runningStatus.initializing || 0 }}</span>
          </span>
        </div>
        <div>
          <span @click="jump()">
            <span class="title">全量完成：</span
            ><span class="blue">{{ runningStatus.initialized || 0 }}</span>
          </span>
        </div>
        <div>
          <span @click="jump()">
            <span class="title">增量：</span
            ><span class="blue">{{ runningStatus.cdc || 0 }}</span>
          </span>
        </div>
        <div>
          <span @click="jump()">
            <span class="title">增量延迟：</span
            ><span class="orange">{{ runningStatus.Lag || 0 }}</span>
          </span>
        </div>
      </div>
    </ElCard>
  ...
  created() {
    ...
    this.$axios
      ...
      .then(data => {
        ...
        obj1.stop =
          (obj1.stopping || 0) + (obj1.draft || 0) + (obj1.paused || 0)
