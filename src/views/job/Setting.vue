    ...
    >
      <el-form-item :label="$t('dataFlow.sync_type')">
        ...
        >
          ...
          <el-radio label="initial_sync">{{
            $t('dataFlow.initial_sync')
          }}</el-radio>
          <el-radio label="cdc" :disabled="sync_typeFalg">{{
            $t('dataFlow.cdc')
          }}</el-radio>
        </el-radio-group>
        <el-popover
        ...
        >
          ...
          <span
            class="icon iconfont icon-tishi1 icontip"
            slot="reference"
          ></span>
        </el-popover>
      </el-form-item>
      <el-form-item :label="$t('dataFlow.cdcEngineFilter')">
        <el-switch
          ...
          :active-text="
            formData.cdcEngineFilter ? $t('dataFlow.yes') : $t('dataFlow.no')
          "
        ></el-switch>
      </el-form-item>
      <el-form-item :label="$t('dataFlow.stop_on_error')">
        ...
        <el-switch
          ...
          :active-text="
            formData.stopOnError ? $t('dataFlow.yes') : $t('dataFlow.no')
          "
        ></el-switch>
      </el-form-item>
      <el-form-item :label="$t('dataFlow.need_to_create_Index')">
        ...
        <el-switch
          ...
          :active-text="
            formData.needToCreateIndex ? $t('dataFlow.yes') : $t('dataFlow.no')
          "
        ></el-switch>
      </el-form-item>
      <el-form-item
        :label="$t('dataFlow.isOpenAutoDDL')"
      ...
      >
        ...
        <el-switch
          ...
          :active-text="
            formData.isOpenAutoDDL ? $t('dataFlow.yes') : $t('dataFlow.no')
          "
        ></el-switch>
        <el-popover
          popper-class="setting-popper"
      ...
      <el-form-item
        :label="$t('dataFlow.cdcDataProcess')"
        v-show="formData.sync_type !== 'initial_sync'"
      >
        <el-select
          v-model="formData.isSerialMode"
          size="mini"
          placeholder="请选择"
      ...
      <el-form-item
        :label="$t('dataFlow.cdcFetchSize')"
        v-show="formData.sync_type !== 'initial_sync'"
      >
        <el-input-number
          v-model="formData.cdcFetchSize"
          :min="1"
          :max="1000"
          size="mini"
        ></el-input-number>
      ...
      <div v-show="showMore">
        ...
        <el-form-item :label="$t('dataFlow.send_email')">
          <el-checkbox v-model="formData.emailWaring.paused">{{
            $t('dataFlow.stopped')
          }}</el-checkbox>
          <el-checkbox v-model="formData.emailWaring.error">{{
            $t('dataFlow.error')
          }}</el-checkbox>
          <el-checkbox v-model="formData.emailWaring.edited">{{
            $t('dataFlow.edited')
          }}</el-checkbox>
        ...
        >
          ...
          <el-switch
            ...
            :active-text="
              formData.isSchedule ? $t('dataFlow.yes') : $t('dataFlow.no')
            "
          ></el-switch>
        </el-form-item>
        <el-form-item
          class="flex-block"
          v-show="
            formData.isSchedule === true &&
            formData.sync_type === 'initial_sync'
          "
          prop="cronExpression"
        >
          <!-- 定期调度任务 -->
        ...
        >
          <div class="flex-block">
            ...
            >
              <span>{{
                $t('editor.cell.data_node.table.form.maximum_transaction.tip')
              }}</span>
              <span class="icon iconfont icon-tishi1" slot="reference"></span>
            </el-popover>
          </div>
