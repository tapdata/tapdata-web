    ...
    <div class="echartMain">
        ...
        >
          <div class="info-list">
            ...
            <el-tooltip :content="stage.nodeName" placement="bottom-start">
              <span class="info-text" @click="handTableName(stage)" style="color: #48b6e2; cursor: pointer">{{
                stage.nodeName
              }}</span>
            </el-tooltip>
            <el-tooltip
          ...
          <div class="info-list">
            ...
            <el-tooltip :content="stage.name" placement="bottom-start">
              <span class="info-text" @click="handDatabaseName(stage)" style="color: #48b6e2; cursor: pointer">{{
                stage.name
              }}</span>
            </el-tooltip>
            <el-tooltip
              ...
              <div v-for="(item, index) in cdcLastTimes" :key="index">
                ...
                <ul class="cdcTarget">
                  <li v-for="(childerItem, childerIndex) in item.targetList" :key="childerIndex">
                    ...
                    <span>{{ $t('dataFlow.targetLibrary') }}: {{ childerItem.targetConnectionName }} </span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <div class="echartlist">
        ...
        <div class="floatLayer">
          <span style="background-color: rgba(72, 182, 226, 0.3); color: #48b6e2"
