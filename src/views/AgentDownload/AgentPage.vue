	...
	<section :class="['agent-page', $PLATFORM]">
		...
		<div class="agent-body">
			<div class="agent-main">
				<DownInstall :downLoadType="downLoadType" v-if="installFlag" @nextStep="handleNextStep"></DownInstall>
				<VersionDownload :downLoadType="downLoadType" v-if="versionFalg" @nextStep="handleNextStep"></VersionDownload>
				<AgentList :downLoadType="downLoadType" v-if="listFalg" @nextStep="handleNextStep"></AgentList>
			</div>
		</div>
	</section>
</template>
