...
export default class {
	...
	async getAPIServerToken() {
		...
		let data =
			'grant_type=client_credentials&client_id=' + clientInfo.id + '&client_secret=' + clientInfo.clientSecret;
				...
				methods.forEach(method => {
					...
					if (collection && methodDesc['responses']) {
						...
						if (
							...
							let $ref =
								methodDesc['responses']['200']['content']['application/json']['schema']['properties'][
									'data'
								]['items']['$ref'];
