module.exports = {
  ...
  inFiles: '',
  // 忽略的目录
  ignoreDir: '.idea,i18n,dist,mock,node_modules,public,locales,locale,nodes',
  // 忽略的文件
  ignoreFile:
    'vue.config.js,VSelect.vue,VIcon.vue,const.js,zh-CN.js,zh-TW.js,en.js,ConnectionType.vue,Node.vue,TransformLoading.vue',
  // 提取的国际化key的拼接符
  suggestionJoin: '_',
