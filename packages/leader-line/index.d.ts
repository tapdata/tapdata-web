...
declare class LeaderLine {
  ...
  static pointAnchor(
    options: LeaderLine.PointAnchorOptions,
  ): LeaderLine.AnchorAttachment
  static pointAnchor(
    element: LeaderLine.Element,
    options?: LeaderLine.PointAnchorOptions,
  ): LeaderLine.AnchorAttachment
  ...
  static areaAnchor(
    element: LeaderLine.Element,
    shape?: LeaderLine.AreaAnchorShape,
    options?: LeaderLine.AreaAnchorOptions,
  ): LeaderLine.AnchorAttachment
  ...
  static pathLabel(
    options: LeaderLine.PathLabelOptions,
  ): LeaderLine.LabelAttachment
  static pathLabel(
    text: string,
    options?: LeaderLine.PathLabelOptions,
  ): LeaderLine.LabelAttachment
  ...
  hide(
    showEffectName?: LeaderLine.ShowEffectName,
    animOptions?: LeaderLine.AnimationOptions,
  ): void
  show(
    showEffectName?: LeaderLine.ShowEffectName,
    animOptions?: LeaderLine.AnimationOptions,
