...
import { defineComponent, ref, computed, reactive, set } from '@vue/composition-api'
      ...
      return (
        <div class="field-processors-tree-warp bg-body pt-2 pb-5" v-loading={this.loading}>
          ...
          <div class="field-processor-operation flex">
            ...
            <span class="flex-1 text inline-block">{i18n.t('packages_form_field_rename_index_mubiaoziduanming')}</span>
