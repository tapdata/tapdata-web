...
export class NodeType {
  ...
  getSchema() {
    console.log('getSchema.this.formSchema', this.formSchema) // eslint-disable-line
    const { formSchema } = this
    if (this.group === 'processor' && formSchema.properties.tabs && !formSchema.properties.tabs.properties.alarmTab) {
