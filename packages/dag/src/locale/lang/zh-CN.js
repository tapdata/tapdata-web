export default {
  ...
  packages_dag_compare_cannot_write: '只读',
  ...
  packages_dag_compare_result_desc: '推演结果与目标模型对比',
  ...
  packages_dag_compare_result_apply_table: '应用当前表',
  packages_dag_compare_result_undo_table: '撤销当前表',
