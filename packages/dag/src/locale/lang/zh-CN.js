export default {
  ...
  packages_dag_alarm_receivers: '告警接收对象',
  packages_dag_alarm_receiver_mode: '接收方式',
  packages_dag_alarm_receiver_system_default: '使用系统默认接收人',
  packages_dag_alarm_receiver_custom: '自定义接收对象',
  packages_dag_alarm_receiver_preview: '当前将发送至 {count} 个邮箱',
  packages_dag_alarm_receiver_system_empty:
    '系统未配置默认接收人，当前不会发送邮件告警。',
  packages_dag_alarm_receiver_empty_warning: '无有效接收人',
  packages_dag_alarm_receiver_status_system: '系统默认',
  packages_dag_alarm_receiver_status_custom: '自定义 · {count} 个有效邮箱',
  packages_dag_alarm_receiver_status_none: '无有效接收人',
  packages_dag_alarm_receiver_tab_group: '用户组',
  packages_dag_alarm_receiver_tab_user: '用户',
  packages_dag_alarm_receiver_tab_email: '邮箱',
  packages_dag_alarm_receiver_group_meta: '包含子组，{count} 个有效邮箱',
  packages_dag_alarm_receiver_no_valid_email: '当前无有效邮箱',
  packages_dag_alarm_receiver_email_invalid: '邮箱格式不正确',
  ...
  packages_dag_alarm_receiver_external_email_named:
    '任务「{name}」的名称、错误信息可能发送到外部邮箱',
  packages_dag_alarm_receiver_candidates_failed: '接收对象候选加载失败',
  packages_dag_alarm_receiver_preview_failed: '接收邮箱预览加载失败',
  packages_dag_alarm_receiver_search_group: '搜索用户组',
  packages_dag_alarm_receiver_search: '搜索用户、邮箱或用户组',
  packages_dag_alarm_receiver_search_user: '搜索用户',
  packages_dag_alarm_receiver_group_chip: '{name}（含子组）',
  packages_dag_alarm_receiver_group_emails: '{count} 个有效邮箱',
  packages_dag_alarm_receiver_group_children: '包含 {count} 个子组',
  packages_dag_alarm_receiver_group_tip:
    '{path}，{count} 个有效邮箱，包含 {children} 个子组',
  packages_dag_alarm_receiver_preview_detail: '查看明细',
  ...
  packages_dag_alarm_receiver_col_type: '类型',
  packages_dag_alarm_receiver_col_status: '状态',
  packages_dag_alarm_receiver_deleted: '已删除',
  packages_dag_alarm_receiver_type_user: '用户',
  packages_dag_alarm_receiver_type_group: '用户组',
  packages_dag_alarm_receiver_type_email: '邮箱',
  packages_dag_alarm_receiver_user_with_email: '{username}（{email}）',
  packages_dag_alarm_receiver_no_group: '暂无用户组',
  packages_dag_alarm_receiver_no_user: '暂无用户',
