export default {
  ...
  packages_dag_nodes_database_xierumeipizui: '写入每批最大等待时间(ms)',
  packages_dag_nodes_database_quanliangmeipici2: '全量每批次写入的条数',
  packages_dag_nodes_database_piliangxierutiao: '批量写入条数',
  ...
  packages_dag_nodes_table_meiciduquhang: '每次读取行数',
  ...
  packages_dag_nodes_table_lunxun: '轮询',
  packages_dag_nodes_table_rizhicdc: '日志cdc',
  packages_dag_nodes_table_tedingziduande: '特定字段的轮询方式对数据进行增量采集',
