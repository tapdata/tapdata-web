export default {
  ...
  packages_dag_records: 'Records',
  packages_dag_enable_validation: 'Enable Validation',
  packages_dag_inspect_type: 'Type',
  packages_dag_inspect_start_time: 'Start Time',
  packages_dag_inspect_end_time: 'End Time',
  packages_dag_inspect_status: 'Status',
  packages_dag_inspect_result: 'Result',
  packages_dag_inspect_type_count: 'Incremental Validation',
  packages_dag_inspect_type_hash: 'Auto Repair',
  packages_dag_inspect_type_field: 'Field Validation',
  packages_dag_inspect_type_jointField: 'Joint Field Validation',
  packages_dag_inspect_type_full: 'Full Validation',
  packages_dag_inspect_type_increment: 'Incremental Validation',
  packages_dag_inspect_status_scheduling: 'Scheduling',
  packages_dag_inspect_status_running: 'Running',
  packages_dag_inspect_status_done: 'Completed',
  packages_dag_inspect_status_error: 'Error',
  packages_dag_inspect_result_passed: 'Passed',
  packages_dag_inspect_result_failed: 'Failed',
  packages_dag_inspect_result_error: 'Error',
  packages_dag_inspect_detail_title: 'Verification Details',
  packages_dag_inspect_last_verify_time: 'Last Verification Time',
  packages_dag_inspect_source_table: 'Source Table',
  packages_dag_inspect_target_table: 'Target Table',
  packages_dag_inspect_count: 'Verification Count',
  packages_dag_inspect_diff_count: 'Data Differences: {count}',
  packages_dag_inspect_detail_tab: 'Verification Details',
  packages_dag_inspect_summary_tab: 'Verification Summary',
  packages_dag_inspect_source_field: 'Source Field',
  packages_dag_inspect_target_field: 'Target Field',
  packages_dag_inspect_value: 'Value',
  packages_dag_inspect_no_data: 'No data available',
  packages_dag_inspect_loading: 'Loading...',
  packages_dag_inspect_fetch_error: 'Failed to fetch verification details',
  packages_dag_inspect_summary_title: 'Data Differences Found',
  packages_dag_inspect_summary_desc:
    'There are {count} records with differences between source and target',
  ...
  packages_dag_inspect_ignore_records: 'Ignores',
  packages_dag_inspect_accept_records: 'Accepts',
  ...
  packages_dag_inspect_start_config_desc:
  ...
  packages_dag_applyCompareRule: 'Apply Model Comparison Rules',
  packages_dag_applyCompareRule_tip:
    'After enabling, the differences generated by model comparison will be automatically processed according to the selected rules',
  packages_dag_applyCompareRules_Missing: 'Delete Missing Fields',
  ...
  packages_dag_compare_result_desc:
    'Comparison of inferred results with target database schema',
  ...
  packages_dag_compare_result_apply_table: 'Apply Below Fields',
  packages_dag_compare_result_undo_table: 'Undo Below Fields',
  ...
  packages_dag_compare_result_alert:
    '{time1} Compare Database Model ({time2} Load), {result}',
  packages_dag_compare_no_diff: 'No Difference Found',
  packages_dag_compare_result_with_diff:
    'Found {count} Different Fields{details}',
  packages_dag_compare_result_with_diff_resolved:
    'Found {count} Different Fields, Resolved',
  packages_dag_compare_result_with_diff_partial:
    'Found {count} Different Fields, Resolved {resolved}, Remaining {remaining}',
