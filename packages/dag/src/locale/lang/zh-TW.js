export default {
  ...
  packages_dag_alarm_receivers: '告警接收對象',
  packages_dag_alarm_receiver_mode: '接收方式',
  packages_dag_alarm_receiver_system_default: '使用系統預設接收人',
  packages_dag_alarm_receiver_custom: '自訂接收對象',
  packages_dag_alarm_receiver_preview: '當前將發送至 {count} 個郵箱',
  packages_dag_alarm_receiver_system_empty:
    '系統未設定預設接收人，目前不會發送郵件告警。',
  packages_dag_alarm_receiver_empty_warning: '無有效接收人',
  packages_dag_alarm_receiver_status_system: '系統預設',
  packages_dag_alarm_receiver_status_custom: '自訂 · {count} 個有效郵箱',
  packages_dag_alarm_receiver_status_none: '無有效接收人',
  packages_dag_alarm_receiver_tab_group: '用戶組',
  packages_dag_alarm_receiver_tab_user: '用戶',
  packages_dag_alarm_receiver_tab_email: '郵箱',
  packages_dag_alarm_receiver_group_meta: '包含子組，{count} 個有效郵箱',
  packages_dag_alarm_receiver_no_valid_email: '當前無有效郵箱',
  packages_dag_alarm_receiver_email_invalid: '郵箱格式不正確',
  ...
  packages_dag_alarm_receiver_external_email_named:
    '任務「{name}」的名稱、錯誤訊息可能發送到外部郵箱',
  packages_dag_alarm_receiver_candidates_failed: '接收對象候選載入失敗',
  packages_dag_alarm_receiver_preview_failed: '接收郵箱預覽載入失敗',
  packages_dag_alarm_receiver_search_group: '搜尋用戶組',
  packages_dag_alarm_receiver_search: '搜尋用戶、郵箱或用戶組',
  packages_dag_alarm_receiver_search_user: '搜尋用戶',
  packages_dag_alarm_receiver_group_chip: '{name}（含子組）',
  packages_dag_alarm_receiver_group_emails: '{count} 個有效郵箱',
  packages_dag_alarm_receiver_group_children: '包含 {count} 個子組',
  packages_dag_alarm_receiver_group_tip:
    '{path}，{count} 個有效郵箱，包含 {children} 個子組',
  packages_dag_alarm_receiver_preview_detail: '查看明細',
  ...
  packages_dag_alarm_receiver_col_type: '類型',
  packages_dag_alarm_receiver_col_status: '狀態',
  packages_dag_alarm_receiver_deleted: '已刪除',
  packages_dag_alarm_receiver_type_user: '用戶',
  packages_dag_alarm_receiver_type_group: '用戶組',
  packages_dag_alarm_receiver_type_email: '郵箱',
  packages_dag_alarm_receiver_user_with_email: '{username}（{email}）',
  packages_dag_alarm_receiver_no_group: '暫無用戶組',
  packages_dag_alarm_receiver_no_user: '暫無用戶',
