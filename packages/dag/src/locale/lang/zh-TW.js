export default {
  ...
  packages_dag_compare_cannot_write: '只讀',
  ...
  packages_dag_compare_result_desc: '推演結果與目標模型對比',
  ...
  packages_dag_compare_result_apply_table: '應用當前表',
  packages_dag_compare_result_undo_table: '撤銷當前表',
