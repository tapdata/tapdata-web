export default {
  ...
  packages_form_dag_dialog_field_mapping_tittle_field_name:
    'Modify the target table field name',
  packages_form_dag_dialog_field_mapping_tittle_data_type:
    'Modify the target table field type',
  packages_form_dag_dialog_field_mapping_tittle_precision:
    'Modify the length of the target field',
  packages_form_dag_dialog_field_mapping_tittle_scale:
    'Modify the precision of the target table',
  packages_form_dag_dialog_field_mapping_tittle_value:
    'Modify the default value of the target table field',
  packages_form_dag_dialog_field_mapping_error_range:
    'The current value does not meet the field range',
  packages_form_editor_cell_processor_field_form_expression:
    'Please enter an expression',
  packages_form_queryBuilder_addCond: 'field Cond',
  packages_form_editor_cell_link_copySourceDatabase:
    'Source database schema to be copied',
  ...
  packages_form_editor_cell_link_migrationSetting:
    'Tables to be copied selection',
  ...
  packages_form_common_placeholder_search_input:
  ...
  packages_form_component_table_selector_not_checked:
    'You have not selected a table',
  ...
  packages_form_component_table_selector_error:
    'Selected tables has exceptions',
  ...
  packages_form_clipboard_dialog_dialog_huoquchuangjianming:
    'Get the creation command',
  packages_form_ddl_event_checkbox_index_mubiaozanbuzhi:
    'The target does not support DDL',
  ...
  packages_form_example_file_index_dayudengyuxiao:
  ...
  packages_form_field_mapping_dialog_bianjituiyanjie:
    'Edit the deduction result',
  ...
  packages_form_js_processor_index_qingqiuchaoshiqing:
  ...
  packages_form_table_rename_index_yixiacaozuojin:
    'The following operations take effect for all original table names',
  ...
  packages_form_field_inference_dialog_cunzaicuowuge:
    'There is an error format',
  packages_form_field_inference_dialog_cankaogeshiv:
    'Reference format: varchar(32)',
  packages_form_field_inference_dialog_xiugaihoudelei: 'Modified type',
  packages_form_field_inference_dialog_mubiaomorentui:
    'Target default inference type',
  ...
  packages_form_field_inference_list_duidangqiantuiyan:
    'Batch adjustment to the current deduction type',
  ...
  packages_form_field_inference_main_gepiliangxiugai:
    'batch modification rule taking effect',
  ...
  packages_form_field_type_rules_main_piliangxiugaizi:
    'Batch modify field type',
  packages_form_load_schema_tree_button_title: 'Load Schema',
  packages_form_field_inference_dialog_mubiaoleixingpi:
    'Target type batch modification rules',
  packages_form_field_inference_list_ninquerenyaohui:
    'Are you sure you want to restore the current table? ',
  packages_form_field_inference_main_ninquerenyaoquan:
    'Are you sure you want to restore all the defaults? ',
