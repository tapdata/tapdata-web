export default {
  ...
  packages_form_dag_dialog_field_mapping_tittle_field_name:
    'Please modify the field name in the target table',
  packages_form_dag_dialog_field_mapping_tittle_data_type:
    'Please modify the field type in the target table',
  packages_form_dag_dialog_field_mapping_tittle_precision:
    'Please modify the field length in the target table',
  packages_form_dag_dialog_field_mapping_tittle_scale:
    'Please modify the precision in the target table',
  ...
  packages_form_editor_cell_link_copySourceDatabase:
    'Need to replicate the schema of the source database',
  ...
  packages_form_field_mapping_dialog_bianjituiyanjie:
    'Please modify or revise the deduction result',
  ...
  packages_form_field_processor_index_other_commonly_used_conversions:
    'Other commonly used conversions',
  ...
  packages_form_table_rename_index_yixiacaozuojin:
    'The following operations will affect all original table names',
