...
import { composeExport, transformComponent, resolveComponent, SlotTypes } from '@formily/element-plus/esm/__builtins__'
...
export const Checkbox = composeExport(connect(CheckboxOption, mapProps({ value: 'modelValue' })), {
  Group: CheckboxGroup,
})
