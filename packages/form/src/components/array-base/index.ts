...
import { FragmentComponent, useField, useFieldSchema, ExpressionScope } from '@formily/vue'
...
import { stylePrefix } from '@formily/element-plus/esm/__builtins__/configs'
import { composeExport } from '@formily/element-plus/esm/__builtins__/shared'
...
const ArrayBaseRemove = defineComponent<ElButtonProps & { title?: string; index?: number }>({
...
const ArrayBaseMoveDown = defineComponent<ElButtonProps & { title?: string; index?: number }>({
...
const ArrayBaseMoveUp = defineComponent<ElButtonProps & { title?: string; index?: number }>({
