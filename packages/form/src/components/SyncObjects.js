  ...
  defineComponent({
    ...
    data() {
      return {
        ...
        sourceData: [],
        tables: [],
        titles: [this.$t('packages_form_editor_cell_link_migrationObjece'), this.$t('packages_form_editor_cell_link_chosen')],
    ...
    render() {
      ...
      return (
        <div class="sync-object-item-wrap">
          <el-form-item>
            <div class="e-label">
              <label class="el-form-item__label">{$t('packages_form_editor_cell_link_copySourceDatabase')}</label>
              <el-popover
                class="align-middle"
                placement="top-start"
                width="400"
              ...
              >
                <span>{$t('packages_form_editor_cell_link_formTip')}</span>
              </el-popover>
            </div>
          ...
          <el-form-item class="transfer-item">
            <div class="el-form-item is-required flex">
              <label class="el-form-item__label flex-grow-1">{$t('packages_form_editor_cell_link_migrationSetting')}</label>
              <el-button
                class="e-button"
                size="mini"
              ...
              >
                {$t('packages_form_dataFlow_changeName')}
              </el-button>
              <el-button
                size="mini"
                class="e-button ml-2"
              ...
              >
                {$t('packages_form_editor_cell_link_reduction')}
              </el-button>
            </div>
            <div class="transfer flex-fill">
              <el-transfer
                ...
                filter-placeholder={$t('packages_form_editor_cell_link_searchContent')}
                v-model={this.tables}
          ...
          <el-dialog
            title={$t('packages_form_editor_cell_link_batchRename')}
          ...
          >
            {
              <el-form props={{ model: this.model }} disabled={this.disabled}>
                <el-row gutter={80} class="e-row">
                  <el-col span={12}>
                    <el-form-item label={$t('packages_form_editor_cell_link_prefixPlaceholder')}>
                      <el-input
                        v-model={this.model.table_prefix}
                        autocomplete="off"
                        maxlength="20"
                        show-word-limit={true}
                        placeholder={$t('packages_form_editor_cell_link_prefixPlaceholder')}
                      />
                    </el-form-item>
                  </el-col>
                  <el-col span={12}>
                    <el-form-item label={$t('packages_form_editor_cell_link_suffixPlaceholder')}>
                      <el-input
                        v-model={this.model.table_suffix}
                        autocomplete="off"
                        maxlength="20"
                        show-word-limit
                        placeholder={$t('packages_form_editor_cell_link_suffixPlaceholder')}
                      />
                    </el-form-item>
                  </el-col>
                </el-row>
            ...
            <div class="text">
              {$t('packages_form_editor_cell_link_tableNameExample')}: {this.model.table_prefix}
              {this.exampleName}
              {this.table_suffix}
            </div>
            <div slot="footer" class="dialog-footer">
              <el-button on={{ click: () => (this.dialogVisible = false) }}>{$t('packages_form_dataVerify_cancel')}</el-button>
              <el-button type="primary" onClick={this.confirm}>
                {$t('packages_form_dataVerify_confirm')}
              </el-button>
            </div>
          </el-dialog>
        </div>
