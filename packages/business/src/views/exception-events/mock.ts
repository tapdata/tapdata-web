...
const rows: DqlEventDetail[] = [
  {
    ...
    stage: 'TARGET',
    captureSeq: 821903,
    eventKeys: [{ type: 'PRIMARY_KEY', values: { order_id: 1009821 } }],
    payloadFormat: 'JSON',
    payloadSize: 872,
  ...
  },
  {
    ...
    stage: 'TRANSFORM',
    captureSeq: 821876,
    eventKeys: [{ type: 'PRIMARY_KEY', values: { order_id: 1009819 } }],
    payloadFormat: 'JSON',
    payloadSize: 1254,
    payloadComplete: true,
    payloadPreview: {
  ...
  },
  {
    ...
    stage: 'TARGET',
    captureSeq: 88211,
    eventKeys: [{ type: 'UNIQUE_INDEX', name: 'uk_member_mobile', values: { mobile: '***0921' } }],
    payloadFormat: 'JSON',
    payloadSize: 671,
    payloadComplete: true,
  ...
  },
  {
    ...
    stage: 'TRANSFORM',
    captureSeq: 821102,
    eventKeys: [{ type: 'PRIMARY_KEY', values: { item_id: 900112 } }],
    payloadFormat: 'JSON',
    payloadSize: 512,
    payloadComplete: true,
    payloadPreview: {
  ...
  },
  {
    ...
    stage: 'TARGET',
    captureSeq: 44821,
    eventKeys: [{ type: 'PRIMARY_KEY', values: { sku: 'SKU-2048' } }],
    payloadFormat: 'JSON',
    payloadSize: 634,
    payloadComplete: true,
    payloadPreview: {
