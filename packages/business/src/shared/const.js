...
export const CONNECTION_STATUS_MAP = {
  ready: {
    text: i18n.t('packages_business_connection_list_efficient'),
    type: 'success',
  },
  invalid: {
    text: i18n.t('packages_business_connection_list_invalidation'),
    type: 'danger',
  },
  testing: {
    text: i18n.t('packages_business_connection_list_testing'),
    type: 'warning',
  },
}
...
export const TASK_STATUS_MAP = {
  running: {
    text: i18n.t('packages_business_status_running'),
    icon: 'yunxingzhong',
    type: 'success',
  },
  paused: {
    text: i18n.t('packages_business_status_paused'),
    icon: 'daiqidong',
  },
  error: {
    text: i18n.t('packages_business_status_error'),
    icon: 'cuowu',
    type: 'warning',
  },
  draft: { text: i18n.t('packages_business_status_draft'), icon: 'daiqidong' },
  scheduled: {
    text: i18n.t('packages_business_status_scheduled'),
    icon: 'qidongzhong',
    type: 'success',
  },
  stopping: {
    text: i18n.t('packages_business_status_stopping'),
    icon: 'tingzhizhong',
    type: 'success',
  },
  'force stopping': {
  ...
  finished: {
    text: i18n.t('packages_business_status_finished'),
    icon: 'yiwancheng',
    type: 'success',
  },
}
...
export const MILESTONE_STATUS_MAP = {
  ...
  error: {
    text: i18n.t('packages_business_milestone_list_status_error'),
    icon: 'cuowu',
  },
  finish: {
    text: i18n.t('packages_business_milestone_list_status_finish'),
    icon: 'yiwancheng',
  },
  paused: {
    text: i18n.t('packages_business_milestone_list_status_stopping'),
    icon: 'yizanting',
  },
}
...
export const ETL_STATUS_MAP = {
  ...
  error: {
    text: i18n.t('packages_business_task_status_error'),
    type: 'danger',
  },
}
...
export const ETL_SUB_STATUS_MAP = {
  ...
  scheduling: {
    text: i18n.t('packages_business_status_scheduling'),
    type: 'scheduling',
  },
  schedule_failed: {
    text: i18n.t('packages_business_status_schedule_failed'),
    type: 'schedule_failed',
  },
  wait_run: {
    text: i18n.t('packages_business_status_wait_run'),
    type: 'wait_run',
  },
  running: {
    text: i18n.t('packages_business_status_running'),
  ...
  complete: {
    text: i18n.t('packages_business_status_complete'),
    type: 'complete',
  },
