  ...
  >
    <ElForm ref="form" label-position="left" label-width="150px" :model="form" class="my-n6">
      <ElFormItem
        ...
        prop="roleId"
      >
        <ElSelect v-model:value="form.roleId" size="mini" @change="getData">
      ...
      <ElFormItem
        ...
        prop="checked"
      >
        <ElCheckboxGroup v-model:value="form.checked" size="mini" class="inline-flex ml-4" @change="handleChange">
          <ElCheckbox
            v-for="item in items"
            :label="item.value"
            :key="item.value"
