        ...
        <template v-slot:statusLabel="scope">
          ...
          >
            <span
              ...
              >{{ $t('public_task_mission_error') }}</span
            >
          </div>
    ...
    wholeItems() {
          ...
          case 'FINISH':
            ...
            switch (el.key) {
              ...
              case 'DATA_NODE_INIT':
                Object.assign(el, {
                  dataDesc: `, ${i18n.t(
                    'public_milestone_connection_succeeded'
                  )},  ${i18n.t(
              ...
              case 'CDC':
                ...
                Object.assign(el, {
                  dataDesc: `, ${i18n.t(
                    'public_milestone_time_cdc_consuming'
                  )} ${time}, ${begin}`,
                })
                break
            }
      ...
      result.unshift({
        ...
        desc: i18n.t('packages_business_milestone_list_finish', {
          ...
          val2: len,
          val3:
            result[currentLen - 1].label + ' ' + result[currentLen - 1].desc,
        }),
      })
