...
<p>適用於目標端為 Oracle 等會自動把空字符串轉換為 NULL 的數據庫，避免因數據庫語義差異導致的字段不一致誤報。</p>`,
  ...
  packages_business_task_dql_event: 'DQL異常事件進入DLQ',
  packages_business_task_dql_save_failed: 'DQL異常事件寫入DLQ失敗',
  packages_business_task_dql_recovery_failed: 'DQL人工重處理批次失敗',
  packages_business_task_dql_storm_guard: 'DQL異常事件風暴保護觸發',
  packages_business_dql_source_table: '來源表',
  packages_business_dql_target_table: '目標表',
  packages_business_dql_event_id: '異常事件 ID',
  packages_business_dql_dml_type: 'DML 類型',
  packages_business_dql_error_type: '錯誤類型',
  packages_business_dql_error_code: '錯誤碼',
  packages_business_dql_classification_reason: '分類原因',
  packages_business_dql_safe_reason: '安全錯誤原因',
  packages_business_dql_pending_count: '目前待處理數量',
  packages_business_dql_task_id: '任務 ID',
  packages_business_dql_batch_id: '重處理批次 ID',
  packages_business_dql_operator: '操作人',
  packages_business_dql_recovery_status: '重處理狀態',
  packages_business_dql_selected_count: '選擇數量',
  packages_business_dql_success_count: '成功數量',
  packages_business_dql_failed_count: '失敗數量',
  packages_business_dql_skipped_count: '跳過數量',
  packages_business_dql_remaining_count: '剩餘待處理數量',
  packages_business_dql_failed_at: '首次失敗時間',
  packages_business_dql_page_url: '異常事件頁面',
  packages_business_dql_alarm_date: '告警時間',
  packages_business_dql_guard_key: '保護鍵',
  packages_business_dql_guard_window: '保護視窗',
  packages_business_dql_guard_threshold: '保護閾值',
  packages_business_dql_suppressed_count: '預計抑制數量',
  packages_business_dql_route_decision: '路由決策',
