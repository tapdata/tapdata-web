export default {
  ...
  packages_business_setting_alarmnotification_api_server_worker_delay_p50_warn:'當APIServer工作行程每分鐘請求延時P50超過閾值時',
  packages_business_setting_alarmnotification_api_server_worker_delay_p95_warn:'當APIServer工作行程每分鐘請求延時P95超過閾值時',
  packages_business_setting_alarmnotification_api_server_worker_delay_p99_warn:'當APIServer工作行程每分鐘請求延時P99超過閾值時',
  packages_business_setting_alarmnotification_api_server_worker_error_rate_warn:'當APIServer工作行程每分鐘請求錯誤率超過告警閾值時',
  packages_business_setting_alarmnotification_api_server_worker_error_rate_alter:'當APIServer工作行程每分鐘請求錯誤率超過通知閾值時',
  packages_business_setting_alarmnotification_api_server_api_delay_avg_warn:'當任一API每分鐘請求的平均延時超過閾值時',
  packages_business_setting_alarmnotification_api_server_api_delay_p95_alter:'當任一API每分鐘請求延時P95超過閾值時',
  packages_business_setting_alarmnotification_api_server_api_delay_p99_alter:'當任一API每分鐘請求延時P99超過閾值時',
  packages_business_setting_alarmnotification_api_server_api_error_rate_alter:'當任一API每分鐘請求錯誤率超過閾值時',
  packages_business_setting_alarmnotification_api_server_all_api_error_rate_alter:'當所有API每分鐘請求錯誤率超過閾值時',
  packages_business_setting_alarmnotification_api_server_api_response_size_alter:'當任一API請求響應大小超過閾值時',
  packages_business_setting_alarmnotification_api_server_cpu_usage_warn:'當任一API Server CPU使用率超過告警閾值時',
  packages_business_setting_alarmnotification_api_server_cpu_usage_alter:'當任一API Server CPU使用率超過通知閾值時',
  packages_business_setting_alarmnotification_api_server_memory_usage_warn:'當任一API Server記憶體使用量超過告警閾值時',
  packages_business_setting_alarmnotification_api_server_memory_usage_alter:'當任一API Server記憶體使用量超過通知閾值時',
  packages_business_setting_alarmnotification_api_server_worker_cpu_usage_warn:'當任一API Server的工作行程CPU使用率超過告警閾值時',
  packages_business_setting_alarmnotification_api_server_worker_cpu_usage_alter:'當任一API Server的工作行程CPU使用率超過通知閾值時',
  packages_business_setting_alarmnotification_api_server_worker_memory_usage_warn:'當任一API Server的工作行程記憶體使用量超過告警閾值時',
  packages_business_setting_alarmnotification_api_server_worker_memory_usage_alter:'當任一API Server的工作行程記憶體使用量超過通知閾值時',
