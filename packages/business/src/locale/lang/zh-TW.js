export default {
  ...
  packages_business_milestone_list_shujujiedianchu: '數據節點初始化',
  ...
  packages_business_milestone_list_renwuchucuo: '任務出錯',
  packages_business_nodes_list_chulijiedian: '處理節點',
