export default {
  ...
  packages_business_button_bulk_import: '批量導入',
  ...
  packages_business_task_list_button_monitor: '運行監控',
  ...
  packages_business_components_connectiontypeselectorsort_jiaoyouTap:
    '交由TapaData進行全面的質量測試，以保證插件的穩定性和質量',
  ...
  packages_business_components_connectiontypeselectorsort_zhuyiBet:
    '注意：Beta版主要來自開源社區的貢獻，TapaData對其做了基本的測試，使用過程中可能會出現錯誤，如有問題可聯繫技術支持',
