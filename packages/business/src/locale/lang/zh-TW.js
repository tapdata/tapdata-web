export default {
  ...
  packages_business_dataFlow_dlq_impact_title: 'DLQ 記錄提示',
  ...
  packages_business_data_server_drawer_shuchujieguo: '响应結果',
...
<p>適用於目標端為 Oracle 等會自動把空字符串轉換為 NULL 的數據庫，避免因數據庫語義差異導致的字段不一致誤報。</p>`,
  ...
  packages_business_mongo_operator_in: '匹配數組中指定的任何值',
  packages_business_mongo_operator_lt: '匹配小於指定值的值',
  packages_business_mongo_operator_lte: '匹配小於或等於指定值的值',
  packages_business_mongo_operator_ne: '匹配所有不等於指定值的值',
  packages_business_mongo_operator_nin: '不匹配數組中指定的任何值',
  packages_business_mongo_operator_and: '使用邏輯 AND 連接查詢子句',
  packages_business_mongo_operator_nor: '使用邏輯 NOR 連接查詢子句',
  packages_business_mongo_operator_or: '使用邏輯 OR 連接查詢子句',
  packages_business_mongo_operator_exists: '匹配具有指定字段的文檔',
  ...
  packages_business_task_dlq_event: 'DLQ異常事件進入DLQ',
  packages_business_task_dlq_save_failed: 'DLQ異常事件寫入DLQ失敗',
  packages_business_task_dlq_recovery_failed: 'DLQ人工重處理批次失敗',
  packages_business_task_dlq_storm_guard: 'DLQ異常事件風暴保護觸發',
  packages_business_dlq_source_table: '來源表',
  packages_business_dlq_target_table: '目標表',
  packages_business_dlq_event_id: '異常事件 ID',
  packages_business_dlq_dml_type: 'DML 類型',
  packages_business_dlq_error_type: '錯誤類型',
  packages_business_dlq_error_code: '錯誤碼',
  packages_business_dlq_classification_reason: '分類原因',
  packages_business_dlq_safe_reason: '安全錯誤原因',
  packages_business_dlq_pending_count: '目前待處理數量',
  packages_business_dlq_task_id: '任務 ID',
  packages_business_dlq_batch_id: '重處理批次 ID',
  packages_business_dlq_operator: '操作人',
  packages_business_dlq_recovery_status: '重處理狀態',
  packages_business_dlq_selected_count: '選擇數量',
  packages_business_dlq_success_count: '成功數量',
  packages_business_dlq_failed_count: '失敗數量',
  packages_business_dlq_skipped_count: '跳過數量',
  packages_business_dlq_remaining_count: '剩餘待處理數量',
  packages_business_dlq_failed_at: '首次失敗時間',
  packages_business_dlq_page_url: '異常事件頁面',
  packages_business_dlq_alarm_date: '告警時間',
  packages_business_dlq_guard_key: '保護鍵',
  packages_business_dlq_guard_window: '保護視窗',
  packages_business_dlq_guard_threshold: '保護閾值',
  packages_business_dlq_suppressed_count: '預計抑制數量',
  packages_business_dlq_route_decision: '路由決策',
  ...
  packages_business_exception_events_dml_delete: '刪除',
  packages_business_exception_events_error_type: '錯誤類型',
  packages_business_exception_events_error_target_write: '目標寫入失敗',
  packages_business_exception_events_error_transform: '轉換失敗',
  packages_business_exception_events_error_poison_record: '不可處理記錄',
  packages_business_exception_events_error_malformed_record: '格式錯誤',
  packages_business_exception_events_error_unknown_record: '未知記錄錯誤',
  packages_business_exception_events_recovery_running: '處理中',
  packages_business_exception_events_recovery_success: '處理成功',
  ...
  packages_business_exception_events_target_table_placeholder:
    '目標表，例如 mongo.orders',
  packages_business_exception_events_failure_start_time: '失敗開始時間',
  packages_business_exception_events_failure_end_time: '失敗結束時間',
  packages_business_exception_events_apply_filters: '套用篩選',
  packages_business_exception_events_refresh: '刷新',
  packages_business_exception_events_reprocess: '重處理',
  packages_business_exception_events_task: '任務',
  packages_business_exception_events_belonging_task: '所屬任務',
  packages_business_exception_events_source_table: '來源表',
  packages_business_exception_events_target_table: '目標表',
  packages_business_exception_events_error_code: '錯誤碼',
  packages_business_exception_events_event_time: '事件時間',
  packages_business_exception_events_failure_time: '失敗時間',
  packages_business_exception_events_status: '狀態',
  packages_business_exception_events_reprocess_count: '重處理次數',
  packages_business_exception_events_last_reprocess_time: '最近重處理',
  packages_business_exception_events_operation: '操作',
  packages_business_exception_events_details: '詳情',
  packages_business_exception_events_event_details: '異常事件詳情',
  packages_business_exception_events_loading: '正在載入…',
  packages_business_exception_events_refresh_event_details: '刷新事件詳情',
  packages_business_exception_events_event_info: '事件資訊',
  packages_business_exception_events_first_failed_at: '首次失敗於 {time}',
  packages_business_exception_events_event_key_missing:
    '事件主鍵缺失，不能安全重處理',
  packages_business_exception_events_failed_node: '失敗節點',
  packages_business_exception_events_source_node: '源節點',
  packages_business_exception_events_target_node: '目標節點',
  packages_business_exception_events_business_key: '業務鍵',
  packages_business_exception_events_error_info: '錯誤資訊',
  packages_business_exception_events_payload_preview: 'Payload 預覽',
  packages_business_exception_events_payload_preview_truncated:
    'Payload 預覽已截斷，僅顯示伺服器回傳的安全預覽。',
  packages_business_exception_events_payload_incomplete:
    'Payload 不完整，當前事件不可重處理。',
  packages_business_exception_events_refresh_records: '刷新記錄',
  packages_business_exception_events_attempt_count: '{count} 次',
  packages_business_exception_events_finished_at: '完成於 {time}',
  packages_business_exception_events_confirm_batch_reprocess: '確認批量重處理',
  packages_business_exception_events_confirm_reprocess: '確認重處理',
  packages_business_exception_events_reprocess_confirm_description:
    '提交前確認任務範圍和事件數量',
  packages_business_exception_events_event_count: '{count} 筆事件',
  packages_business_exception_events_reprocess_notice:
    '將使用各任務當前已發佈配置提交原始事件。處理期間，相關任務可能短暫暫停，完成後恢復。原始 Payload 不會被修改。',
  packages_business_exception_events_events_to_submit: '待提交事件',
  packages_business_exception_events_tasks_involved: '涉及任務',
  packages_business_exception_events_task_count: '{count} 個任務',
  packages_business_exception_events_execution_order: '執行順序',
  packages_business_exception_events_event_time_order: '按事件時間',
  packages_business_exception_events_submission_list: '提交清單',
  ...
  packages_business_exception_events_data_routes_events_count:
    '{routeCount} 條資料鏈路 · {eventCount} 筆事件',
  packages_business_exception_events_failed_at: '失敗於 {time}',
  ...
  packages_business_exception_events_confirm_reprocess_with_count:
    '確認重處理 {count} 筆',
  packages_business_workflow_enabled: '啟用狀態',
  packages_business_workflow_trigger_type: '觸發方式',
  packages_business_workflow_last_result: '最近結果',
  packages_business_workflow_last_run_time: '最近運行時間',
  packages_business_workflow_duration: '耗時',
  packages_business_workflow_next_fire: '下次計劃時間',
  packages_business_workflow_all_runs: '全部運行記錄',
  packages_business_workflow_runs: '運行記錄',
  packages_business_workflow_run: '手動運行',
  packages_business_workflow_test: '試跑',
  packages_business_workflow_view_active: '查看運行中',
  packages_business_workflow_enabled_ok: '工作流已啟用',
  packages_business_workflow_suppressed: '已有運行中的實例，本次觸發已被抑制',
  packages_business_workflow_validate: '校驗',
  packages_business_workflow_validate_ok: '校驗通過',
  packages_business_workflow_validate_fail: '校驗未通過，請根據提示修改',
  packages_business_workflow_name_required: '請填寫工作流名稱',
  packages_business_workflow_name_placeholder: '請輸入工作流名稱',
  packages_business_workflow_when: '觸發器',
  packages_business_workflow_trigger_title_manual: '手動觸發',
  packages_business_workflow_trigger_title_schedule: '定時觸發',
  packages_business_workflow_trigger_title_event: '事件觸發',
  packages_business_workflow_palette: '步驟組件',
  packages_business_workflow_palette_hint: '拖到中間流程插入，或點擊添加到末尾',
  packages_business_workflow_palette_group_task: '任務',
  packages_business_workflow_palette_group_inspect: '校驗',
  packages_business_workflow_palette_group_control: '流程',
  packages_business_workflow_palette_group_action: '動作',
  packages_business_workflow_drop_hint: '將步驟拖到這裡',
  packages_business_workflow_step_type: '步驟類型',
  packages_business_workflow_step_config: '步驟配置',
  packages_business_workflow_locked_enabled: '已啟用的工作流不可編輯，請先停用',
  packages_business_workflow_locked_active: '存在活動運行，無法修改或刪除',
  packages_business_workflow_versions: '定義版本',
  packages_business_workflow_select_resource: '請選擇',
  packages_business_workflow_trigger_MANUAL: '僅手動運行',
  packages_business_workflow_trigger_MANUAL_TEST: '手動測試',
  packages_business_workflow_trigger_SCHEDULE_ONCE: '單次定時',
  packages_business_workflow_trigger_SCHEDULE_INTERVAL: '固定週期',
  packages_business_workflow_trigger_SCHEDULE_DAILY: '每日定時',
  packages_business_workflow_trigger_SCHEDULE_WEEKLY: '每週定時',
  packages_business_workflow_trigger_TASK_STARTED: '任務啟動',
  packages_business_workflow_trigger_TASK_STOPPED: '任務停止',
  packages_business_workflow_trigger_TASK_ERROR: '任務錯誤',
  packages_business_workflow_trigger_SNAPSHOT_COMPLETED: '全量完成',
  packages_business_workflow_trigger_CDC_ENTERED: '進入增量',
  packages_business_workflow_trigger_INCREMENT_DELAY_BREACHED: '增量延遲超限',
  packages_business_workflow_trigger_INSPECT_DIFF_BREACHED: '校驗差異超限',
  packages_business_workflow_step_TASK_START: '啟動任務',
  packages_business_workflow_step_TASK_STOP: '停止任務',
  packages_business_workflow_step_INSPECT_START: '執行校驗',
  packages_business_workflow_step_INSPECT_DIFF: '二次校驗',
  packages_business_workflow_step_INSPECT_REPAIR: '一鍵修復',
  packages_business_workflow_step_WAIT: '等待任務就緒',
  packages_business_workflow_step_CONDITION: '繼續條件',
  packages_business_workflow_step_IF_ELSE: 'If / Else',
  packages_business_workflow_step_ALARM: '發送告警',
  packages_business_workflow_step_WEBHOOK: '發送 Webhook',
  packages_business_workflow_step_JAVASCRIPT: '執行 JS',
  packages_business_workflow_run_CREATED: '已創建',
  packages_business_workflow_run_RUNNING: '運行中',
  packages_business_workflow_run_WAITING: '等待中',
  packages_business_workflow_run_RETRY_WAIT: '等待重試',
  packages_business_workflow_run_SUCCEEDED: '成功',
  packages_business_workflow_run_COMPLETED_WITH_WARNINGS: '完成但有警告',
  packages_business_workflow_run_CONDITION_NOT_MET: '條件未滿足',
  packages_business_workflow_run_FAILED: '失敗',
  packages_business_workflow_run_STOPPED: '已停止',
  packages_business_workflow_run_RETRYABLE: '可重試',
  packages_business_workflow_logic_and: '全部滿足',
  packages_business_workflow_logic_or: '任一滿足',
  packages_business_workflow_variable: '比較欄位',
  packages_business_workflow_condition_hint:
    '選擇要比較的欄位。任務和校驗會列出本工作流已引用的對象，不用手填 ID。告警模板變量不會出現在這裡。',
  packages_business_workflow_condition_empty_task:
    '先在觸發器或步驟中選擇任務，才會出現任務狀態、延遲等條件',
  packages_business_workflow_condition_empty_inspect:
    '先引用校驗任務，才會出現差異數、校驗結果等條件',
  packages_business_workflow_condition_empty_step:
    '把 If / Else 放在其他步驟後面，才能按上游結果分支',
  packages_business_workflow_value_ms: '毫秒',
  packages_business_workflow_task_status_retrying: '重試中',
  packages_business_workflow_inspect_status_done: '已完成',
  packages_business_workflow_inspect_result_passed: '通過',
  packages_business_workflow_inspect_result_failed: '未通過',
  packages_business_workflow_var_group_trigger: '本次觸發',
  packages_business_workflow_var_group_task: '引用的任務',
  packages_business_workflow_var_group_inspect: '引用的校驗',
  packages_business_workflow_var_group_step: '上游步驟',
  packages_business_workflow_var_group_run: '本次運行',
  packages_business_workflow_var_group_workflow: '工作流',
  packages_business_workflow_var_run_id: '運行 ID',
  packages_business_workflow_var_run_id_tip: '這次工作流運行的編號，一般不用來做業務判斷',
  packages_business_workflow_var_run_triggerType: '觸發方式',
  packages_business_workflow_var_run_triggerType_tip: '這次運行是手動、定時還是任務事件觸發的',
  packages_business_workflow_var_run_startedAt: '開始時間',
  packages_business_workflow_var_run_startedAt_tip: '運行開始的時間戳，單位毫秒',
  packages_business_workflow_var_workflow_id: '工作流 ID',
  packages_business_workflow_var_workflow_id_tip: '當前工作流的編號',
  packages_business_workflow_var_workflow_name: '工作流名稱',
  packages_business_workflow_var_workflow_name_tip: '當前工作流的名稱',
  packages_business_workflow_var_workflow_version: '工作流版本',
  packages_business_workflow_var_workflow_version_tip: '當前已發布的版本號',
  packages_business_workflow_var_trigger_taskId: '觸發來源任務',
  packages_business_workflow_var_trigger_taskId_tip: '觸發這次運行的任務 ID',
  packages_business_workflow_var_trigger_inspectId: '觸發來源校驗',
  packages_business_workflow_var_trigger_inspectId_tip: '觸發這次運行的校驗任務 ID',
  packages_business_workflow_var_trigger_observedValue: '觸發時的觀測值',
  packages_business_workflow_var_trigger_observedValue_tip: '觸發瞬間記下的指標，例如延遲毫秒或差異條數',
  packages_business_workflow_var_trigger_delayTime: '觸發時的增量延遲',
  packages_business_workflow_var_trigger_delayTime_tip: '增量延遲超限觸發時才有值，單位毫秒',
  packages_business_workflow_var_trigger_differenceNumber: '觸發時的差異數',
  packages_business_workflow_var_trigger_differenceNumber_tip: '校驗差異超限觸發時記下的差異條數',
  packages_business_workflow_var_tasks_name: '任務名稱',
  packages_business_workflow_var_tasks_name_tip: '該任務當前的名稱',
  packages_business_workflow_var_tasks_delayTime: '當前增量延遲',
  packages_business_workflow_var_tasks_delayTime_tip: '該任務此刻的增量延遲，單位毫秒',
  packages_business_workflow_var_tasks_status: '運行狀態',
  packages_business_workflow_var_tasks_status_tip: '該任務此刻是否在運行、出錯或已停止',
  packages_business_workflow_var_tasks_cdcEntered: '是否已進入增量',
  packages_business_workflow_var_tasks_cdcEntered_tip: '該任務是否已經進入增量同步',
  packages_business_workflow_var_inspects_name: '校驗名稱',
  packages_business_workflow_var_inspects_name_tip: '該校驗任務當前的名稱',
  packages_business_workflow_var_inspects_differenceNumber: '當前差異數',
  packages_business_workflow_var_inspects_differenceNumber_tip: '該校驗此刻的差異條數',
  packages_business_workflow_var_inspects_status: '校驗狀態',
  packages_business_workflow_var_inspects_status_tip: '該校驗此刻是運行中、已完成還是失敗',
  packages_business_workflow_var_inspects_result: '校驗結果',
  packages_business_workflow_var_inspects_result_tip: '最近一次校驗是通過還是未通過',
  packages_business_workflow_var_steps_status: '步驟結果',
  packages_business_workflow_var_steps_status_tip: '該上游步驟是否已成功執行',
  packages_business_workflow_var_steps_output_differenceNumber: '步驟產出的差異數',
  packages_business_workflow_var_steps_output_differenceNumber_tip: '校驗類步驟執行後得到的差異條數',
  packages_business_workflow_var_steps_errorCode: '步驟錯誤碼',
  packages_business_workflow_var_steps_errorCode_tip: '該上游步驟失敗時的錯誤碼',
  packages_business_workflow_add_condition: '添加條件',
  packages_business_workflow_op_eq: '等於',
  packages_business_workflow_op_ne: '不等於',
  packages_business_workflow_op_gt: '大於',
  packages_business_workflow_op_gte: '大於等於',
  packages_business_workflow_op_lt: '小於',
  packages_business_workflow_op_lte: '小於等於',
  packages_business_workflow_type_string: '字串',
  packages_business_workflow_type_number: '數字',
  packages_business_workflow_type_boolean: '布林',
  packages_business_workflow_context_task: '選擇上下文任務',
  packages_business_workflow_context_task_tip: '事件或指標型工作流手動運行時，需要從觸發器清單中選擇一個任務作為本次上下文。',
  packages_business_workflow_context_missing_list: '觸發器未配置任務清單，無法選擇上下文任務',
  packages_business_workflow_fire_at: '執行時間',
  packages_business_workflow_interval_minutes: '間隔（分鐘）',
  packages_business_workflow_timezone: '時區',
  packages_business_workflow_clock: '時間（時 / 分）',
  packages_business_workflow_days_of_week: '星期',
  packages_business_workflow_weekday_1: '週一',
  packages_business_workflow_weekday_2: '週二',
  packages_business_workflow_weekday_3: '週三',
  packages_business_workflow_weekday_4: '週四',
  packages_business_workflow_weekday_5: '週五',
  packages_business_workflow_weekday_6: '週六',
  packages_business_workflow_weekday_7: '週日',
  packages_business_workflow_tasks: '任務',
  packages_business_workflow_inspects: '校驗任務',
  packages_business_workflow_threshold_seconds: '延遲閾值（秒）',
  packages_business_workflow_diff_threshold: '差異閾值',
  packages_business_workflow_predicate: '等待條件',
  packages_business_workflow_predicate_RUNNING: '運行中',
  packages_business_workflow_predicate_SNAPSHOT_DONE: '全量完成',
  packages_business_workflow_predicate_CDC_ENTERED: '進入增量',
  packages_business_workflow_join: '等待範圍',
  packages_business_workflow_join_all: '全部達到',
  packages_business_workflow_join_any: '任一達到',
  packages_business_workflow_trigger_join: '觸發條件',
  packages_business_workflow_trigger_join_tip:
    '多個任務時：任一達到即觸發；全部達到則等清單裡每一個都滿足後再觸發。已有執行中的實例時，其餘觸發會被抑制。',
  packages_business_workflow_timeout_minutes: '最長等待（分鐘）',
  packages_business_workflow_inspect_diff_tip:
    '二次校驗僅支援全表/關聯欄位值校驗，且需要已有校驗結果',
  packages_business_workflow_inspect_repair_tip:
    '一鍵修復要求關聯同步任務處於增量運行中',
  packages_business_workflow_alarm_title: '告警標題',
  packages_business_workflow_alarm_message: '告警內容',
  packages_business_workflow_alarm_email_hint:
    '執行時會寫入系統通知，並用「系統設定 → 郵件」中的 SMTP 與收件人立即寄信。可編輯 HTML 模板，點擊變數插入工作流名、任務名、校驗名等上下文。請確認已設定 smtp.server.host 與 email.receivers。',
  packages_business_workflow_alarm_template: '告警郵件模板',
  packages_business_workflow_alarm_edit_template: '編輯郵件模板',
  packages_business_workflow_alarm_restore_template: '恢復預設模板',
  packages_business_workflow_alarm_var_task_desc: '摘要',
  packages_business_workflow_alarm_var_step_name: '步驟名',
  packages_business_workflow_alarm_var_trigger_type: '觸發類型',
  packages_business_workflow_alarm_var_time: '通知時間',
  packages_business_workflow_alarm_var_details: '運行詳情',
  packages_business_workflow_webhook: 'Webhook 配置',
  packages_business_workflow_webhook_url: '請求 URL',
  packages_business_workflow_webhook_method: '請求方法',
  packages_business_workflow_webhook_token: 'Authorization（可選）',
  packages_business_workflow_webhook_token_placeholder: '寫入 Authorization 請求頭，可留空',
  packages_business_workflow_webhook_body: '請求體',
  packages_business_workflow_webhook_hint:
    '在工作流內直接設定 URL 和 JSON 請求體。點擊變數可插入工作流名、任務名、校驗名等執行時上下文。',
  packages_business_workflow_webhook_legacy_hint:
    '此步驟仍引用系統 Webhook 設定。填寫 URL 後儲存，將改為使用工作流內的設定。',
  packages_business_workflow_script: '腳本',
  packages_business_workflow_connections: '連接（可選）',
  packages_business_workflow_js_retry_tip: 'JS / Webhook 重試可能導致外部接口被重複調用',
  packages_business_workflow_retry_policy: '異常策略',
  packages_business_workflow_max_retries: '最大重試次數',
  packages_business_workflow_retry_seconds: '重試間隔（秒）',
  packages_business_workflow_exhausted: '重試耗盡後',
  packages_business_workflow_exhausted_stop: '停止工作流',
  packages_business_workflow_exhausted_skip: '跳過並繼續',
  packages_business_workflow_then: 'Then',
  packages_business_workflow_else: 'Else',
  packages_business_workflow_name: '工作流名稱',
  packages_business_workflow_id: '工作流 ID',
  packages_business_workflow_run_id: '運行 ID',
  packages_business_workflow_resume_count: '恢復次數',
  packages_business_workflow_started_by: '操作人',
  packages_business_workflow_time_range: '時間範圍',
  packages_business_workflow_resume: '從失敗步驟繼續',
  packages_business_workflow_rerun: '從頭重跑',
  packages_business_workflow_stop_confirm: '停止後不會回滾已完成的啟停、Webhook 或告警。確定停止當前運行嗎？',
  packages_business_workflow_unknown_result_tip: '外部結果未知，不能自動重放該步驟。請選擇從失敗步驟繼續或從頭重跑。',
  packages_business_workflow_wait_deadline: '等待截止時間',
  packages_business_workflow_last_resumed_by: '恢復人',
  packages_business_workflow_last_resumed_at: '恢復時間',
  packages_business_workflow_wait_progress: '尚未滿足的任務',
  packages_business_workflow_task_id: '任務 ID',
  packages_business_workflow_reason: '原因',
  packages_business_workflow_step_output: '返回值',
  packages_business_workflow_timeline: '步驟時間線',
  packages_business_workflow_suppressed_triggers: '運行期間被抑制的觸發',
}
