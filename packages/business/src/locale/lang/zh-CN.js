export default {
  ...
  packages_business_dataFlow_dlq_impact_title: 'DLQ 记录提示',
  packages_business_dataFlow_dlq_delete_impact_message:
    '当前任务存在{count}条未处理的异常事件，删除任务后异常事件将无法重运行',
  ...
  packages_business_dataFlow_dlq_bulk_delete_impact_message:
    '以下任务存在未处理的异常事件，批量删除任务后异常事件将无法重运行：',
  packages_business_dataFlow_dlq_bulk_reset_impact_message:
    '以下任务存在未处理的异常事件，批量重置任务后异常事件将无法重运行：',
  ...
  packages_business_data_server_drawer_shuchujieguo: '响应结果',
...
- 您可以将数据库表拖放到应用上，快速地发布 API
  ...
  packages_business_api_import: 'API 导入',
  packages_business_functions_import: '函数导入',
...
<p>适用于目标端为 Oracle 等会自动把空字符串转换为 NULL 的数据库，避免因数据库语义差异导致的字段不一致误报。</p>`,
  ...
  packages_business_mongo_operator_in: '匹配数组中指定的任何值',
  packages_business_mongo_operator_lt: '匹配小于指定值的值',
  packages_business_mongo_operator_lte: '匹配小于或等于指定值的值',
  packages_business_mongo_operator_ne: '匹配所有不等于指定值的值',
  packages_business_mongo_operator_nin: '不匹配数组中指定的任何值',
  packages_business_mongo_operator_and: '使用逻辑 AND 连接查询子句',
  packages_business_mongo_operator_nor: '使用逻辑 NOR 连接查询子句',
  packages_business_mongo_operator_or: '使用逻辑 OR 连接查询子句',
  packages_business_mongo_operator_exists: '匹配具有指定字段的文档',
  ...
  packages_business_example_eq: '{a} 等于 {b}',
  packages_business_example_ne: '{a} 不等于 {b}',
  packages_business_example_gt: '{a} 大于 {b}',
  packages_business_example_gte: '{a} 大于等于 {b}',
  packages_business_example_lt: '{a} 小于{b}',
  packages_business_example_lte: '{a} 小于等于 {b}',
  packages_business_example_in: '{a} 在{b} 中',
  packages_business_example_nin: '{a} 不在 {b} 中',
  packages_business_example_exists: '字段不存在',
  packages_business_example_type: '也可用数字代号，如 16 表示 int',
  ...
  packages_business_task_dlq_event: 'DLQ异常事件进入DLQ',
  packages_business_task_dlq_save_failed: 'DLQ异常事件写入DLQ失败',
  packages_business_task_dlq_recovery_failed: 'DLQ人工重处理批次失败',
  packages_business_task_dlq_storm_guard: 'DLQ异常事件风暴保护触发',
  packages_business_dlq_source_table: '源表',
  packages_business_dlq_target_table: '目标表',
  packages_business_dlq_event_id: '异常事件 ID',
  packages_business_dlq_dml_type: 'DML 类型',
  packages_business_dlq_error_type: '错误类型',
  packages_business_dlq_error_code: '错误码',
  packages_business_dlq_classification_reason: '分类原因',
  packages_business_dlq_safe_reason: '安全错误原因',
  packages_business_dlq_pending_count: '当前待处理数量',
  packages_business_dlq_task_id: '任务 ID',
  packages_business_dlq_batch_id: '重处理批次 ID',
  packages_business_dlq_operator: '操作人',
  packages_business_dlq_recovery_status: '重处理状态',
  packages_business_dlq_selected_count: '选择数量',
  packages_business_dlq_success_count: '成功数量',
  packages_business_dlq_failed_count: '失败数量',
  packages_business_dlq_skipped_count: '跳过数量',
  packages_business_dlq_remaining_count: '剩余待处理数量',
  packages_business_dlq_failed_at: '首次失败时间',
  packages_business_dlq_page_url: '异常事件页面',
  packages_business_dlq_alarm_date: '告警时间',
  packages_business_dlq_guard_key: '保护键',
  packages_business_dlq_guard_window: '保护窗口',
  packages_business_dlq_guard_threshold: '保护阈值',
  packages_business_dlq_suppressed_count: '预计抑制数量',
  packages_business_dlq_route_decision: '路由决策',
  ...
  packages_business_exception_events_dml_delete: '删除',
  packages_business_exception_events_error_type: '错误类型',
  packages_business_exception_events_error_target_write: '目标写入失败',
  packages_business_exception_events_error_transform: '转换失败',
  packages_business_exception_events_error_poison_record: '不可处理记录',
  packages_business_exception_events_error_malformed_record: '格式错误',
  packages_business_exception_events_error_unknown_record: '未知记录错误',
  packages_business_exception_events_recovery_running: '处理中',
  packages_business_exception_events_recovery_success: '处理成功',
  packages_business_exception_events_recovery_failed: '处理失败',
  packages_business_exception_events_recovery_skipped: '已跳过',
  packages_business_exception_events_recovery_timeout: '处理超时',
  packages_business_exception_events_status_all: '全部',
  packages_business_exception_events_status_pending: '待处理',
  packages_business_exception_events_status_reprocessing: '处理中',
  packages_business_exception_events_status_recovered: '已恢复',
  packages_business_exception_events_status_recovery_failed: '恢复失败',
  packages_business_exception_events_status_not_reprocessable: '不可重处理',
  packages_business_exception_events_recovery_records: '处理记录',
  packages_business_exception_events_recovery_records_empty: '暂无处理记录',
  packages_business_exception_events_refresh_recovery_records: '刷新处理记录',
  ...
  packages_business_exception_events_more_filters_description:
    '按表名或失败时间进一步缩小范围',
  packages_business_exception_events_clear: '清除',
  packages_business_exception_events_source_table_placeholder:
    '来源表，例如 mysql.orders',
  packages_business_exception_events_target_table_placeholder:
    '目标表，例如 mongo.orders',
  packages_business_exception_events_failure_start_time: '失败开始时间',
  packages_business_exception_events_failure_end_time: '失败结束时间',
  packages_business_exception_events_apply_filters: '应用筛选',
  packages_business_exception_events_refresh: '刷新',
  packages_business_exception_events_reprocess: '重处理',
  packages_business_exception_events_task: '任务',
  packages_business_exception_events_belonging_task: '所属任务',
  packages_business_exception_events_source_table: '来源表',
  packages_business_exception_events_target_table: '目标表',
  packages_business_exception_events_error_code: '错误码',
  packages_business_exception_events_event_time: '事件时间',
  packages_business_exception_events_failure_time: '失败时间',
  packages_business_exception_events_status: '状态',
  packages_business_exception_events_reprocess_count: '重处理次数',
  packages_business_exception_events_last_reprocess_time: '最近重处理',
  packages_business_exception_events_operation: '操作',
  packages_business_exception_events_details: '详情',
  packages_business_exception_events_event_details: '异常事件详情',
  packages_business_exception_events_loading: '正在加载…',
  packages_business_exception_events_refresh_event_details: '刷新事件详情',
  packages_business_exception_events_event_info: '事件信息',
  packages_business_exception_events_first_failed_at: '首次失败于 {time}',
  packages_business_exception_events_event_key_missing:
    '事件主键缺失，不能安全重处理',
  packages_business_exception_events_failed_node: '失败节点',
  packages_business_exception_events_source_node: '源节点',
  packages_business_exception_events_target_node: '目标节点',
  packages_business_exception_events_business_key: '业务键',
  packages_business_exception_events_error_info: '错误信息',
  packages_business_exception_events_payload_preview: 'Payload 预览',
  packages_business_exception_events_payload_preview_truncated:
    'Payload 预览已截断，仅展示服务端返回的安全预览。',
  packages_business_exception_events_payload_incomplete:
    'Payload 不完整，当前事件不可重处理。',
  packages_business_exception_events_refresh_records: '刷新记录',
  packages_business_exception_events_attempt_count: '{count} 次',
  packages_business_exception_events_finished_at: '完成于 {time}',
  packages_business_exception_events_confirm_batch_reprocess: '确认批量重处理',
  packages_business_exception_events_confirm_reprocess: '确认重处理',
  packages_business_exception_events_reprocess_confirm_description:
    '提交前确认任务范围和事件数量',
  packages_business_exception_events_event_count: '{count} 条事件',
  packages_business_exception_events_reprocess_notice:
    '将使用各任务当前已发布配置提交原始事件。处理期间，相关任务可能短暂暂停，完成后恢复。原始 Payload 不会被修改。',
  packages_business_exception_events_events_to_submit: '待提交事件',
  packages_business_exception_events_tasks_involved: '涉及任务',
  packages_business_exception_events_task_count: '{count} 个任务',
  packages_business_exception_events_execution_order: '执行顺序',
  packages_business_exception_events_event_time_order: '按事件时间',
  packages_business_exception_events_submission_list: '提交清单',
  ...
  packages_business_exception_events_data_routes_events_count:
    '{routeCount} 条数据链路 · {eventCount} 条事件',
  packages_business_exception_events_failed_at: '失败于 {time}',
  packages_business_exception_events_more_events_not_expanded:
    '还有 {count} 条事件未展开',
  packages_business_exception_events_temporarily_unavailable: '暂不可提交',
  packages_business_exception_events_blocked_events_description:
    '这些事件不会被提交',
  packages_business_exception_events_risky_submission: '具有风险提交',
  ...
  packages_business_exception_events_business_key_missing_risk:
    '缺少业务键，可能无法准确定位目标记录，存在重复或覆盖风险',
  packages_business_exception_events_selected_record: '所选记录',
  packages_business_exception_events_submit_in_order: '确认后将按顺序提交这些事件',
  ...
  packages_business_exception_events_confirm_reprocess_with_count:
    '确认重处理 {count} 条',
  packages_business_workflow_enabled: '启用状态',
  packages_business_workflow_trigger_type: '触发方式',
  packages_business_workflow_last_result: '最近结果',
  packages_business_workflow_last_run_time: '最近运行时间',
  packages_business_workflow_duration: '耗时',
  packages_business_workflow_next_fire: '下次计划时间',
  packages_business_workflow_all_runs: '全部运行记录',
  packages_business_workflow_runs: '运行记录',
  packages_business_workflow_run: '手动运行',
  packages_business_workflow_test: '试跑',
  packages_business_workflow_view_active: '查看运行中',
  packages_business_workflow_enabled_ok: '工作流已启用',
  packages_business_workflow_suppressed: '已有运行中的实例，本次触发已被抑制',
  packages_business_workflow_validate: '校验',
  packages_business_workflow_validate_ok: '校验通过',
  packages_business_workflow_validate_fail: '校验未通过，请根据提示修改',
  packages_business_workflow_name_required: '请填写工作流名称',
  packages_business_workflow_name_placeholder: '请输入工作流名称',
  packages_business_workflow_when: '触发器',
  packages_business_workflow_trigger_title_manual: '手动触发',
  packages_business_workflow_trigger_title_schedule: '定时触发',
  packages_business_workflow_trigger_title_event: '事件触发',
  packages_business_workflow_palette: '步骤组件',
  packages_business_workflow_palette_hint: '拖到中间流程插入，或点击添加到末尾',
  packages_business_workflow_palette_group_task: '任务',
  packages_business_workflow_palette_group_inspect: '校验',
  packages_business_workflow_palette_group_control: '流程',
  packages_business_workflow_palette_group_action: '动作',
  packages_business_workflow_drop_hint: '将步骤拖到这里',
  packages_business_workflow_step_type: '步骤类型',
  packages_business_workflow_step_config: '步骤配置',
  packages_business_workflow_locked_enabled: '已启用的工作流不可编辑，请先禁用',
  packages_business_workflow_locked_active: '存在活动运行，无法修改或删除',
  packages_business_workflow_versions: '定义版本',
  packages_business_workflow_select_resource: '请选择',
  packages_business_workflow_trigger_MANUAL: '仅手动运行',
  packages_business_workflow_trigger_MANUAL_TEST: '手动测试',
  packages_business_workflow_trigger_SCHEDULE_ONCE: '单次定时',
  packages_business_workflow_trigger_SCHEDULE_INTERVAL: '固定周期',
  packages_business_workflow_trigger_SCHEDULE_DAILY: '每日定时',
  packages_business_workflow_trigger_SCHEDULE_WEEKLY: '每周定时',
  packages_business_workflow_trigger_TASK_STARTED: '任务启动',
  packages_business_workflow_trigger_TASK_STOPPED: '任务停止',
  packages_business_workflow_trigger_TASK_ERROR: '任务错误',
  packages_business_workflow_trigger_SNAPSHOT_COMPLETED: '全量完成',
  packages_business_workflow_trigger_CDC_ENTERED: '进入增量',
  packages_business_workflow_trigger_INCREMENT_DELAY_BREACHED: '增量延迟超限',
  packages_business_workflow_trigger_INSPECT_DIFF_BREACHED: '校验差异超限',
  packages_business_workflow_step_TASK_START: '启动任务',
  packages_business_workflow_step_TASK_STOP: '停止任务',
  packages_business_workflow_step_INSPECT_START: '执行校验',
  packages_business_workflow_step_INSPECT_DIFF: '二次校验',
  packages_business_workflow_step_INSPECT_REPAIR: '一键修复',
  packages_business_workflow_step_WAIT: '等待任务就绪',
  packages_business_workflow_step_CONDITION: '继续条件',
  packages_business_workflow_step_IF_ELSE: 'If / Else',
  packages_business_workflow_step_ALARM: '发送告警',
  packages_business_workflow_step_WEBHOOK: '发送 Webhook',
  packages_business_workflow_step_JAVASCRIPT: '执行 JS',
  packages_business_workflow_run_CREATED: '已创建',
  packages_business_workflow_run_RUNNING: '运行中',
  packages_business_workflow_run_WAITING: '等待中',
  packages_business_workflow_run_RETRY_WAIT: '等待重试',
  packages_business_workflow_run_SUCCEEDED: '成功',
  packages_business_workflow_run_COMPLETED_WITH_WARNINGS: '完成但有警告',
  packages_business_workflow_run_CONDITION_NOT_MET: '条件未满足',
  packages_business_workflow_run_FAILED: '失败',
  packages_business_workflow_run_STOPPED: '已停止',
  packages_business_workflow_run_RETRYABLE: '可重试',
  packages_business_workflow_logic_and: '全部满足',
  packages_business_workflow_logic_or: '任一满足',
  packages_business_workflow_variable: '比较字段',
  packages_business_workflow_condition_hint:
    '选择要比较的字段。任务和校验会列出本工作流已引用的对象，不用手填 ID。告警模板变量不会出现在这里。',
  packages_business_workflow_condition_empty_task:
    '先在触发器或步骤中选择任务，才会出现任务状态、延迟等条件',
  packages_business_workflow_condition_empty_inspect:
    '先引用校验任务，才会出现差异数、校验结果等条件',
  packages_business_workflow_condition_empty_step:
    '把 If / Else 放在其他步骤后面，才能按上游结果分支',
  packages_business_workflow_value_ms: '毫秒',
  packages_business_workflow_task_status_retrying: '重试中',
  packages_business_workflow_inspect_status_done: '已完成',
  packages_business_workflow_inspect_result_passed: '通过',
  packages_business_workflow_inspect_result_failed: '未通过',
  packages_business_workflow_var_group_trigger: '本次触发',
  packages_business_workflow_var_group_task: '引用的任务',
  packages_business_workflow_var_group_inspect: '引用的校验',
  packages_business_workflow_var_group_step: '上游步骤',
  packages_business_workflow_var_group_run: '本次运行',
  packages_business_workflow_var_group_workflow: '工作流',
  packages_business_workflow_var_run_id: '运行 ID',
  packages_business_workflow_var_run_id_tip: '这次工作流运行的编号，一般不用来做业务判断',
  packages_business_workflow_var_run_triggerType: '触发方式',
  packages_business_workflow_var_run_triggerType_tip: '这次运行是手动、定时还是任务事件触发的',
  packages_business_workflow_var_run_startedAt: '开始时间',
  packages_business_workflow_var_run_startedAt_tip: '运行开始的时间戳，单位毫秒',
  packages_business_workflow_var_workflow_id: '工作流 ID',
  packages_business_workflow_var_workflow_id_tip: '当前工作流的编号',
  packages_business_workflow_var_workflow_name: '工作流名称',
  packages_business_workflow_var_workflow_name_tip: '当前工作流的名称',
  packages_business_workflow_var_workflow_version: '工作流版本',
  packages_business_workflow_var_workflow_version_tip: '当前已发布的版本号',
  packages_business_workflow_var_trigger_taskId: '触发来源任务',
  packages_business_workflow_var_trigger_taskId_tip: '触发这次运行的任务 ID',
  packages_business_workflow_var_trigger_inspectId: '触发来源校验',
  packages_business_workflow_var_trigger_inspectId_tip: '触发这次运行的校验任务 ID',
  packages_business_workflow_var_trigger_observedValue: '触发时的观测值',
  packages_business_workflow_var_trigger_observedValue_tip: '触发瞬间记下的指标，例如延迟毫秒或差异条数',
  packages_business_workflow_var_trigger_delayTime: '触发时的增量延迟',
  packages_business_workflow_var_trigger_delayTime_tip: '增量延迟超限触发时才有值，单位毫秒',
  packages_business_workflow_var_trigger_differenceNumber: '触发时的差异数',
  packages_business_workflow_var_trigger_differenceNumber_tip: '校验差异超限触发时记下的差异条数',
  packages_business_workflow_var_tasks_name: '任务名称',
  packages_business_workflow_var_tasks_name_tip: '该任务当前的名称',
  packages_business_workflow_var_tasks_delayTime: '当前增量延迟',
  packages_business_workflow_var_tasks_delayTime_tip: '该任务此刻的增量延迟，单位毫秒',
  packages_business_workflow_var_tasks_status: '运行状态',
  packages_business_workflow_var_tasks_status_tip: '该任务此刻是否在运行、出错或已停止',
  packages_business_workflow_var_tasks_cdcEntered: '是否已进入增量',
  packages_business_workflow_var_tasks_cdcEntered_tip: '该任务是否已经进入增量同步',
  packages_business_workflow_var_inspects_name: '校验名称',
  packages_business_workflow_var_inspects_name_tip: '该校验任务当前的名称',
  packages_business_workflow_var_inspects_differenceNumber: '当前差异数',
  packages_business_workflow_var_inspects_differenceNumber_tip: '该校验此刻的差异条数',
  packages_business_workflow_var_inspects_status: '校验状态',
  packages_business_workflow_var_inspects_status_tip: '该校验此刻是运行中、已完成还是失败',
  packages_business_workflow_var_inspects_result: '校验结果',
  packages_business_workflow_var_inspects_result_tip: '最近一次校验是通过还是未通过',
  packages_business_workflow_var_steps_status: '步骤结果',
  packages_business_workflow_var_steps_status_tip: '该上游步骤是否已成功执行',
  packages_business_workflow_var_steps_output_differenceNumber: '步骤产出的差异数',
  packages_business_workflow_var_steps_output_differenceNumber_tip: '校验类步骤执行后得到的差异条数',
  packages_business_workflow_var_steps_errorCode: '步骤错误码',
  packages_business_workflow_var_steps_errorCode_tip: '该上游步骤失败时的错误码',
  packages_business_workflow_add_condition: '添加条件',
  packages_business_workflow_op_eq: '等于',
  packages_business_workflow_op_ne: '不等于',
  packages_business_workflow_op_gt: '大于',
  packages_business_workflow_op_gte: '大于等于',
  packages_business_workflow_op_lt: '小于',
  packages_business_workflow_op_lte: '小于等于',
  packages_business_workflow_type_string: '字符串',
  packages_business_workflow_type_number: '数字',
  packages_business_workflow_type_boolean: '布尔',
  packages_business_workflow_context_task: '选择上下文任务',
  packages_business_workflow_context_task_tip: '事件或指标型工作流手动运行时，需要从触发器清单中选择一个任务作为本次上下文。',
  packages_business_workflow_context_missing_list: '触发器未配置任务清单，无法选择上下文任务',
  packages_business_workflow_fire_at: '执行时间',
  packages_business_workflow_interval_minutes: '间隔（分钟）',
  packages_business_workflow_timezone: '时区',
  packages_business_workflow_clock: '时间（时 / 分）',
  packages_business_workflow_days_of_week: '星期',
  packages_business_workflow_weekday_1: '周一',
  packages_business_workflow_weekday_2: '周二',
  packages_business_workflow_weekday_3: '周三',
  packages_business_workflow_weekday_4: '周四',
  packages_business_workflow_weekday_5: '周五',
  packages_business_workflow_weekday_6: '周六',
  packages_business_workflow_weekday_7: '周日',
  packages_business_workflow_tasks: '任务',
  packages_business_workflow_inspects: '校验任务',
  packages_business_workflow_threshold_seconds: '延迟阈值（秒）',
  packages_business_workflow_diff_threshold: '差异阈值',
  packages_business_workflow_predicate: '等待条件',
  packages_business_workflow_predicate_RUNNING: '运行中',
  packages_business_workflow_predicate_SNAPSHOT_DONE: '全量完成',
  packages_business_workflow_predicate_CDC_ENTERED: '进入增量',
  packages_business_workflow_join: '等待范围',
  packages_business_workflow_join_all: '全部达到',
  packages_business_workflow_join_any: '任一达到',
  packages_business_workflow_trigger_join: '触发条件',
  packages_business_workflow_trigger_join_tip:
    '多个任务时：任一达到即触发；全部达到则等清单里每一个都满足后再触发。已有运行中的实例时，其余触发会被抑制。',
  packages_business_workflow_timeout_minutes: '最长等待（分钟）',
  packages_business_workflow_inspect_diff_tip:
    '二次校验仅支持全表/关联字段值校验，且需要已有校验结果',
  packages_business_workflow_inspect_repair_tip:
    '一键修复要求关联同步任务处于增量运行中',
  packages_business_workflow_alarm_title: '告警标题',
  packages_business_workflow_alarm_message: '告警内容',
  packages_business_workflow_alarm_email_hint:
    '执行时会写系统通知，并用「系统设置 → 邮件」里的 SMTP 和收件人立即发信。可编辑 HTML 模板，点击变量插入工作流名、任务名、校验名等上下文。请确认已配置 smtp.server.host 与 email.receivers。',
  packages_business_workflow_alarm_template: '告警邮件模板',
  packages_business_workflow_alarm_edit_template: '编辑邮件模板',
  packages_business_workflow_alarm_restore_template: '恢复默认模板',
  packages_business_workflow_alarm_var_task_desc: '摘要',
  packages_business_workflow_alarm_var_step_name: '步骤名',
  packages_business_workflow_alarm_var_trigger_type: '触发类型',
  packages_business_workflow_alarm_var_time: '通知时间',
  packages_business_workflow_alarm_var_details: '运行详情',
  packages_business_workflow_webhook: 'Webhook 配置',
  packages_business_workflow_webhook_url: '请求 URL',
  packages_business_workflow_webhook_method: '请求方法',
  packages_business_workflow_webhook_token: 'Authorization（可选）',
  packages_business_workflow_webhook_token_placeholder: '写入 Authorization 请求头，可留空',
  packages_business_workflow_webhook_body: '请求体',
  packages_business_workflow_webhook_hint:
    '在工作流内直接配置 URL 和 JSON 请求体。点击变量可插入工作流名、任务名、校验名等运行时上下文。',
  packages_business_workflow_webhook_legacy_hint:
    '此步骤仍引用系统 Webhook 配置。填写 URL 后保存，将改为使用工作流内的配置。',
  packages_business_workflow_script: '脚本',
  packages_business_workflow_connections: '连接（可选）',
  packages_business_workflow_js_retry_tip: 'JS / Webhook 重试可能导致外部接口被重复调用',
  packages_business_workflow_retry_policy: '异常策略',
  packages_business_workflow_max_retries: '最大重试次数',
  packages_business_workflow_retry_seconds: '重试间隔（秒）',
  packages_business_workflow_exhausted: '重试耗尽后',
  packages_business_workflow_exhausted_stop: '停止工作流',
  packages_business_workflow_exhausted_skip: '跳过并继续',
  packages_business_workflow_then: 'Then',
  packages_business_workflow_else: 'Else',
  packages_business_workflow_name: '工作流名称',
  packages_business_workflow_id: '工作流 ID',
  packages_business_workflow_run_id: '运行 ID',
  packages_business_workflow_resume_count: '恢复次数',
  packages_business_workflow_started_by: '操作人',
  packages_business_workflow_time_range: '时间范围',
  packages_business_workflow_resume: '从失败步骤继续',
  packages_business_workflow_rerun: '从头重跑',
  packages_business_workflow_stop_confirm: '停止后不会回滚已完成的启停、Webhook 或告警。确定停止当前运行吗？',
  packages_business_workflow_unknown_result_tip: '外部结果未知，不能自动重放该步骤。请选择从失败步骤继续或从头重跑。',
  packages_business_workflow_wait_deadline: '等待截止时间',
  packages_business_workflow_last_resumed_by: '恢复人',
  packages_business_workflow_last_resumed_at: '恢复时间',
  packages_business_workflow_wait_progress: '尚未满足的任务',
  packages_business_workflow_task_id: '任务 ID',
  packages_business_workflow_reason: '原因',
  packages_business_workflow_step_output: '返回值',
  packages_business_workflow_timeline: '步骤时间线',
  packages_business_workflow_suppressed_triggers: '运行期间被抑制的触发',
}
