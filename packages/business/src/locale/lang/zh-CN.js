export default {
  ...
  packages_business_dataFlow_dql_impact_title: 'DQL 记录提示',
...
<p>适用于目标端为 Oracle 等会自动把空字符串转换为 NULL 的数据库，避免因数据库语义差异导致的字段不一致误报。</p>`,
  ...
  packages_business_task_dql_event: 'DQL异常事件进入DLQ',
  packages_business_task_dql_save_failed: 'DQL异常事件写入DLQ失败',
  packages_business_task_dql_recovery_failed: 'DQL人工重处理批次失败',
  packages_business_task_dql_storm_guard: 'DQL异常事件风暴保护触发',
  packages_business_dql_source_table: '源表',
  packages_business_dql_target_table: '目标表',
  packages_business_dql_event_id: '异常事件 ID',
  packages_business_dql_dml_type: 'DML 类型',
  packages_business_dql_error_type: '错误类型',
  packages_business_dql_error_code: '错误码',
  packages_business_dql_classification_reason: '分类原因',
  packages_business_dql_safe_reason: '安全错误原因',
  packages_business_dql_pending_count: '当前待处理数量',
  packages_business_dql_task_id: '任务 ID',
  packages_business_dql_batch_id: '重处理批次 ID',
  packages_business_dql_operator: '操作人',
  packages_business_dql_recovery_status: '重处理状态',
  packages_business_dql_selected_count: '选择数量',
  packages_business_dql_success_count: '成功数量',
  packages_business_dql_failed_count: '失败数量',
  packages_business_dql_skipped_count: '跳过数量',
  packages_business_dql_remaining_count: '剩余待处理数量',
  packages_business_dql_failed_at: '首次失败时间',
  packages_business_dql_page_url: '异常事件页面',
  packages_business_dql_alarm_date: '告警时间',
  packages_business_dql_guard_key: '保护键',
  packages_business_dql_guard_window: '保护窗口',
  packages_business_dql_guard_threshold: '保护阈值',
  packages_business_dql_suppressed_count: '预计抑制数量',
  packages_business_dql_route_decision: '路由决策',
