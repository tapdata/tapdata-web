export default {
  ...
  packages_business_components_connectiontypeselectorsort_betaban: 'Beta版',
  packages_business_components_connectiontypeselectorsort_zhengshiban: '正式版',
  packages_business_components_connectiontypeselectorsort_jiaoyouTap:
    '交由TapaData进行全面的质量测试，以保证插件的稳定性和质量',
