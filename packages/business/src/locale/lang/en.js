export default {
  ...
  packages_business_verification_tasksJobName: 'Please enter validation task name',
  packages_business_verification_tasksVerifyCondition: 'Please set validation condition',
  ...
  packages_business_components_conditionbox_daijiaoyanlianjie: 'Connection to be validation',
  ...
  packages_business_verification_form_task_alarm_when_error: 'Alert when the validation task fails',
  ...
  packages_business_setting_alarmnotification_dangjiaoyanrenwucuowu: 'When the validation task encounters an error',
...
- You can drag and drop database tables onto the application to quickly publish APIs.
  ...
  packages_business_verification_list_renyibiaoshuju: 'Any Table Data Validation',
  packages_business_verification_list_renwuyizhixing: 'Task Consistency Validation',
