export default {
  ...
  packages_business_dataFlow_dlq_impact_title: 'DLQ record warning',
  ...
  packages_business_data_server_drawer_shuchujieguo: 'Response Result',
...
<p>Useful when the target is a database that automatically converts empty strings to NULL (e.g. Oracle), to avoid false-positive field inconsistencies caused by such semantic differences.</p>`,
  ...
  packages_business_task_dlq_event: 'DLQ exception event entered DLQ',
  packages_business_task_dlq_save_failed: 'DLQ exception event failed to enter DLQ',
  packages_business_task_dlq_recovery_failed: 'DLQ manual recovery batch failed',
  packages_business_task_dlq_storm_guard: 'DLQ exception storm guard activated',
  packages_business_dlq_source_table: 'Source table',
  packages_business_dlq_target_table: 'Target table',
  packages_business_dlq_event_id: 'Exception event ID',
  packages_business_dlq_dml_type: 'DML type',
  packages_business_dlq_error_type: 'Error type',
  packages_business_dlq_error_code: 'Error code',
  packages_business_dlq_classification_reason: 'Classification reason',
  packages_business_dlq_safe_reason: 'Safe error reason',
  packages_business_dlq_pending_count: 'Pending count',
  packages_business_dlq_task_id: 'Task ID',
  packages_business_dlq_batch_id: 'Recovery batch ID',
  packages_business_dlq_operator: 'Operator',
  packages_business_dlq_recovery_status: 'Recovery status',
  packages_business_dlq_selected_count: 'Selected count',
  packages_business_dlq_success_count: 'Success count',
  packages_business_dlq_failed_count: 'Failed count',
  packages_business_dlq_skipped_count: 'Skipped count',
  packages_business_dlq_remaining_count: 'Remaining pending count',
  packages_business_dlq_failed_at: 'First failure time',
  packages_business_dlq_page_url: 'Exception events page',
  packages_business_dlq_alarm_date: 'Alarm time',
  packages_business_dlq_guard_key: 'Guard key',
  packages_business_dlq_guard_window: 'Guard window',
  packages_business_dlq_guard_threshold: 'Guard threshold',
  packages_business_dlq_suppressed_count: 'Estimated suppressed count',
  packages_business_dlq_route_decision: 'Route decision',
  ...
  packages_business_workflow_enabled: 'Enabled',
  packages_business_workflow_trigger_type: 'Trigger',
  packages_business_workflow_last_result: 'Last Result',
  packages_business_workflow_last_run_time: 'Last Run Time',
  packages_business_workflow_duration: 'Duration',
  packages_business_workflow_next_fire: 'Next Run',
  packages_business_workflow_all_runs: 'All Runs',
  packages_business_workflow_runs: 'Runs',
  packages_business_workflow_run: 'Run',
  packages_business_workflow_test: 'Test Run',
  packages_business_workflow_view_active: 'View Active Run',
  packages_business_workflow_enabled_ok: 'Workflow enabled',
  packages_business_workflow_suppressed: 'An active run already exists. This trigger was suppressed.',
  packages_business_workflow_validate: 'Validate',
  packages_business_workflow_validate_ok: 'Validation passed',
  packages_business_workflow_validate_fail: 'Validation failed. Fix the highlighted issues.',
  packages_business_workflow_name_required: 'Workflow name is required',
  packages_business_workflow_name_placeholder: 'Enter workflow name',
  packages_business_workflow_when: 'Trigger',
  packages_business_workflow_trigger_title_manual: 'Manual trigger',
  packages_business_workflow_trigger_title_schedule: 'Scheduled trigger',
  packages_business_workflow_trigger_title_event: 'Event trigger',
  packages_business_workflow_palette: 'Steps',
  packages_business_workflow_palette_hint: 'Drag onto the flow to insert, or click to append',
  packages_business_workflow_palette_group_task: 'Tasks',
  packages_business_workflow_palette_group_inspect: 'Inspect',
  packages_business_workflow_palette_group_control: 'Flow',
  packages_business_workflow_palette_group_action: 'Actions',
  packages_business_workflow_drop_hint: 'Drop a step here',
  packages_business_workflow_step_type: 'Step type',
  packages_business_workflow_step_config: 'Step configuration',
  packages_business_workflow_locked_enabled: 'Enabled workflows cannot be edited. Disable first.',
  packages_business_workflow_locked_active: 'This workflow has an active run and cannot be edited or deleted.',
  packages_business_workflow_versions: 'Versions',
  packages_business_workflow_select_resource: 'Select',
  packages_business_workflow_trigger_MANUAL: 'Manual only',
  packages_business_workflow_trigger_MANUAL_TEST: 'Manual test',
  packages_business_workflow_trigger_SCHEDULE_ONCE: 'Run once',
  packages_business_workflow_trigger_SCHEDULE_INTERVAL: 'Interval',
  packages_business_workflow_trigger_SCHEDULE_DAILY: 'Daily',
  packages_business_workflow_trigger_SCHEDULE_WEEKLY: 'Weekly',
  packages_business_workflow_trigger_TASK_STARTED: 'Task started',
  packages_business_workflow_trigger_TASK_STOPPED: 'Task stopped',
  packages_business_workflow_trigger_TASK_ERROR: 'Task error',
  packages_business_workflow_trigger_SNAPSHOT_COMPLETED: 'Snapshot completed',
  packages_business_workflow_trigger_CDC_ENTERED: 'CDC entered',
  packages_business_workflow_trigger_INCREMENT_DELAY_BREACHED: 'Increment delay breached',
  packages_business_workflow_trigger_INSPECT_DIFF_BREACHED: 'Inspect diff breached',
  packages_business_workflow_step_TASK_START: 'Start tasks',
  packages_business_workflow_step_TASK_STOP: 'Stop tasks',
  packages_business_workflow_step_INSPECT_START: 'Run inspect',
  packages_business_workflow_step_INSPECT_DIFF: 'Diff inspect',
  packages_business_workflow_step_INSPECT_REPAIR: 'Repair inspect',
  packages_business_workflow_step_WAIT: 'Wait until ready',
  packages_business_workflow_step_CONDITION: 'Continue if',
  packages_business_workflow_step_IF_ELSE: 'If / Else',
  packages_business_workflow_step_ALARM: 'Send alarm',
  packages_business_workflow_step_WEBHOOK: 'Send webhook',
  packages_business_workflow_step_JAVASCRIPT: 'Run JavaScript',
  packages_business_workflow_run_CREATED: 'Created',
  packages_business_workflow_run_RUNNING: 'Running',
  packages_business_workflow_run_WAITING: 'Waiting',
  packages_business_workflow_run_RETRY_WAIT: 'Retry wait',
  packages_business_workflow_run_SUCCEEDED: 'Succeeded',
  packages_business_workflow_run_COMPLETED_WITH_WARNINGS: 'Completed with warnings',
  packages_business_workflow_run_CONDITION_NOT_MET: 'Condition not met',
  packages_business_workflow_run_FAILED: 'Failed',
  packages_business_workflow_run_STOPPED: 'Stopped',
  packages_business_workflow_run_RETRYABLE: 'Retryable',
  packages_business_workflow_logic_and: 'All match',
  packages_business_workflow_logic_or: 'Any match',
  packages_business_workflow_variable: 'Field',
  packages_business_workflow_condition_hint:
    'Pick the field to compare. Tasks and inspects listed here are the ones this workflow already references — you do not type IDs. Alarm-template aliases are hidden.',
  packages_business_workflow_condition_empty_task:
    'Select a task on the trigger or a step first to compare its status or delay',
  packages_business_workflow_condition_empty_inspect:
    'Reference an inspect task first to compare difference count or result',
  packages_business_workflow_condition_empty_step:
    'Place If / Else after other steps to branch on their results',
  packages_business_workflow_value_ms: 'milliseconds',
  packages_business_workflow_task_status_retrying: 'Retrying',
  packages_business_workflow_inspect_status_done: 'Done',
  packages_business_workflow_inspect_result_passed: 'Passed',
  packages_business_workflow_inspect_result_failed: 'Failed',
  packages_business_workflow_var_group_trigger: 'This trigger',
  packages_business_workflow_var_group_task: 'Referenced tasks',
  packages_business_workflow_var_group_inspect: 'Referenced inspects',
  packages_business_workflow_var_group_step: 'Upstream steps',
  packages_business_workflow_var_group_run: 'This run',
  packages_business_workflow_var_group_workflow: 'Workflow',
  packages_business_workflow_var_run_id: 'Run ID',
  packages_business_workflow_var_run_id_tip: 'ID of this workflow run; rarely used for business rules',
  packages_business_workflow_var_run_triggerType: 'Trigger type',
  packages_business_workflow_var_run_triggerType_tip: 'Whether this run was manual, scheduled, or event-driven',
  packages_business_workflow_var_run_startedAt: 'Started at',
  packages_business_workflow_var_run_startedAt_tip: 'Run start time as epoch milliseconds',
  packages_business_workflow_var_workflow_id: 'Workflow ID',
  packages_business_workflow_var_workflow_id_tip: 'ID of the current workflow',
  packages_business_workflow_var_workflow_name: 'Workflow name',
  packages_business_workflow_var_workflow_name_tip: 'Name of the current workflow',
  packages_business_workflow_var_workflow_version: 'Workflow version',
  packages_business_workflow_var_workflow_version_tip: 'Published version number',
  packages_business_workflow_var_trigger_taskId: 'Trigger source task',
  packages_business_workflow_var_trigger_taskId_tip: 'Task that caused this run',
  packages_business_workflow_var_trigger_inspectId: 'Trigger source inspect',
  packages_business_workflow_var_trigger_inspectId_tip: 'Inspect that caused this run',
  packages_business_workflow_var_trigger_observedValue: 'Observed value at trigger',
  packages_business_workflow_var_trigger_observedValue_tip: 'Metric captured when the run started, such as delay ms or difference count',
  packages_business_workflow_var_trigger_delayTime: 'Increment delay at trigger',
  packages_business_workflow_var_trigger_delayTime_tip: 'Set when increment-delay trigger fires, in milliseconds',
  packages_business_workflow_var_trigger_differenceNumber: 'Difference count at trigger',
  packages_business_workflow_var_trigger_differenceNumber_tip: 'Difference count captured when inspect-diff trigger fires',
  packages_business_workflow_var_tasks_name: 'Task name',
  packages_business_workflow_var_tasks_name_tip: 'Current name of this task',
  packages_business_workflow_var_tasks_delayTime: 'Current increment delay',
  packages_business_workflow_var_tasks_delayTime_tip: 'Live increment delay of this task, in milliseconds',
  packages_business_workflow_var_tasks_status: 'Task status',
  packages_business_workflow_var_tasks_status_tip: 'Whether this task is running, in error, or stopped right now',
  packages_business_workflow_var_tasks_cdcEntered: 'CDC entered',
  packages_business_workflow_var_tasks_cdcEntered_tip: 'Whether this task has entered incremental sync',
  packages_business_workflow_var_inspects_name: 'Inspect name',
  packages_business_workflow_var_inspects_name_tip: 'Current name of this inspect',
  packages_business_workflow_var_inspects_differenceNumber: 'Current difference count',
  packages_business_workflow_var_inspects_differenceNumber_tip: 'Live difference count of this inspect',
  packages_business_workflow_var_inspects_status: 'Inspect status',
  packages_business_workflow_var_inspects_status_tip: 'Whether this inspect is running, done, or failed',
  packages_business_workflow_var_inspects_result: 'Inspect result',
  packages_business_workflow_var_inspects_result_tip: 'Whether the latest inspect passed or failed',
  packages_business_workflow_var_steps_status: 'Step result',
  packages_business_workflow_var_steps_status_tip: 'Whether that upstream step succeeded',
  packages_business_workflow_var_steps_output_differenceNumber: 'Step difference count',
  packages_business_workflow_var_steps_output_differenceNumber_tip: 'Difference count produced by an inspect step',
  packages_business_workflow_var_steps_errorCode: 'Step error code',
  packages_business_workflow_var_steps_errorCode_tip: 'Error code if that upstream step failed',
  packages_business_workflow_add_condition: 'Add condition',
  packages_business_workflow_op_eq: 'Equals',
  packages_business_workflow_op_ne: 'Not equal',
  packages_business_workflow_op_gt: 'Greater than',
  packages_business_workflow_op_gte: 'Greater or equal',
  packages_business_workflow_op_lt: 'Less than',
  packages_business_workflow_op_lte: 'Less or equal',
  packages_business_workflow_type_string: 'String',
  packages_business_workflow_type_number: 'Number',
  packages_business_workflow_type_boolean: 'Boolean',
  packages_business_workflow_context_task: 'Select context task',
  packages_business_workflow_context_task_tip: 'For event or metric workflows, pick one task from the trigger list as the context for this manual run.',
  packages_business_workflow_context_missing_list: 'The trigger has no task list, so a context task cannot be selected.',
  packages_business_workflow_fire_at: 'Run at',
  packages_business_workflow_interval_minutes: 'Interval (minutes)',
  packages_business_workflow_timezone: 'Timezone',
  packages_business_workflow_clock: 'Time (hour / minute)',
  packages_business_workflow_days_of_week: 'Days of week',
  packages_business_workflow_weekday_1: 'Mon',
  packages_business_workflow_weekday_2: 'Tue',
  packages_business_workflow_weekday_3: 'Wed',
  packages_business_workflow_weekday_4: 'Thu',
  packages_business_workflow_weekday_5: 'Fri',
  packages_business_workflow_weekday_6: 'Sat',
  packages_business_workflow_weekday_7: 'Sun',
  packages_business_workflow_tasks: 'Tasks',
  packages_business_workflow_inspects: 'Inspect tasks',
  packages_business_workflow_threshold_seconds: 'Delay threshold (seconds)',
  packages_business_workflow_diff_threshold: 'Diff threshold',
  packages_business_workflow_predicate: 'Wait until',
  packages_business_workflow_predicate_RUNNING: 'Running',
  packages_business_workflow_predicate_SNAPSHOT_DONE: 'Snapshot done',
  packages_business_workflow_predicate_CDC_ENTERED: 'CDC entered',
  packages_business_workflow_join: 'Join',
  packages_business_workflow_join_all: 'All',
  packages_business_workflow_join_any: 'Any',
  packages_business_workflow_trigger_join: 'Match',
  packages_business_workflow_trigger_join_tip:
    'With multiple sources: Any fires when the first one meets the condition; All waits until every listed source meets it, then fires once. A running instance suppresses later triggers.',
  packages_business_workflow_timeout_minutes: 'Timeout (minutes)',
  packages_business_workflow_inspect_diff_tip:
    'Diff inspect supports field / joint-field jobs only, and needs an existing inspect result',
  packages_business_workflow_inspect_repair_tip:
    'Repair requires the related sync task to be running in CDC',
  packages_business_workflow_alarm_title: 'Alarm title',
  packages_business_workflow_alarm_message: 'Alarm message',
  packages_business_workflow_alarm_email_hint:
    'This step writes an in-app notification and immediately emails the addresses in System Settings → Email. Edit the HTML template and click a variable to insert workflow, task, or inspect context. Configure smtp.server.host and email.receivers first.',
  packages_business_workflow_alarm_template: 'Alarm email template',
  packages_business_workflow_alarm_edit_template: 'Edit email template',
  packages_business_workflow_alarm_restore_template: 'Restore default template',
  packages_business_workflow_alarm_var_task_desc: 'Summary',
  packages_business_workflow_alarm_var_step_name: 'Step name',
  packages_business_workflow_alarm_var_trigger_type: 'Trigger type',
  packages_business_workflow_alarm_var_time: 'Notification time',
  packages_business_workflow_alarm_var_details: 'Run details',
  packages_business_workflow_webhook: 'Webhook',
  packages_business_workflow_webhook_url: 'Request URL',
  packages_business_workflow_webhook_method: 'Method',
  packages_business_workflow_webhook_token: 'Authorization (optional)',
  packages_business_workflow_webhook_token_placeholder: 'Sent as the Authorization header. Leave empty if unused.',
  packages_business_workflow_webhook_body: 'Request body',
  packages_business_workflow_webhook_hint:
    'Configure the URL and JSON body on this step. Click a variable to insert workflow, task, or inspect context.',
  packages_business_workflow_webhook_legacy_hint:
    'This step still references a system webhook. Fill in a URL and save to switch to an in-workflow configuration.',
  packages_business_workflow_script: 'Script',
  packages_business_workflow_connections: 'Connections (optional)',
  packages_business_workflow_js_retry_tip: 'Retrying JS or webhook steps may call the external API more than once.',
  packages_business_workflow_retry_policy: 'Retry policy',
  packages_business_workflow_max_retries: 'Max retries',
  packages_business_workflow_retry_seconds: 'Retry interval (seconds)',
  packages_business_workflow_exhausted: 'When retries are exhausted',
  packages_business_workflow_exhausted_stop: 'Stop workflow',
  packages_business_workflow_exhausted_skip: 'Skip and continue',
  packages_business_workflow_then: 'Then',
  packages_business_workflow_else: 'Else',
  packages_business_workflow_name: 'Workflow name',
  packages_business_workflow_id: 'Workflow ID',
  packages_business_workflow_run_id: 'Run ID',
  packages_business_workflow_resume_count: 'Resume count',
  packages_business_workflow_started_by: 'Started by',
  packages_business_workflow_time_range: 'Time range',
  packages_business_workflow_resume: 'Resume from failed step',
  packages_business_workflow_rerun: 'Rerun from start',
  packages_business_workflow_stop_confirm: 'Stopping does not roll back completed start/stop, webhook, or alarm actions. Stop this run?',
  packages_business_workflow_unknown_result_tip: 'The external result is unknown. Do not auto-replay this step. Resume from the failed step or rerun from the start.',
  packages_business_workflow_wait_deadline: 'Wait deadline',
  packages_business_workflow_last_resumed_by: 'Resumed by',
  packages_business_workflow_last_resumed_at: 'Resumed at',
  packages_business_workflow_wait_progress: 'Unmet tasks',
  packages_business_workflow_task_id: 'Task ID',
  packages_business_workflow_reason: 'Reason',
  packages_business_workflow_step_output: 'Return value',
  packages_business_workflow_timeline: 'Step timeline',
  packages_business_workflow_suppressed_triggers: 'Suppressed triggers',
