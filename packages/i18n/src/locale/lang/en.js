export default {
  ...
  public_message_create_success: 'Create Successful',
  ...
  public_time_avg_input: 'Input (Avg/{unit})',
  public_time_max_input: 'Input (Max/{unit})',
  public_time_output: 'Output',
  public_time_avg_output: 'Output (Avg/{unit})',
  public_time_max_output: 'Output (Max/{unit})',
  public_time_avg_input_95th: 'Input P95',
  public_time_avg_output_95th: 'Output P95',
  public_time_avg_input_99th: 'Input P99',
  public_time_avg_output_99th: 'Output P99',
  ...
  public_start_download: 'Start Download',
  ...
  public_package_name: 'Package Name',
  public_new_release: 'New Release',
  public_version_name: 'Version Name',
  public_select_api: 'Select API',
  ...
  public_history_version: 'History Version',
  public_search_version: 'Search Version',
  public_no_match_version: 'No matching version found',
  public_find_version: 'Found {count} versions',
  public_version_info: 'Version Info',
  public_zip_package: 'ZIP Package',
  public_jar_package: 'JAR Package',
  public_release_time: 'Release Time',
  ...
  public_rule_content: 'Rule Content',
  public_regex: 'Regex',
  public_regex_example: 'Regex Example',
  public_replace_char: 'Replace Char',
  public_test: 'Test',
  public_rule_name_required: 'Please enter rule name',
  public_rule_name_placeholder: 'Please enter rule name',
  public_regex_required: 'Please enter regex',
  public_regex_placeholder: `Please enter regex, e.g. \\d+`,
  public_regex_invalid: 'Regex format is incorrect',
  public_replace_char_required: 'Please enter replace char',
  public_replace_char_placeholder:
    'Please enter replace content (support $1, $2, etc.)',
  public_description_placeholder: 'Please enter description (optional)',
  public_rule_test: 'Rule Test',
  public_test_text: 'Test Text',
  public_test_text_placeholder: 'Please enter the test text',
  public_execute_test: 'Execute Test',
  ...
  public_table_filter: 'Table Filter',
  public_filter_type: 'Filter Type',
  public_include_tables: 'Include Tables',
  public_include_regex: 'Include Regex',
  public_exclude_tables: 'Exclude Tables',
  public_exclude_regex: 'Exclude Regex',
  public_tables_included: 'Included Tables',
  public_tables_excluded: 'Excluded Tables',
  public_table_regex_placeholder:
    'e.g. user_.* matches tables starting with user_',
