export default {
  ...
  public_filter: '筛选',
  public_equal: '等于',
  public_not_equal: '不等于',
  public_greater_than: '大于',
  public_greater_than_or_equal: '大于或等于',
  public_less_than: '小于',
  public_less_than_or_equal: '小于或等于',
  public_contains: '包含',
  ...
  public_status_skipped: '已跳过',
  public_status_recovering: '恢复中',
  // 按钮
  ...
  public_message_401: '登录认证过期，请重新登录',
  public_message_403: '禁止访问, 您没有权限访问此资源',
  public_message_404: '请求的资源不存在',
  public_message_408: '请求超时，请稍后再试',
  public_message_5xx: '服务器异常',
  public_message_inner_error: '内部服务器错误，请稍后再试',
  ...
  public_time_avg_input: '输入 (平均/{unit})',
  public_time_max_input: '输入 (最大/{unit})',
  ...
  public_new_release: '发布新版',
  public_version_name: '版本名称',
  public_select_api: '选择 API',
  public_client: '客户端',
  public_search_api: '搜索 API',
  public_quick_fill: '快速填入',
  public_last_version: '上个版本',
  public_example: '示例',
  public_placeholder_sdk_name: '请输入 SDK 名称',
  public_placeholder_package_name: '请输入包名',
  public_placeholder_version: '请输入版本',
  public_history_version: '历史版本',
  public_search_version: '搜索版本',
  public_no_match_version: '未找到匹配的版本',
  public_find_version: '找到 {count} 个版本',
  public_version_info: '版本信息',
  public_zip_package: 'ZIP 包',
  public_jar_package: 'JAR 包',
  public_release_time: '发布时间',
  public_api_list: 'API 列表',
  public_generated: '已生成',
  public_generating: '生成中',
  public_delete_version: '删除版本',
  public_delete_version_message: '确定删除版本 {version} 吗？',
  public_select_client: '请选择客户端',
  public_selected_apis: '已选 {count} APIs',
  public_delete_sdk_message: '删除 SDK “{sdk}”？',
  ...
  public_rule_content: '规则内容',
  public_regex: '正则表达式',
  public_regex_example: '正则表达式示例',
  public_replace_char: '替换符',
  public_test: '测试',
  public_rule_name_required: '请输入规则名称',
  public_rule_name_placeholder: '输入规则名称',
  public_regex_required: '请输入正则表达式',
  public_regex_placeholder: `输入正则表达式, 如: \\d+`,
  public_regex_invalid: '正则表达式格式不正确',
  public_replace_char_required: '请输入替换符',
  public_replace_char_placeholder: '输入替换内容（支持 $1, $2 等分组引用）',
  public_description_placeholder: '输入描述（可选）',
  public_test_text: '测试文本',
  public_rule_test: '规则测试',
  public_test_text_placeholder: '输入要测试的文本内容',
  public_execute_test: '执行测试',
  public_matched_items: '匹配项 ({val})',
  ...
  public_table_filter: '表过滤',
  public_filter_type: '过滤类型',
  public_include_tables: '包含指定表',
  public_include_regex: '包含正则匹配',
  public_exclude_tables: '排除指定表',
  public_exclude_regex: '排除正则匹配',
  public_tables_included: '包含的表',
  public_tables_excluded: '排除的表',
  public_table_regex_placeholder: '例如: user_.* 匹配以 user_ 开头的表',
  ...
  public_duckdb_sql_label: 'SQL 语句',
