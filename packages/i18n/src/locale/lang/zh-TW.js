export default {
  ...
  public_filter: '篩選',
  public_equal: '等於',
  public_not_equal: '不等於',
  public_greater_than: '大於',
  public_greater_than_or_equal: '大於或等於',
  public_less_than: '小於',
  public_less_than_or_equal: '小於或等於',
  public_contains: '包含',
  public_not_contains: '不包含',
  public_is_null: '為空',
  ...
  public_time_avg_input: '輸入 (平均/{unit})',
  public_time_max_input: '輸入 (最大/{unit})',
  ...
  public_connection_button_import: '導入連接',
  ...
  public_table_filter: '表過濾',
  public_filter_type: '過濾類型',
  public_include_tables: '包含指定表',
  public_include_regex: '包含正則匹配',
  public_exclude_tables: '排除指定表',
