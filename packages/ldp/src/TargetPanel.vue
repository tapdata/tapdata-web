<template>
  <div class="list__item flex flex-column flex-1 overflow-hidden">
    ...
    <div class="flex-fill min-h-0 flex flex-column">
      ...
      <div
        class="flex-fill min-h-0 overflow-auto p-4 position-relative"
        @scroll="handleScroll"
      >
          ...
          <template v-if="item.LDP_TYPE === 'app'">
            ...
            >
              <ElTooltip
                placement="top"
                :content="
                  $t('packages_ldp_src_target_muqianzhichide') +
                  ':' +
              ...
              >
                <span>
                  {{
                    `${$t(
                      'packages_dag_components_node_zanbuzhichi'
                    )} ${dragDatabaseType}`
                  }}</span
                >
              </ElTooltip>
      ...
      >
        ...
        >
          ...
          <ElFormItem prop="taskName" :label="$t('public_task_name')">
            <ElInput
              size="small"
              v-model:value="taskDialogConfig.taskName"
              maxlength="50"
              show-word-limit
            ></ElInput>
          </ElFormItem>
