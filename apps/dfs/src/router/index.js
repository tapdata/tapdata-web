...
const UserCenter = Vue.defineAsyncComponent(() => import('../views/user/Center.vue'))
...
const routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: '/workbench',
        name: 'Workbench',
        component: Vue.defineAsyncComponent(() => import('../views/workbench/Workbench.vue')),
        meta: {
          title: 'tap_workbench',
          icon: 'workbench',
          hideTitle: true
        ...
        children: [
          {
            ...
            component: Vue.defineAsyncComponent(() => import('../views/workbench/Notice.vue')),
            meta: {
      ...
      },
      {
        path: '/systemNotice',
        name: 'SystemNotice',
        component: Vue.defineAsyncComponent(() => import('../views/workbench/SystemNotice.vue')),
        meta: {
      ...
      },
      {
        path: '/instance',
        name: 'Instance',
        component: Vue.defineAsyncComponent(() => import('../views/instance/Instance.vue')),
        meta: {
        ...
        children: [
          {
            ...
            component: Vue.defineAsyncComponent(() => import('../views/instance/Details.vue')),
            meta: {
      ...
      },
      {
        ...
        name: 'connections',
        // component: Iframe,
        component: Vue.defineAsyncComponent(() => import('@/views/connection/List.tsx')),
        meta: {
      ...
      },
      {
        path: '/migrate',
        name: 'migrateList',
        component: Vue.defineAsyncComponent(() => import('../views/task/MigrationList.tsx')),
        meta: {
      ...
      },
      {
        path: '/etl',
        name: 'dataflowList',
        component: Vue.defineAsyncComponent(() => import('../views/task/EtlList.tsx')),
        meta: {
...

      {
        path: '/operationLog',
        name: 'OperationLog',
        component: Vue.defineAsyncComponent(() => import('../views/operation-log/List.vue')),
        meta: {
      ...
      },
      {
        path: '/data-server',
        name: 'dataServerList',
        component: Vue.defineAsyncComponent(() => import('../views/data-server/list')),
        meta: {
