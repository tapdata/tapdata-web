        ...
        <template v-if="showPhone">
          <ElFormItem prop="telephone" :label="$t('user_Center_dangQianShouJi')">
            <ElInput
              ...
              disabled
            >
              <el-select v-model="passwordForm.countryCode" disabled slot="prepend" style="width: 110px" filterable>
                <el-option
      ...
      <ElForm :model="phoneForm" label-width="120px" @submit.native.prevent label-position="top">
        <ElFormItem prop="current" :label="$t('user_Center_dangQianShouJi')">
          <ElInput
            ...
            disabled
          >
            <el-select v-model="phoneForm.countryCode" slot="prepend" style="width: 110px" filterable disabled>
              <el-option
