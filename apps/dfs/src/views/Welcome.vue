      ...
      <div class="flex absolute-fill">
        <div class="flex-1 flex flex-column justify-center align-center my-8">
          <div class="text-center mb-14">
            ...
            <div class="font-color-sslight lh-base mb-10">平台提供<span class="text-gradient">免费15天</span>的全托管引擎和Demo数据源进行功能场景试用
            </div>
          </div>

          <div class="flex align-center">
            <div class="position-relative">
              <div class="position-absolute start-50 font-color-sslight text-center lh-base connector-header mt-n3">
                数据源
              </div>
              <div class="flex flex-column gap-6 connector-list p-4">
                <div class="connector-list-item flex justify-center align-center" v-for="(item) in sourceList"
                     :key="item.type">
            ...
            <div class="position-relative">
              ...
              <div class="flex flex-column gap-6 connector-list p-4">
                <div class="connector-list-item flex justify-center align-center" v-for="(item) in targetList"
                     :key="item.type">
                  <ElImage :src="item.icon" style="width: 30px;height: 30px;"></ElImage>
                </div>
              </div>
