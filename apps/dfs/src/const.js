...
export const INSTANCE_STATUS_MAP = {
  ...
  MDB_STATUS_MAP = {
    ...
    WaitingDelete: {
      text: i18n.t('public_status_waiting_delete'),
      type: 'waiting'
    },
  ...
  ORDER_STATUS_MAP = {
    incomplete: {
      text: i18n.t('packages_business_shared_const_weizhifu'),
      type: 'waiting'
    },
    active: {
      text: i18n.t('packages_business_shared_const_yizhifu'),
      type: 'success'
    },
    payFail: {
      text: i18n.t('packages_business_shared_const_zhifushibai'),
      type: 'warning'
    },
    refund: {
      text: i18n.t('packages_business_shared_const_yituikuan'),
      type: 'disable'
    },
    past_due: {
      text: i18n.t('packages_business_payment_timeout'),
      type: 'warning'
    },
    refunding: { text: i18n.t('packages_business_shared_const_tuikuanzhong') },
    incomplete_expired: {
      text: i18n.t('packages_business_shared_const_shixiao'),
      type: 'disable'
    },
    canceled: {
      text: i18n.t('packages_business_shared_const_yiquxiao'),
      type: 'disable'
    },
    altering: { text: i18n.t('public_status_altering') },
  ...
  TASK_STATUS_MAP = {
    ...
    paused: {
      text: i18n.t('public_status_wait_run'),
      icon: 'daiqidong',
      type: 'warning'
    },
    error: {
