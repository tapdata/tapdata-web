export default {
  ...
  operation_log_agent_start_tip: 'The agent【@{parameter1}】 has been started',
  operation_log_agent_stop: 'Stop Agent',
  operation_log_agent_stop_tip: 'The agent【 has been stopped【@{parameter1}】',
  operation_log_agent_restart_agent: 'Restart Agent',
  operation_log_agent_restart_agent_tip: 'The agent【@{parameter1}】 has been restarted',
  operation_log_agent_delete: 'Unsubscribe Agent',
  operation_log_agent_delete_tip: 'Unsubscribed a Agent [${parameter1}]',
