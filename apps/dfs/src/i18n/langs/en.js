export default {
  ...
  connection_form_mongo_standard_mode_tip:
    'this mode will connect to a separate server in the network, which provides TSL / SSL channel to the database. If your database is on an inaccessible subnet, you can try this method',
  task_next_run_time: 'next run time',
  task_form_setting_sync_points_tip:
    'incremental collection time point setting temporarily supports only mysql, SQL server, Oracle and mongodb sources',
  task_info_sync_running: 'synchronization in progress',
  task_info_sync_waiting: 'to be synchronized',
  task_info_sync_pause: 'paused',
  task_info_history_start_type: 'operation mode',
  task_info_history_running_status: 'operation status',
  task_info_history_start_type_manual: 'manual operation',
  task_info_history_start_type_auto: 'regular scheduling',
  task_setting_sync_points: 'incremental acquisition start time',
  task_setting_cron_expression: 'regularly schedules tasks',
  task_setting_schedule_time: 'scheduled run time',
  task_setting_task_name_already_exists: 'task name already exists',
  task_setting_cron_expression_valid_false:
    'scheduling expression error___ Field type of synchronization not supported by Kaikai',
  task_mapping_table_setting_tip1: 'type modification',
  task_mapping_table_field_type_change: ', please edit the field name',
  task_mapping_table_field_name_empty_edit_vika:
    "'s current table fields have not been set. Please ensure that all source fields have been associated with target fields. Please delete the source fields that do not need to be synchronized",
  task_mapping_table_field_name_empty_check:
    ', please select the target Vig table and wait for the table structure information to be loaded',
  ...
  task_mapping_table_no_data_qingflow: 'modifies the target table name',
  task_mapping_dialog_rename_a_single_table_title:
    'custom name tables will not be applied: prefix, suffix and case conversion operations___ The actual available length of Kaikai depends on the target database type definition. Please set it as required',
  ...
  dataForm_error_portNumber: 'port must be numeric___ The value range of Kaikai port number is 1 ~ 65535',
  dataForm_error_portRange: 'database name',
  dataForm_form_databaseName: 'account',
  dataForm_form_userName: 'password',
  dataForm_form_password: 'other connection string parameters___ Time zone of Kaikai time type',
  dataForm_form_additionalString: 'impact type: Date',
  dataForm_form_timeZone: 'source and target',
  dataForm_form_timeZoneTips: 'this data connection can be used as both source and target in tapdata',
  dataForm_form_options_sourceAndTarget: 'Schema',
  dataForm_form_options_sourceAndTargetTips: 'log decoder',
  dataForm_form_databaseOwner: 'connection mode',
  dataForm_form_plugin_name: 'uri pattern',
  dataForm_form_options_connectionMode: 'configures mongodb database in URI mode and supports batch input',
  dataForm_form_options_URIMode: 'standard mode',
  dataForm_form_options_URIModeTips: 'database URI',
  dataForm_form_options_standardMode: 'uses TLS / SSL connection',
  dataForm_form_databaseUri: 'tsl / SSL connection',
  dataForm_form_ssl:
  ...
  dataForm_form_options_sslTSL: 'direct connection',
  dataForm_form_options_sslTSLTip:
    'tapdata will connect directly to the database. You can create a security rule to allow system access. This is a simple and direct method',
  dataForm_form_options_sslTop: 'client private key',
  dataForm_form_options_sslTopTips: 'client private key cannot be empty',
  dataForm_form_sslKey: 'private key password',
  dataForm_error_noneSslKey: 'authentication server certificate',
  dataForm_form_sslPass: 'certification authority',
  dataForm_form_sslValidate: 'certification authority cannot be empty',
  dataForm_form_sslCA: 'loads the schema periodically',
  dataForm_error_noneSslCA: 'include table',
  dataForm_form_ReloadSchema: 'comma separated expression list, using * to represent any character of any length',
  dataForm_form_tableFilter: 'initialization data size',
  dataForm_form_tableFilterTips: 'test rate (times / second)',
  dataForm_form_initialReadSize: 'index prefix',
  dataForm_form_incrementalTps: 'topic expression',
  dataForm_form_indexPrefix: 'ignores non JSON object format messages',
  dataForm_form_kafka_topicExpression: 'ack confirmation mechanism',
  dataForm_form_kafka_lonoreFormat: "doesn't confirm",
  dataForm_form_kafka_kafkaAcks: 'writes only to the master partition',
  dataForm_form_kafka_kafkaAcks0: 'writes to most ISR partitions',
  dataForm_form_kafka_kafkaAcks1: 'writes to all ISR partitions',
  dataForm_form_kafka_kafkaAcks_1: 'message compression type',
  dataForm_form_kafka_kafkaAcksAll: 'ignores push message exception',
  dataForm_form_kafka_kafkaCompressionType: 'mq type',
  dataForm_form_kafka_kafkaIgnorePushError: 'queue name',
  dataForm_form_mq_mqType: 'topic name',
  dataForm_form_mq_mqQueueSet: 'message routing',
  dataForm_form_mq_mqTopicSet: 'virtual host',
  dataForm_form_mq_routeKeyField: 'connection mode',
  dataForm_form_mq_virtualHost: 'service name',
  ...
  connection_reloadTittle: 'reloads the schema',
  connection_reloadMsg:
    ', if there are too many schemas in this library, it may take a long time. Are you sure you want to refresh the schema of the data source',
  message_confirm: 'confirmed',
  message_cancel: 'cancel',
  connection_reloadFail: 'schema failed to load',
  milestone_btn_check_error: 'check the cause of the error',
  dataFlow_second: 'seconds',
  dataFlow_min: 'points',
  dataFlow_hour: 'time',
  dataFlow_day: 'day',
  ...
  dataFlow_throughputpop:
    'input / output statistics: the average data acquisition speed of the source side and the writing speed of the target side per second. The larger the value, the better',
  ...
  dataFlow_totalInsert: 'general insert',
  dataFlow_totalUpdate: 'general update',
  dataFlow_totalDelete: 'general delete',
  dataFlow_cronExpression: ', please enter the scheduling expression',
  dialog_jobSchedule_explanation: 'can set fixed time, date and interval to run periodic tasks through cron expression',
  dialog_jobSchedule_grammar: 'syntax:',
  dialog_jobSchedule_example: 'example:',
  dialog_jobSchedule_runMinute: 'runs every minute',
  dialog_jobSchedule_runDay: "runs at 2 o'clock every day",
  guide_btn_back: ', back',
  ...
  dataFlow_SyncInfo_currentType: 'now',
  ...
  dataVerification_startVerify: 'is performing verification',
  message_placeholderSelect: ', please select',
  dataVerification_JSVerifyLogic: 'js check logic',
  dataVerification_verifyTime: 'verification time',
  dataVerification_completeTime: 'completion time',
  dataVerification_verifyProgress: 'verification progress',
  dataVerification_verifytype: 'check type',
  dataVerification_verifyResult: 'verification results',
  dataVerification_verifyStatus: 'verification status',
  dataFlow_operate: 'operation',
  button_details: 'details',
  dataVerification_operation: 'operation',
  dataVerification_waiting: 'to be verified',
  dataVerification_scheduling: 'verification startup',
  dataVerification_error: 'Error___ End of Kaikai verification',
  dataVerification_done: 'verification in progress',
  dataVerification_running: 'verification is consistent',
  app_Home_checkSame: 'count inconsistent',
  app_Home_countDifference: 'content differences',
  app_Home_contentDifference: 'deletion verification task cannot be recovered. Are you sure to delete it',
  dataVerification_deleteMessage: 'important reminder',
  dataFlow_importantReminder: 'delete',
  classification_deleteNode: 'deleted successfully',
  message_deleteOK: 'this task is in',
  dataVerification_checkStatusPre: 'status, unable to configure verification settings',
  dataVerification_checkStatusSuffix: 'data is trying to load',
  dataFlow_dataLoading: 'source table',
  dataVerification_sourceTable: 'target table',
  dataVerification_targetTable: 'source table rows',
  dataVerification_sourceRows: 'consistent',
  dataVerification_consistent: 'verification details',
  dataVerification_verifyDetail:
  ...
  dataVerification_success: 'difference type',
  dataVerification_inconsistentType: 'source table field name',
  dataVerification_sourceFieldName: 'value',
  dataVerification_Value: 'target field name',
  dataVerification_targetFieldName: 'unique field difference',
  dataVerification_uniqueField: 'other field differences___ Message returned by Kaikai',
  dataVerification_otherField: 'source table data___ Data returned by Kaikai',
  ...
  dataForm_form_response_body_CHECK_VERSION: 'checks whether the data source version information is available',
  dataForm_form_response_body_LOAD_SCHEMA: 'loading model',
  dataForm_form_response_body_CHECK_CDC_PERMISSION:
    'checks whether the permissions required for CDC synchronization are authorized',
  dataForm_form_response_body_CHECK_ARCHIVE_LOG: 'checks whether the archive log is enabled',
  dataForm_form_response_body_CHECK_SUPPLEMENTAL_LOG: 'checks whether the supplementary log mode is correct',
  dataForm_form_response_body_CHECK_DDL_PERMISSION:
    'checks whether the permissions required to execute DDL statements are authorized',
  dataForm_form_response_body_CHECK_PERMISSION:
    'checks whether the permissions required for synchronization are authorized',
  dataForm_form_response_body_CHECK_BIN_LOG: 'checks whether binlog is enabled and is at row level',
  dataForm_form_response_body_CHECK_BIN_ROW_IMAGE: 'checks whether binlog format is full',
  dataForm_form_response_body_CHECK_SCRIPT: 'checks if the script is available',
  dataForm_form_response_body_CHECK_PRIMARY_KEY: 'checks whether the primary key is available',
  dataForm_form_response_body_CHECK_CONFIG: 'checks whether the configuration is correct',
  dataForm_form_response_body_CHECK_READ_PERMISSION: 'checks whether the read permission is authorized',
  dataForm_form_response_body_CHECK_ACCESS_TOKEN: 'checks whether the access token is available',
  dataForm_form_response_body_CHECK_API_AUTH: 'checks whether the API has access rights',
  dataForm_form_response_body_CHECK_LOCAL_PORT: 'checks whether the local port is available',
  dataForm_form_response_body_SCAN_FILE: 'scans files in the directory',
  dataForm_form_response_body_CHECK_BIN_LOG_SYNC: 'checks whether binlog log synchronization is enabled',
  ...
  field_mapping_field_mapping_dialog_jingDu: 'precision',
  field_mapping_field_mapping_dialog_caoZuo: 'operation',
  field_mapping_field_mapping_dialog_tianJia: 'add',
  ...
  components_InlineInput_baoCun: 'save',
  components_InlineInput_quXiao: 'cancel',
  components_InlineInput_bianJi: 'editor',
  components_InlineInput_ziFuChangDuXian: 'character length is limited to {val1} - {val2} characters',
  components_RequestErrorMessage_yiFuZhi: 'copied',
  components_SelectList_meiYouGengDuoShu: 'has no more data',
  components_TableFilter_quanBu: 'all',
  the_header_Header_yongHuZhongXin: 'user center',
  the_header_Header_zhongWen: 'Chinese',
  components_VerificationCode_faSongYanZhengMa: 'sends verification code',
  ...
  agent_download_AgentDownloadModal_fuZhiXiaFangMing:
    '2. Copy the following commands and execute them in the tapdata directory, including the download and operation of images, and the download, automatic deployment and startup of tapdata agent',
  ...
  agent_download_AgentDownloadModal_kaiShiChuangJianLian: 'starts creating connections',
  agent_download_AgentDownloadModal_jinRuGongZuoTai: 'enters the workbench',
  agent_download_UpgradeVersion_dOCKE: 'docker exec - it container ID Bash',
  agent_download_UpgradeVersion_dOCKE2: 'dock start container ID',
  connection_Form_lianJieMingChengBu: 'connection name cannot be empty',
  connection_Form_mingChengGuiZeZhong:
    'name rule: it starts with Chinese and English, with 1 ~ 100 characters, and can contain Chinese and English, numbers, Chinese dashes, underscores and spaces',
  connection_Form_mingChengYiCunZai: 'name already exists',
  connection_List_lianJieMing: 'connection name',
  connection_List_lianJieCeShi: 'connection test',
  connection_List_fuZhi: 'replication',
  connection_List_shanChu: 'delete',
  connection_List_chuangJianLianJie: 'create connection',
  connection_List_quanBuZhuangTai: 'full status',
  connection_List_shuJuKuLeiXing: 'database type',
  connection_List_anLianJieMingSou: 'searches by connection name',
  connection_List_fuZhiChengGong: 'Copy successful___ Failed to delete kaik',
  connection_List_shanChuShiBai: 'operation succeeded',
  connection_Preview_caoZuoChengGong: 'server internal error',
  views_Error_fuWuQiNeiBu: 'returns to the home page',
  views_Error_fanHuiShouYe:
    'account has no permission! Your account authority is insufficient to order products. Please contact the customer manager or customer service personnel: 4001100868',
  views_Error_zhangHuZanWuQuan: 'account has been frozen',
  views_Error_zhangHuYiBeiDong:
    ', your account has been suspended and cannot order products. Please recharge in time or contact the account manager',
  views_Error_ninDeZhangHuYi: 'products have been taken off the shelf',
  views_Error_chanPinYiXiaJia: 'is very sorry, the product has been taken off the shelf',
  views_Error_feiChangBaoQianChan: 'status',
  instance_Instance_zhuangTai: 'searches by ID / instance name',
  instance_Instance_anIDShiLi: '，{val1}：{val2}%',
  instance_Instance_tHIST: 'error',
  monitor_Dashboard_cuoWu: ', please enter the log content',
  monitor_Log_qingShuRuRiZhi: 'download task log',
  monitor_Log_xiaZaiRenWuRi: 'has no more',
  monitor_Log_meiYouGengDuoLe: 'has no log at present',
  monitor_Log_zanWuRiZhi: 'select log range',
  monitor_Log_xuanZeRiZhiFan: 'download now',
  monitor_Log_liJiXiaZai: ', last 6 hours',
  monitor_Log_zuiJinGeXiaoShi: 'last day',
  monitor_Log_zuiJinTian3: ', last 3 days',
  monitor_Log_zuiJinTian2: ', last 5 days',
  monitor_Log_zuiJinTian: 'has read all notifications',
  operation_log_List_yiDuQuanBuTong: 'set all notifications as read',
  operation_log_List_sheZhiQuanBuTong: 'delete all notifications',
  operation_log_List_shanChuQuanBuTong: 'deleted all notifications',
  operation_log_List_shanChuLeQuanBu: 'marks the notification as read',
  operation_log_List_biaoJiTongZhiWei: 'marks all selected notifications as read',
  operation_log_List_jiangXuanZhongDeTong2: 'delete notification',
  operation_log_List_shanChuTongZhi: 'deletes all the selected notifications',
  operation_log_List_jiangXuanZhongDeTong: 'modify notification settings',
  operation_log_List_xiuGaiTongZhiShe: 'modified the system notification settings',
  operation_log_List_xiuGaiLeXiTong: 'modifies user information',
  operation_log_List_xiuGaiYongHuXin: 'modified the user information',
  operation_log_List_xiuGaiLeYongHu: 'binding mobile number',
  operation_log_List_bangDingShouJiHao: 'bound the phone number',
  operation_log_List_bangDingLeShouJi: 'modifies the mobile phone number',
  operation_log_List_xiuGaiShouJiHao: 'changed the phone number',
  operation_log_List_xiuGaiLeShouJi: 'binding mailbox',
  operation_log_List_bangDingYouXiang: 'bound the mailbox',
  operation_log_List_bangDingLeYouXiang: 'modify email',
  operation_log_List_xiuGaiYouXiang: 'modified the email address',
  operation_log_List_xiuGaiLeYouXiang: 'change password',
  operation_log_List_xiuGaiMiMa: 'changed the password',
  operation_log_List_xiuGaiLeMiMa: 'modifies enterprise information',
  operation_log_List_xiuGaiQiYeXin: 'modified the enterprise information',
  operation_log_List_xiuGaiLeQiYe: 'user name',
  operation_log_List_yongHuMing: 'operation time',
  operation_log_List_caoZuoShiJian: 'operand',
  operation_log_List_caoZuoDuiXiang: 'operation type',
  operation_log_List_caoZuoLeiXing: 'operation description',
  operation_log_List_caoZuoMiaoShu: 'user name',
  operation_log_List_yongHuMingCheng: 'Database replication drsncsp&;',
  purchase_Header_shuJuKuFuZhi: 'purchase history',
  purchase_Header_gouMaiLiShi: 'view product details',
  purchase_Header_zhaKanChanPinXiang: 'help documentation',
  purchase_Header_bangZhuWenDang: 'instance ordering',
  purchase_Header_shiLiDingGou: 'renewal',
  purchase_Header_xuDing: 'specification change',
  purchase_Header_guiGeBianGeng: 'billing method',
  purchase_Purchase_jiFeiFangShi: 'region and availability area',
  purchase_Purchase_diYuJiKeYong: 'synchronization topology',
  purchase_Purchase_tongBuTuoPu: 'instance specification___ Kaik instance name',
  purchase_Purchase_shiLiGuiGe: 'order duration',
  purchase_Purchase_shiLiMingCheng: 'ordered instances',
  purchase_Purchase_dingGouShiChang: 'renewal duration___ Expiration time after Kaikai renewal',
  purchase_Purchase_dingGouShiLiShu: 'configuration information___ Number of Kaikai instances',
  purchase_Purchase_xuDingShiChang: 'billing mode',
  purchase_Purchase_xuDingHouDaoQi: 'duration',
  purchase_Purchase_peiZhiXinXi: 'unit price',
  purchase_Purchase_shiLiShuLiang:
    '(_ Kaikai government enterprise group customer _ Kaikai current configuration _ Kaikai instance ID _ Kaikai ordering time _ Kaikai expiration time _ Kaikai monthly billing: it belongs to prepayment, that is, when creating an instance, you need to pay "monthly billing" Expenses',
  purchase_Purchase_jiFeiMoShi:
  ...
  purchase_Purchase_changDuXianZhiGe: 'is limited to 1 ~ 32 characters in length',
  purchase_Purchase_geYue: 'months',
  purchase_Purchase_ge: '1',
  purchase_Purchase_xuDingPeiZhi: 'renewal configuration',
  ...
  purchase_Purchase_2: '￥___ Total Kaikai expenses',
  purchase_Purchase_feiYongHeJi: '/ hour',
  purchase_Purchase_xiaoShi: ', I have read and agree',
  purchase_Purchase_woYiYueDuBing: 'confirms purchase',
  purchase_Purchase_queRenGouMai: 'refers to the price, and the specific deduction shall be subject to the bill',
  purchase_Purchase_canKaoJiaGeJu: 'knows the billing details',
  purchase_Purchase_liaoJieJiFeiXiang: 'confirms the order',
  purchase_Purchase_queRenDingDan: '/ month',
  purchase_Purchase_yue: '(same area)',
  purchase_Purchase_tongQuYu: ', the instance specification is consistent with the selected specification',
  purchase_Purchase_gaiShiLiGuiGe:
    ', your resource has started to be created. It is estimated that it will take a few minutes. You can check the instance list and proceed to the next step',
  purchase_Purchase_ninDeZiYuanYi: 'under approval',
  purchase_Purchase_shenPiZhong:
    ', your order is being approved. Please go to the order center to check the approval status',
  purchase_Purchase_ninDeDingDanZheng: 'request failed',
  purchase_Purchase_qingQiuShiBai: 'failed because:',
  purchase_Purchase_shiBaiYuanYin: ', please read and check the service agreement first',
  purchase_Purchase_qingXianYueDuBing: '<p>{val1}<span style="color:#409EFF">{val2}</span>、',
  copy_Info_pTHIS: '<span style="color:#409EFF">{val1}</span>、',
  copy_Info_sPANS: 'task name',
  task_Migration_renWuMingCheng: 'task type',
  task_Migration_renWuLeiXing: "'s agent",
  task_Migration_suoShuAGE: 'selects the task type',
  task_Migration_xuanZeRenWuLei: 'create task',
  task_Migration_chuangJianRenWu: 'reset',
  task_Migration_zhongZhi: 'database migration',
  task_Migration_shuJuKuQianYi: 'performs cross database replication on the database',
  task_Migration_duiShuJuKuJin: 'data table synchronization',
  task_Migration_shuJuBiaoTongBu: 'extracts the source data and calculates the conversion',
  task_Migration_chouQuYuanDuanShu: 'task status',
  task_Migration_renWuZhuangTai: 'synchronization type',
  task_Migration_tongBuLeiXing: 'agent name',
  task_Migration_aGENT: 'name',
  task_Migration_mingCheng:
    ': the scheduled running time of this task has been set. Manual startup will invalidate the scheduled running time. Are you sure you want to continue startup',
  task_Migration_gaiRenWuYiShe: ', do you want to start this task',
  task_Migration_shiFouQiDongGai: 'mission milestone',
  task_TaskProgress_renWuLiChengBei: 'milestone',
  task_TaskProgress_liChengBei: 'time',
  task_TaskProgress_shiJian: ', please enter the name of the table',
  task_TaskProgress_qingShuRuBiaoMing: 'database',
  task_TaskProgress_shuJuKu: 'data sheet',
  task_TaskProgress_shuJuBiao: 'data volume (row)',
  task_TaskProgress_shuJuLiangHang: 'progress',
  task_TaskProgress_jinDu: 'structure migration overview',
  task_TaskProgress_jieGouQianYiGai: 'plans to migrate 100 tables',
  task_TaskProgress_jiHuaQianYiBiao: 'has completed the migration of 100 tables',
  task_TaskProgress_yiWanChengQianYi:
    'estimated that the time needed for full completion: 24 hours, 23 minutes and 1 second',
  task_TaskProgress_yuJiQuanLiangWan: 'has migrated 100 tables',
  task_TaskProgress_yiQianYiZhangBiao: 'has 100 sheets in total',
  task_TaskProgress_gongZhangBiao: 'migration details',
  task_TaskProgress_qianYiXiangQing: 'Status:',
  task_TaskProgress_zhuangTai: 'task initialization',
  task_TaskProgress_renWuChuShiHua: 'structure migration___ Full synchronization kaik',
  task_TaskProgress_jieGouQianYi: 'incremental synchronization',
  task_TaskProgress_quanLiangTongBu: 'upload Avatar',
  task_TaskProgress_zengLiangTongBu: "'s current mobile phone:",
  user_Center_shangChuanTouXiang: ', please enter the current mobile phone',
  user_Center_dangQianShouJi: 'mobile phone verification code:',
  user_Center_qingShuRuDangQian: ', please enter the mobile phone verification code',
  user_Center_shouJiYanZhengMa: 'new password:',
  user_Center_qingShuRuShouJi: ', please enter a new password',
  user_Center_xinMiMa: 'confirm password:',
  user_Center_qingShuRuXinMi: 'verification code:',
  ...
  user_Center_qingShuRuYouXiang: ', please enter email',
  user_Center_qingShuRuYanZheng: ', please enter the verification code',
  user_Center_dangQianYouXiangYan: "'s current email verification code:",
  user_Center_xinYouXiang: 'new email:',
  user_Center_qingShuRuXinYou: ', please enter a new email address',
  ...
  user_Center_xiuGai: 'modification',
  user_Center_shouJiHao: 'mobile number:',
  user_Center_bangDing: 'binding',
  user_Center_touXiang: 'head:',
  user_Center_zanWu: 'not available',
  user_Center_qiYeXinXi: 'enterprise information',
  user_Center_gongSiMingCheng: 'Company Name:',
  user_Center_gongSiGuanWang: "'s official website:",
  user_Center_suoShuHangYe: "'s industry:",
  user_Center_suoShuChengShi: 'City:',
  user_Center_qiYeXinXiXiu: 'enterprise information modification',
  user_Center_zhiChiJPG: 'supports JPG, PNG and GIF formats, and the image size should be within 500kb',
  user_Center_qingShiYongWeiXin: ', please use wechat scanning QR code to bind tapdata cloud',
  user_Center_xiuGaiNiChengCheng: 'successfully modified the nickname',
  user_Center_shangChuanTouXiangTu: 'upload avatar image size can not exceed 500kb',
  user_Center_xiuGaiTouXiangCheng: 'successfully modified the Avatar',
  user_Center_qingXianBangDingShou: ', please bind your mobile number first',
  user_Center_bangDingShouJi: 'binding mobile phone___ The passwords entered by Kaikai are inconsistent',
  user_Center_shuRuMiMaBu: 'successfully changed the password',
  user_Center_xiuGaiMiMaCheng: 'successfully bound the mobile phone',
  user_Center_bangDingShouJiCheng: 'successfully modified the mobile phone',
  user_Center_xiuGaiShouJiCheng:
    'will not be able to use wechat to log in and receive wechat notifications after being released. Are you sure to unbind',
  user_Center_jieChuHouJiangWu: 'cancels wechat',
  user_Center_jieChuWeiXin: 'successfully unbound wechat',
  user_Center_jieBangWeiXinCheng: 'successfully bound mailbox',
  user_Center_bangDingYouXiangCheng: 'successfully modified the mailbox',
  user_Center_xiuGaiYouXiangCheng: 'successfully modified the enterprise information',
  user_Center_xiuGaiQiYeXin: ', please bind your mobile number',
  components_BindPhone_qingBangDingShouJi: ', please enter your mobile phone',
  components_BindPhone_qingShuRuShouJi: ', put it away',
  verify_Details_shouQi: 'expansion',
  verify_Details_zhanKai: 'selected task has a data source that does not support verification. Please select again',
  verify_Form_suoXuanRenWuCun: 'cannot find the table information corresponding to the node',
  verify_Form_zhaoBuDaoJieDian: 'type',
  verify_List_leiXing: 'frequency',
  verify_List_pinCi: 'results',
  verify_List_jieGuo: 'tapdata cloud version 1.0.9 has been released',
  ...
  workbench_Notice_tAPDA11:
    '2.  Continuous optimization to provide a better experience___ When Kaikai creates a connection, the user can select the connection type',
  workbench_Notice_buDuanYouHuaTi: 'adds log filtering function this time. Users can filter through log filtering',
  workbench_Notice_zaiChuangJianLianJie:
    '3.  Support batch operation and better experience___ In the Kaikai field mapping part, the table name, field name and case setting support users to adjust in batches, which is simple and fast, and greatly improves the processing efficiency',
  workbench_Notice_benCiXinZengRi: '4.  Multi dimensional statistics, more intuitive understanding of task progress',
  workbench_Notice_zhiChiPiLiangCao:
    '1. Version 0.9 optimizes the details of database synchronization tasks. Users can see the synchronization progress and the synchronization process at a glance',
  workbench_Notice_ziDuanYingSheBu: 'upgrade announcement___ Dear user friends of Kaikai:',
  ...
  workbench_Notice_tAPDA8:
    'tapdata cloud new year version update: details control benefits! The data source is newly added, which supports the custom collection "start time" of incremental tasks',
  workbench_Notice_kaiNianYouFengGeng:
    'is updated again at the beginning of the new year, and the optimization never stops - the new version of tapdata cloud has been released',
  ...
  workbench_Notice_sheZhiZengLiangCai: 'sets the incremental acquisition time point',
  ...
  workbench_Notice_xinZengMAR: 'adds MariaDB support',
  workbench_Notice_xiJieGengXinYou:
    '3.  Detail update: optimize the pop-up prompt for editing "run tasks" to avoid misoperation',
  workbench_Notice_zhiChiSheZhiZeng: 'supports setting incremental acquisition time points',
  workbench_Notice_gongNengShengJiCao: 'function upgrade operation is more flexible',
  ...
  workbench_Notice_shuJuYuanZaiShang: 'data source update',
  ...
  workbench_Notice_weiXiaoDanTieXin2: "is small but intimate, and it's more reassuring to use it",
  ...
  workbench_Notice_tAPDA7:
    'tapdata cloud 2.1.0 is coming: the latest version supports Alibaba cloud database access. The Windows version has lighter operation and a comprehensive upgrade of the user experience!',
  ...
  workbench_Notice_kaiShiZhiChiYun: 'began to support cloud database access',
  workbench_Notice_benLunXinZengA:
    ', aliyun added in this roundMariaDB, aliyun mongodb, aliyun RDS for sqlserver, aliyun RDS for PG, aliyun RDS for MySQL as the source and target',
  workbench_Notice_youHuaWIN: 'optimizes the Windows version packaging and installation process',
  workbench_Notice_liuChengGengQingXi: ', the process is clearer and the deployment operation is simpler',
  workbench_Notice_xinZengYongHuZhong2: 'added user center module',
  workbench_Notice_zhiChiXiuGaiZhu:
    ': it supports the modification of initial registration information, including the editing of nickname, avatar, password and enterprise information, as well as the new binding and switching of mobile phone number and email',
  workbench_Notice_xinZengRenWuShu2: 'added task data visualization module',
  workbench_Notice_yongHuGongZuoTai:
    ': the "daily data volume trend chart of tasks" can be seen on the user workbench ➕ "Cumulative data volume chart"',
  workbench_Notice_shuJuLianJieYou2: '\'s data connection is new again, and the "cloud" is coming',
  ...
  workbench_Notice_mianDuiDaLiangYong:
    'Facing the urgent needs of a large number of users to connect to the cloud database, tapdata cloud gives priority to response. In this update, aliyun MariaDB and aliyun are supportedMongodb, aliyun RDS for sqlserver, aliyun RDS for PG and aliyun RDS for MySQL are the source and target. Tapdata, just zoom inLatest achievements of cloud "wall breaking operation" 👇：',
  workbench_Notice_wINDO: 'Windows version process optimization',
  workbench_Notice_shaGuaMoShiZai:
    '\'s "fool mode" is upgraded, installed and deployed more efficiently___ Is the installation and deployment of kaikaikaitapdata cloud easy to use? We can be simpler 👉',
  workbench_Notice_tAPDA6: "'s update focuses on the re optimization of the operating process of the Windows version:",
  workbench_Notice_benCiGengXinZhong2:
    "'s agent deployment method: after the user downloads the agent installation package, double-click execute to complete the installation and deployment",
  workbench_Notice_zaiAGEN:
    "During installation: the new version will automatically detect the user's Java environment. If the user's Java environment does not meet the running needs, it will automatically download JREWith, there is no need to configure the Java environment in advance. (* manually highlight: the downloaded JRE has no intrusion into the customer environment",
  workbench_Notice_zaiAnZhuangGuoCheng: 'added "user center" page',
  workbench_Notice_wuRenHeQinRu: ', your new personalization feature is online',
  workbench_Notice_3:
  ...
  workbench_Notice_xinZengYongHuZhong: 'new task data volume statistical chart display',
  workbench_Notice_niDeGeXingHua: 'is clearer because it is visible',
  ...
  workbench_Notice_xuQiuChiXuGeng3:
    "'s needs are constantly updated and optimized - the March version of tapdata cloud is updated again",
  workbench_Notice_zuiXinFaBuDe3:
    'Newly released 2.1.1In the version, Tencent cloud database is newly connected. In addition to expanding the access area of cloud database again, it adheres to the iterative guidance of giving priority to user experience and focuses on removing three "small nails" that are easy to kick in the past use',
  workbench_Notice_shuJuLianJieShang: 'data connection is new, and cloud database access is new',
  workbench_Notice_ciFanZengJiaLe:
    ': tencentdb forMysql, tencentdb for MariaDB, tencentdb for PG, tencentdb for sqlserver, and tencentdb mongodbAs source and target',
  workbench_Notice_kaiShiZhiChiRen: 'began to support "scheduled release" of tasks',
  workbench_Notice_quanLiangRenWuKe2:
    ': the [full volume] task can specify the "execution cycle". The [full volume + incremental] & [incremental] task can also set the "planned running time". 1Second, liberate migrant workers, non working hours are not hard',
  workbench_Notice_kaiShiZhiChiZhi: 'began to support "revalidation" of specified single table or multiple tables',
  workbench_Notice_shuJuJiaoYanHuan:
    ": in the data verification phase, you can independently initiate re verification for tables with inconsistent verification. You don't have to start from scratch. You're not afraid of a large amount of data and multiple tables",
  workbench_Notice_ziDuanYingSheGuo2: 'supports modifying a single table name during field mapping',
  workbench_Notice_zaiYuanYouDePi:
    ': Based on the original batch table name change, the modification of a single table name is added to realize the freedom of table name change and easier operation',
  workbench_Notice_yunShuJuKuJie: 'cloud database access is new again',
  workbench_Notice_banTuYouJianXin: "'s territory has seen a new look, and Tencent cloud database has now settled in",
  workbench_Notice_zuoWeiGuoNeiShou2:
    'As the first heterogeneous database real-time synchronization cloud platform in China, tapdata cloudContinuously expand the data connection layout that can be supported, strive to meet the diversified data sources and target needs of users, and truly realize the "comprehensive breaking wall" of real-time data synchronization',
  workbench_Notice_jiBanBenShouCi:
    'Following the first cloud database access in version 2.1.0, tapdata cloud continues to make efforts. In this update, China Cloud database will go to five cities and support tencentdb forMysql, tencentdb for MariaDB, tencentdb for PG, tencentdb for sqlserver, tencentdb mongodb as the source and target___ The number of Kaikai data source sites expanded to',
  workbench_Notice_shuJuYuanJuDian:
    '。 Zoom in to see the latest achievements of tapdata cloud\'s "wall breaking operation" 👇：',
  workbench_Notice_fangDaJiuKanT: 'hi, your task has been released regularly',
  workbench_Notice_hINiDeRen:
    'does not work overtime passively, starting from setting the "execution cycle" and "running" time independently___ Is Kaikai still depressed about the need to start tasks during non working hours___ Is Kaikai still bothered by the need to manually start periodic full-scale tasks over and over again',
  workbench_Notice_buBeiDongJiaBan: '- the "scheduled release of tasks" function you want is online',
  workbench_Notice_haiZaiWeiXuYao2: '[full amount + increment] and [increment] tasks can specify "start time"',
  ...
  workbench_Notice_sheZhiShiJianQian: 'sets the time and the task starts',
  workbench_Notice_sheZhiShiJianDao: '[full volume] task can specify "operation cycle"',
  ...
  workbench_Notice_zhenDuiQuanLiangRen:
    'Specific process: open the setting and display the [scheduling expression] input box → hover the help icon to display the input help and sample of cron expression → fill in the task cycle according to the instructions and actual needs → complete other settings and save the task → the task runs stably according to the set fixed time, date and interval___ Behind the Kaikai direction input box, the instructions for filling in the dispatching expression can be seen',
  workbench_Notice_juTiLiuChengDa: 'example: set the scheduling cycle to run every five minutes',
  workbench_Notice_zhiLuShuRuKuang: 'task not started',
  workbench_Notice_shiLiSheZhiTiao: 'mission starts for the first time',
  workbench_Notice_renWuWeiQiDong: 'task starts again',
  workbench_Notice_renWuDiYiCi: 'supports revalidation of the specified table',
  workbench_Notice_renWuZaiCiQi:
    ', only individual tables are inconsistent in verification? Now you can delimit a small area and recheck it',
  ...
  workbench_Notice_congZheYiBanKai2: 'field mapping supports modifying a single table name',
  workbench_Notice_xinBanBenZhiChi2: 'breaks through limitations and is more convenient',
  workbench_Notice_ziDuanYingSheShi:
    'Tapdata Cloud 2.1.1In view of the limitations of the function of "only supporting batch change of table name" in the historical version in the actual operation environment, starting from the actual needs of users, the ability of "single table name modification" is added on the basis of the original function of "batch change of table name"___ Under Kaikai\'s new function, users can:',
  ...
  workbench_Notice_tAPDA5: 'source table data',
  workbench_Notice_xinGongNengXiaYong: 'write',
  workbench_Notice_zaiQianYiGuoCheng: 'specifies the target table',
  workbench_Notice_yuanBiaoShuJu: 'By modifying the target table name to the same table name, the',
  workbench_Notice_xieRu: 'multiple source tables with the same structure',
  workbench_Notice_zhiDingMuBiaoBiao: 'same target table',
  ...
  workbench_Notice_duoGeJieGouXiang:
    "'s needs are constantly updated and optimized - tapdata cloud version 2.1.2 is coming",
  workbench_Notice_tongYiMuBiaoBiao:
  ...
  workbench_Notice_tAPDA4: 'added support for Vika',
  workbench_Notice_xuQiuChiXuGeng2:
    ': open up the real-time data channel with "new generation team data collaboration + project management artifact" to help further improve business transformation and collaboration efficiency',
  workbench_Notice_zuiXinFaBuDe2: 'field type can be modified in batch',
  workbench_Notice_xinZengZhiChiV:
  ...
  workbench_Notice_daTongYuXinYi: "'s code scanning login function is online",
  ...
  workbench_Notice_qingLiangQingLiangGeng: 'lightweight + lightweight = easier to use',
  ...
  workbench_Notice_jiangXueShengChengJi: 'imports student scores into Vika',
  workbench_Notice_2: '：',
  workbench_Notice_caoZuoYanShiJiang: 'operation demonstration: import student scores into Vika',
  workbench_Notice_zhiChiZiDuanLei: 'supports batch modification of field types',
  workbench_Notice_ziDuanLeiXingZhuan:
    'field type conversion exception leads to task error. What should I do? Now you can modify it manually',
  ...
  workbench_Notice_shiXianSaoMaZhu: 'realizes code scanning registration and login',
  workbench_Notice_jiSaoJiYongKuai: 'swipe and use, fast and at your heart',
  workbench_Notice_zhangHaoMiMaRong:
    'account and password are easy to mix, and SMS verification needs to wait. What if you want to log in quickly',
  ...
  workbench_Notice_weiXiaoDanTieXin: 'is small but intimate, and its use experience is constantly upgraded',
  workbench_Notice_yongHuDaoXiangXi:
    'is user-oriented and detail oriented - this time, we optimized the SMS notification strategy and the connection creation process',
  workbench_Notice_ziZhuKaiGuanDuan: 'self service switch SMS notification authority',
  ...
  workbench_Notice_gengKuaiDingWeiLian: 'locates connection types faster',
  ...
  workbench_Notice_tAPDA2: 'tapdata 2.1.3 is coming: Apache Doris is added as the target, and the task query is faster',
  workbench_Notice_xuQiuChiXuGeng:
    "'s requirements are constantly updated and optimized - tapdata cloud 2.1.3 is coming!",
  ...
  workbench_Notice_xinZengZhiChiA: 'added Apache Doris support as its target',
  ...
  workbench_Notice_kaiShiZhiChiZai:
    ': it starts to support the direct export of logs on the task operation monitoring page, which makes the query faster',
  workbench_Notice_kaiShiZhiChiD: 'began to support Doris as his goal',
  workbench_Notice_qiangQiangLianShouGong: 'joins hands to build the next generation data architecture',
  workbench_Notice_suiZheXinXingGuo:
    ', with the continuous emergence of emerging domestic databases, tapdata cloud continues to make efforts to join hands with more high-quality domestic databases. The new data target Apache in this updateDoris, also launched recently',
  workbench_Notice_tAPDA:
    "tapdata PDK ecological co construction plan___ One of Kaikai's first co construction partners will work with tapdataJoin hands to break the data island, build a next-generation data architecture, and provide users with an efficient and unified data application and analysis platform",
  workbench_Notice_deShouPiGongJian: 'So far, tapdata cloud___ The number of Kaikai data connection sites expanded to',
  workbench_Notice_zhiCiTAP: 'small optimization, more intimate',
  workbench_Notice_shuJuLianJieJu:
    "📣 From this version, when you need to query the task log, you don't need to go back to the agent to pull it___ In the new version of Kaikai, when there is a problem with a user's task and you need to view the log to locate the problem, you can directly export the log on the operation monitoring page (you can select [time range]) without returningAgent deployment server finds log files. The operation is more humanized",
  workbench_Notice_xiaoYouHuaGengTie: 'tapdata cloud version 2.1.3 has been released',
  workbench_Notice_congZheYiBanKai: 'tapdata cloud version 2.1.2 has been released',
  workbench_Notice_xinBanBenXiaDang: 'tapdata cloud version 2.1.1 has been released',
  workbench_Workbench_tAPDA5: 'tapdata cloud version 2.1.0 has been released',
  workbench_Workbench_tAPDA4: 'tapdata cloud version 2.0.1 has been released',
  workbench_Workbench_tAPDA3:
    'tapdata 2.1.4 is coming: the data connection is new again, polardb MySQL and light flow start to access, and the unsupported field types can be automatically marked',
  workbench_Workbench_tAPDA2:
    "'s needs are constantly updated and optimized - tapdata cloud 2.1.4 is coming___ In the latest version of Kaikai, in addition to adding data connections, the default flag does not support synchronized field types to avoid affecting the normal operation of tasks___ New on Kaikai data connection",
  workbench_Workbench_tAPDA:
    ': Alibaba cloud polardb MySQL is newly supportedAs the source and target, the new platform "light flow" supporting codeless system is added as the target',
  workbench_Notice_tAPDA1: 'auto tag unsupported field type',
  workbench_Notice_xuQiuChiXuGeng1:
    ': for field types that do not support synchronization, they are marked as not supported by default during field mapping. Quickly locate and delete them to ensure the normal operation of the task',
  workbench_Notice_zuiXinFaBuDe1: 'data connection adds new members',
  workbench_Notice_shuJuLianJieShang1: 'continues to build a 1 + 1 > 2 user experience',
  workbench_Notice_xinZengZhiChiA1:
    'is the first heterogeneous database real-time synchronization cloud platform in China, tapdata cloudContinuously expand the data connection layout that can be supported, strive to meet the diversified data sources and target needs of users, and truly realize the "comprehensive breaking wall" of real-time data synchronization. 2.1.4New partners have joined the version:',
  workbench_Notice_ziDongBiaoJiBu: 'added polardb MySQL as the source and target',
  workbench_Notice_duiYuYiJingMing:
    ', with the continuous emergence of emerging domestic databases, tapdata cloud continues to make efforts to join hands with more high-quality domestic databases. The latest access in this update',
  workbench_Notice_shuJuLianJieZai: 'Alibaba cloud polardb MySQL',
  ...
  workbench_Notice_weiShuJuMuBiao:
    'is the data target. As a codeless system building platform, light flow supports 0 code and quickly builds business systems, which can effectively improve work efficiency and reduce management costs. When the lightweight heterogeneous data real-time synchronization tool meets the lightweight digital management tool, the ease of use of the two can be doubled. User assistanceTapdata cloud quickly imports business data into light flow, providing stable and reliable data support for more agile use of light flow for digital management',
  workbench_Notice_ziDongBiaoJi: 'automatic marking___ Field type not supported by Kaikai',
  workbench_Notice_buZhiChiDeZi: 'quickly locates and deletes, and the task runs unimpeded',
  workbench_Notice_kuaiSuDingWeiShan:
    'gives a solution to the problem that the normal operation of the task is affected by errors caused by special field types in some databases that do not support synchronization in the historical version:',
  workbench_Notice_zhenDuiLiShiBan1:
    "In this version, for the field types that explicitly do not support synchronization, they will be marked as not supported by default during field mapping. These fields will be automatically deleted when entering the field mapping page, and there is no need to locate them manually (__ Kaikai * highlight _ Kaikai: you can clearly see in the task interface that the corresponding fields are deleted because of [not supported], and the [deleted] fields do not support recovery __ Kaikai), So as to ensure the normal operation of the task and avoid frequent errors caused by users' unclear which fields are not supported",
  workbench_Notice_gaiBanBenXiaDui: 'tapdata cloud version 2.1.4 has been released',
  workbench_Notice_huaZhongDian: 'does not support',
