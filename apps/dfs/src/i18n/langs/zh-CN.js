export default {
  ...
  dfs_instance_create_bencidinggouzhi: '本次订购只适用{val1}规格的实例',
  dfs_instance_create_zhifuwancheng: '支付完成',
  dfs_instance_create_tuijian: '推荐',
  dfs_instance_create_jieshouzhangdande: '接收账单的邮箱',
  dfs_instance_create_xuanzeshiligui: '选择实例规格',
  dfs_instance_create_qinggenjushuju: '请根据数据量和任务数量选择合适的实例规格进行订阅，订阅成功后，不可变更',
  ...
  dfs_instance_selectlist_bangdingshilizhuang: '绑定实例状态',
  dfs_instance_selectlist_dingyuezhouqi: '订阅周期',
  dfs_instance_selectlist_dingyueneirong: '订阅内容',
  dfs_instance_selectlist_keyixuanzeyi: '可以选择已有未使用的订阅创建实例，可以创建新实例选择更多规格',
  dfs_instance_selectlist_xuanzedingyue: '选择可用的订阅创建实例',
  public_operation: '操作',
  dfs_instance_selectlist_shiliguige: '实例规格',
  ...
  dfs_instance_selectlist_xuanzeshouquanma: '选择可用授权码创建实例',
  dfs_instance_selectlist_chuangjianxinshili: '创建新实例',
  ...
  dfs_instance_expired_time_tip2: '1.禁止调度新任务到过期的实例上去运行',
  ...
  dfs_user_center_ninjiangquxiaoding: '您将取消订阅“{val1}实例”业务，取消后您将不再享受该服务，确定是否继续？',
