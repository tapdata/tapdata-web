export default {
  ...
  errorCode_networkUnconnected: '网络未连接',
  errorCode_serverAbnormal: '服务器异常',
  errorCode_requested: '请求的资源不存在',
  errorCode_unauthorized: '未授权',
  errorCode_parameters: '参数不正确',
  errorCode_timeout: '请求超时',
  app_document: '帮助文档',
  app_qa: '客服',
  app_version: '系统版本',
  app_home: '官网',
  ...
  role_page_Dashboard_menu: '控制台(首页)',
  role_page_datasource_menu: '数据源',
  role_page_Data_SYNC_menu: '迁移 & 数据同步',
  ...
  role_page_API_data_explorer_menu: 'API数据浏览',
  role_page_API_doc_test_menu: 'API文档测试',
  role_page_API_stats_menu: 'API统计分析',
