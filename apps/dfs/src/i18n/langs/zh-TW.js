export default {
  ...
  //实例
  dfs_agent_down_tishi: 'Agent 實例已刪除，不能繼續部署。',
  ...
  dfs_instance_create_bencidinggouzhi: '本次訂購只適用{val1}規格的實例',
  dfs_instance_create_zhifuwancheng: '支付完成',
  dfs_instance_create_zhangdanyifasong: '賬單已發送至郵箱，請查收',
  dfs_instance_create_tuijian: '推薦',
  dfs_instance_create_jieshouzhangdande: '接收賬單的郵箱',
  dfs_instance_create_xuanzeshiligui: '選擇實例規格',
  dfs_instance_create_qinggenjushuju: '請根據數據量和任務數量選擇合適的實例規格進行訂閱，訂閱成功後，不可變更',
  ...
  dfs_instance_selectlist_getPa: '{val1} {val2} 實例',
  dfs_instance_selectlist_bangdingshilizhuang: '綁定實例狀態',
  dfs_instance_selectlist_dingyuezhouqi: '訂閱週期',
  dfs_instance_selectlist_dingyueneirong: '訂閱內容',
  dfs_instance_selectlist_keyixuanzeyi: '可以選擇已有未使用的訂閱創建實例，可以創建新實例選擇更多規格',
  dfs_instance_selectlist_xuanzedingyue: '選擇訂閱？ ',
  public_operation: '操作',
  dfs_instance_selectlist_shiliguige: '實例規格',
  ...
  dfs_instance_selectlist_xuanzeshouquanma: '選擇授權碼?',
  dfs_instance_selectlist_chuangjianxinshili: '創建新實例',
  ...
  dfs_instance_expired_time_tip2: '1.禁止調度新任務到過期的實例上去運行',
  ...
  dfs_user_center_ninjiangquxiaoding: '您將取消訂閱“{val1}實例”業務，取消後您將不再享受該服務，確定是否繼續？ ',
  ...
  dfs_user_center_tsubs: '{val1} {val2} 實例',
