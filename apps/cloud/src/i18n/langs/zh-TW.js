export default {
  ...
  operation_log_agent_delete: '退訂Agent',
  operation_log_agent_delete_tip: '退訂了Agent【@{parameter1}】',
  ...
  operation_log_agent_start: '啟動Agent',
  operation_log_agent_start_tip: '啟動了Agent【@{parameter1}】',
  operation_log_agent_restart: '重啟Agent',
  operation_log_agent_restart_tip: '重啟了Agent【@{parameter1}】',
  ...
  instance_Instance_anIDShiLi: '按ID/Agent名稱搜索',
  ...
  //Agent
  dfs_agent_down_tishi: 'Agent 已被刪除，請返回管理頁面重新創建。',
  dfs_agent_down_tishi_running: 'Agent 已經在運行中，請返回管理頁面查看。',
  ...
  dfs_agent_download_agentdownloadmodal_ninkeyixuanze:
    '1. 您可以選擇按流量計費或者預付包月/年，也可以免費試用3天，3天后服務器資源將自動回收，您需要重新部署Agent才能繼續使用TapData，根據您的付費方式，請點擊下方按鈕跳轉到阿里雲創建您的雲服務器，Tapdata  Agent會自動安裝在该實例上，如果沒有賬號可以現場註冊：',
  ...
  dfs_aliyun_market_checklicnese_ninhaimeiyouji:
    '您還沒有激活授權碼，請到阿里雲市場複製授權碼並在授權碼激活頁面激活',
  ...
  dfs_views_error_zuoweidailihuo:
    '作為代理或網關使用的服務器從請求響應鏈的下一條鏈路上收到了一條偽響應。 ',
  ...
  dfs_plugins_element_chongfuxiaoxi: '重複消息',
  dfs_aliyun_market_license_aliyunshichang: '阿里雲市場',
  dfs_aliyun_market_license_dianjidakai: '1.點擊打開',
  dfs_instance_create_kexuan: '（可選）',
  dfs_instance_create_yongyujieshoumei: '用於接收每期訂閱支付賬單',
  dfs_instance_create_qingshuruzhengque: '請輸入正確的郵箱地址',
  dfs_instance_create_qingshuruninde: '請輸入您的郵箱',
  dfs_instance_create_bencidinggouzhi: '本次訂購只適用{val1}規格的Agent',
  dfs_instance_create_zhifuwancheng: '支付完成',
  dfs_instance_create_tuijian: '推薦',
  dfs_instance_create_jieshouzhangdande: '接收賬單的郵箱',
  dfs_instance_create_xuanzeshiligui: '選擇Agent規格',
  dfs_instance_create_qinggenjushuju:
    '請根據數據量和任務數量選擇合適的Agent規格進行訂閱，訂閱成功後，不可變更',
  dfs_instance_create_xuyaogengduode: '需要更多的服務',
  dfs_instance_instance_shouquanmafuwu: '授權碼服務',
  dfs_instance_instance_pclas:
    '<p class="flex align-content-center">點擊打開<a class="color-primary text-decoration-underline" href="{val1}" target="_blank">阿里雲市場</a>購買實例，並獲取授權碼</p>',
  dfs_instance_instance_daoqishijian: '到期時間',
  dfs_instance_instance_dingyuefangshi: '訂閱方式',
  dfs_instance_instance_guige: '規格',
  dfs_instance_selectlist_yibangding: '已綁定',
  dfs_instance_selectlist_bangdingshilizhuang: '綁定Agent狀態',
  dfs_instance_selectlist_dingyuezhouqi: '訂閱週期',
  dfs_instance_selectlist_dingyueneirong: '訂閱內容',
  dfs_instance_selectlist_keyixuanzeyi:
    '可以選擇已有未使用的訂閱創建Agent，可以創建新Agent選擇更多規格',
  dfs_instance_selectlist_xuanzedingyue: '選擇可用的訂閱創建Agent',
  public_operation: '操作',
  dfs_instance_selectlist_shiliguige: 'Agent規格',
  dfs_instance_selectlist_youxiaoqi: '有效期',
  dfs_instance_selectlist_shouquanma: '授權碼',
  dfs_instance_selectlist_shouquanmashizai:
    '授權碼是在阿里雲市場購買生成的授權碼',
  dfs_instance_selectlist_xuanzeshouquanma: '選擇可用授權碼創建Agent',
  dfs_instance_selectlist_chuangjianxinshili: '創建新Agent',
  dfs_instance_selectlist_goumaixinshili: '購買新實例',
  dfs_instance_utils_geyue: '個月',
  ...
  dfs_instance_tapdata_agent_status_tip:
    'tapdata啟停管理服務已離線，請手動在安裝目錄執行啟停操作。',
  dfs_user_center_zhifufuwu: '支付服務',
  dfs_user_center_ninjiangzhifur:
    '您將支付“{val1}”業務，支付後您將享受該服務，確定是否繼續？ ',
  dfs_user_center_xudingfuwu: '續訂服務',
  dfs_user_center_ninjiangxudingr:
    '您將續訂“{val1}”業務<span class="fw-bolder font-color-dark">{val2}</span>，確定是否繼續？ ',
  dfs_user_center_quxiaodingyuefu: '取消訂閱服務',
  dfs_user_center_ninjiangquxiaoding:
    '您將取消訂閱“{val1}Agent”業務，取消後您將不再享受該服務，確定是否繼續？ ',
  dfs_user_center_tuidingfuwu: '退訂服務',
  dfs_user_center_ninjiangtuidingr:
    '您將退訂“{val1}”業務，退訂後您將不再享受該服務，確定是否繼續？ ',
  dfs_user_center_dingdanhao: '訂單號',
  dfs_user_center_zhifushijian: '支付時間',
  ...
  dfs_user_center_guoqishijian2: '過期時間',
  dfs_user_center_jihuoshijian2: '激活時間',
  dfs_user_center_jine: '金額',
  dfs_user_center_dingyueshuliang: '訂閱數量',
  dfs_user_center_yibangdingshili: '已綁定Agent',
  dfs_user_center_fuwudingyuexin: '服務訂閱信息',
  dfs_user_center_qingxianshanchushi: '請先刪除Agent',
  ...
  dfs_agent_download_fastdownload_fuzhiTok:
    '方法二: 複製Token,在命令行部署啟動Agent',
  dfs_agent_download_fastdownload_shuangjizhixingt:
    '3. 雙擊執行tapdata.exe開始安裝。 ',
  dfs_agent_download_fastdownload_jiangwenjianta:
    ' 2. 將文件 tapdata.exe 和 application.yml 放入您要安裝的目錄，安裝路徑不能有中文和特殊字符。 ',
  ...
  dfs_agent_download_subscriptionmodeldialog_jihuoxinshouquan: '激活新授權碼',
  dfs_agent_download_subscriptionmodeldialog_xuanzebizhong: '選擇幣種',
  ...
  dfs_agent_download_subscriptionmodeldialog_gengjiakekaoyou:
    '- 更加可靠: 由 Tapdata 提供資源使用的維護與監控, 運行更可靠',
  ...
  dfs_agent_download_subscriptionmodeldialog_zaizhezhongmoshi:
    '在這種模式下, Tapdata 提供所有的計算及存儲資源.',
  dfs_agent_download_subscriptionmodeldialog_gengjiaanquanyong:
    '- 更加安全: 用戶的數據不會經過包括 Tapdata 在內的任意外部網絡',
  dfs_agent_download_subscriptionmodeldialog_chengbengengdichong:
    '- 成本更低: 充分利用已有硬件資源, 同樣的規格下產品價格低很多',
  dfs_agent_download_subscriptionmodeldialog_shiyongbantuoguan:
    '使用半託管模式的好處：',
  dfs_agent_download_subscriptionmodeldialog_zaizhezhongmoshi2:
    '在這種模式下, 你需要自己提供自己計算資源與存儲資源',
  dfs_agent_download_subscriptionmodeldialog_quantuoguanmoshi: '全託管模式',
  dfs_agent_download_subscriptionmodeldialog_bantuoguanmoshi: '半託管模式',
  dfs_instance_instance_quxiaodingyue: '取消訂閱',
  dfs_views_layout_chanpinyindao: '產品引導',
  dfs_agent_download_subscriptionmodeldialog_chakanbingqueren: '查看並確認',
  dfs_agent_download_subscriptionmodeldialog_peizhibushugui: '配置部署規格',
  dfs_agent_download_subscriptionmodeldialog_xuanzebushulei: '選擇部署類型',
  ...
  dfs_instance_instance_shifujine: '實付金額',
  dfs_instance_instance_yuanlutuihui: ' 原路退回',
  dfs_instance_instance_ketuidingjine: '可退訂金額：',
  dfs_instance_instance_tuikuanqudao: '退款渠道',
  dfs_instance_instance_qita: '其他',
  dfs_instance_instance_yewuceshiwan: '業務測試完畢退訂',
  dfs_instance_instance_xingnenghuozhegong: '性能或者功能不符合預期',
  dfs_instance_instance_wufazhengchangbu: '無法正常部署',
  ...
  dfs_instance_instance_qingzixihedui:
    '2. 請仔細核對退訂實例的信息，並確認退訂規則和退訂金額，實例一經退訂無法恢復。 ',
  dfs_instance_instance_tuidingzhituihuan:
    '1. 退訂只退還實付金額的部分，已使用優惠卷不退還。 ',
  ...
  dfs_instance_createagent_shishishucang: '實時數倉',
  dfs_instance_createagent_apIkuaisu: 'API 快速發布',
  dfs_instance_createagent_cunchuziyuan: '存儲資源費用: ',
  dfs_instance_createagent_jisuanziyuan: '計算資源費用: ',
  dfs_instance_createagent_cunchukongjian: '存儲空間',
  ...
  dfs_ticketing_system_details_wenti: '問題: ',
  dfs_ticketing_system_details_tijiaoshijian: '提交時間: ',
  dfs_ticketing_system_details_gongdanzhuangtai: '工單狀態:',
  dfs_ticketing_system_details_gongdanbianhao: ' 工單編號:',
  dfs_ticketing_system_details_renwu: ' 任務:',
  dfs_ticketing_system_details_shujuyuan: ' 數據源:',
  dfs_ticketing_system_details_zhuti: ' 主題:',
  dfs_ticketing_system_details_gongdanxiangqing: '工單詳情',
  dfs_ticketing_system_list_gongdanyiguanbi: '工單已關閉',
  dfs_ticketing_system_list_shurugongdanming: '輸入工單名稱',
  dfs_ticketing_system_list_qingmiaoshuninde: '請描述您的問題',
  dfs_ticketing_system_list_qingshuruzhuti: '請輸入主題',
  dfs_ticketing_system_list_xuanzeshujuyuan: '選擇數據源',
  dfs_ticketing_system_list_qingxuanzexuanze: '請選擇選擇任務',
  dfs_ticketing_system_list_tijiaoshijian: '提交時間',
  dfs_ticketing_system_list_gongdanzhuangtai: '工單狀態',
  dfs_ticketing_system_list_gongdanbianhao: '工單編號',
  dfs_ticketing_system_list_wenti: '問題',
  ...
  dfs_guide_deploy_qingfuzhixiafang:
    ' 請複制下方命令並在部署環境執行，其包含鏡像的下載及運行，計算引擎 的下載、自動部署及啟動',
  dfs_guide_deploy_wanchengdoc:
    '完成 docker 服務安裝後, 請複制下方命令執行, 執行後, 等待平台檢測引擎啟動',
  dfs_guide_deploy_qingfuzhixiafang2:
    '請複制下方命令, 在目錄中執行, 執行後, 等待平台檢測引擎啟動',
  dfs_guide_index_bushujisuanyin: '部署計算引擎',
  dfs_guide_index_qingxuanzeninxiang:
    '請選擇您想通過本產品完成您的什麼需求呢？ ',
  dfs_guide_index_xuanzejisuanyin: '選擇計算引擎規格',
  dfs_guide_index_shezhishujuku: '設置數據庫網絡環境',
  dfs_guide_index_quedingshiyongchang: '確定使用場景',
  dfs_guide_index_zhanghaoanquanbang: '賬號安全綁定',
  dfs_guide_index_zhengzaijianceyin:
    '正在檢測引擎部署狀態，檢測完成之後自動進入任務引導頁面。 ',
  dfs_guide_index_waiting_for_deployment_tip:
    '完成本地部署後，請點擊「我已部署完成按鈕」以結束新手引導。',
  ...
  dfs_guide_scenes_meiyoutedingde: '沒有特定的需求',
  dfs_guide_scenes_qitachangjing: '其他場景',
  dfs_guide_scenes_yigoushujuku: '異構數據庫同步',
  dfs_guide_scenes_bendishujushang: '本地數據上雲',
  dfs_guide_scenes_shujurucangjia: '數據入倉，加速查詢',
  dfs_guide_scenes_kuayunshujushi: '跨雲數據實時同步',
  dfs_guide_spec_ninxuyaozixing:
    '您需要自行安裝一個計算引擎到您的網絡環境中, 選擇一種合適的方式吧。 ',
  ...
  dfs_components_taskalarmtour_jiancedaoninwei:
    '檢測到您未綁定郵箱，請先綁定郵箱用於接收任務告警通知',
  dfs_mixins_tour_qingxianqidongnin: '請先啟動您的 Agent 計算引擎',
  dfs_mixins_tour_dianjicichuchuang: '點擊此處創建您的第一個複制任務',
  dfs_mixins_tour_qingchuangjianninde: '請創建您的第一個複制任務',
  dfs_mixins_tour_dianjicichuchuang2: '點擊此處創建您的目標數據庫',
  ...
  dfs_instance_instance_shengji: '升級',
  dfs_instance_instance_xintiaobinlu: '心跳頻率',
  dfs_components_taskalarmtour_deployment_qingwen:
    '請問您的源和目標數據庫, 可以從互聯網上直接訪問嗎?',
  dfs_components_taskalarmtour_deployment_bukeyi: '不可以 (需要您部署計算引擎)',
  dfs_components_taskalarmtour_deployment_wodeshujuku:
    '您的數據庫在局域網內, 或者出於安全考慮, 無法暴露在公共網絡中',
  dfs_components_taskalarmtour_deployment_keyi: '可以 (平台維護計算引擎)',
  dfs_components_taskalarmtour_deployment_yunshujuku:
    '您的數據庫均為雲數據庫, 且可以暴露到公共網絡',
  dfs_components_taskalarmtour_deployment_zhunbei:
    '準備Tapdata Cloud 計算引擎環境部署，如遇問題可',
  dfs_components_taskalarmtour_deployment_zixun: '諮詢客服',
  dfs_components_taskalarmtour_deployment_anpai:
    '要安裝計算引擎,請先在下方選擇您的服務器類型 : ',
  dfs_components_taskalarmtour_account_zhuanghao:
    '為了賬號安全和數據任務狀態能快速通知到您，請您綁定手機號。 ',
  public_payment: '支付',
  ...
  dfs_change_instance_tip:
    '規格變更僅支持由小規格向大規格變更，如需將大規格變更為小規格，請先退訂後再重新訂購。',
  ...
  dfs_offline_deployment_tip:
    '由於線上版本使用MongoDB Atlas，該產品在國內沒有服務，所以國內僅提供線下版本。',
  dfs_wait_storage_init:
    '订阅成功。您訂閱的儲存正在初始化，這可能需要1到20分鐘。請耐心等待。',
  dfs_replication_tour_dialog_desc:
    '在開始資料複製任務之前，您需要創建源資料庫和目標資料庫連接，我們將引導您完成：',
  dfs_replication_tour_dialog_steps:
    '1.創建源資料庫連接  ｜  2.創建目標資料庫連接  ｜  3.配置資料複製任務',
  ...
  dfs_order_pay_duigonghuikuan: '對公匯款',
  dfs_order_pay_old_shifujine: '實付金額:',
  dfs_user_contactus_chakanwendang: '查看文檔',
  dfs_user_contactus_tigongchanpinjie: '提供產品介紹、使用指導等',
  dfs_user_contactus_chuangjiangongdan: '創建工單',
  dfs_user_contactus_tijiaogongdanjie: '提交工單解決問題',
  dfs_user_contactus_wodegongdan: '我的工單',
  dfs_user_contactus_gengduofuwu: '更多服務',
  dfs_user_contactus_gongzuorijiejia:
    '工作日 09:00 - 20:00 節假日 09:00 - 18:00',
  dfs_user_contactus_dianhuazixun: '電話諮詢',
  dfs_user_contactus_weinintigongchan:
    '為您提供產品配置指導、問題排查等技術支持',
  dfs_user_contactus_saomatianjiake: '掃碼添加客服微信',
  dfs_user_contactus_qiyeweixin: '企業微信',
  dfs_user_contactus_youxiang: '郵箱',
  ...
  dfs_traffic_billing_desc:
    '除了引擎規格費用外，還會根據您同步數據量的大小來收取流量費用，流量費按月收取。',
  dfs_traffic_billing_prefix:
    '(每月贈送 {gift}GB 免費流量，超出以 {trafficPrice}/GB 計費)',
  ...
  dfs_customer_survey_notice: '🎁 有獎調研',
  ...
  dfs_tm_address_alert:
    '如果您的服務器進行了訪問限制，請開放網絡策略以確保服務器可以訪問到 TapData Cloud 管理端：',
  ...
  agent_version_not_support: '當前版本的 Agent 不支持此功能，請升級後重試',
}
