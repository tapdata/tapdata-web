export default {
  ...
  operation_log_agent_start_tip: 'Start Agent [@{parameter1}]',
  ...
  user_Center_gongSiMingCheng: 'Company Name',
  user_Center_gongSiGuanWang: 'Company Official Website',
  ...
  dfs_ticketing_system_details_wenti: 'Question: ',
  dfs_ticketing_system_details_tijiaoshijian: 'Submission Time: ',
  dfs_ticketing_system_details_gongdanzhuangtai: 'Ticket Ttatus:',
  dfs_ticketing_system_details_gongdanbianhao: 'Ticket Number:',
  dfs_ticketing_system_details_renwu: 'Task:',
  dfs_ticketing_system_details_shujuyuan: 'Data Source:',
  dfs_ticketing_system_details_zhuti: 'Subject:',
  dfs_ticketing_system_details_gongdanxiangqing: 'Ticket Details',
  dfs_ticketing_system_list_gongdanyiguanbi: 'Ticket is closed',
  ...
  dfs_ticketing_system_list_gongdanbianhao: 'Ticket Number',
  ...
  dfs_instance_instance_baimingdanIp: 'Access List IP',
  dfs_instance_instance_ipdizhi: 'IP Address',
  dfs_instance_instance_tianjiabaimingdan: 'Add Access List',
  ...
  dfs_replication_tour_dialog_finished:
  ...
  dfs_replication_tour_dialog_finished_option_no_plan_3:
    'No plan to use, I have concerns over data security.',
  ...
  dfs_marketplace_guide_step_1:
    'Fully managed Agent is being created automatically...',
  ...
  dfs_payment_progress_desc:
    'If you have already made the payment, please click “Payment Completed”.',
  dfs_retry_payment: 'Repay',
  dfs_complete_payment: 'Payment Completed',
  dfs_tm_address_alert:
    'If your server has access restrictions, please allow access for TapData Cloud management to:',
  ...
  welcome_demand_collection_2:
    "Explore TapData's data replication and integration capability",
  welcome_demand_collection_3:
    'Learn best practices in real time data processing with TapData',
