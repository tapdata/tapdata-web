<template>
  <Drawer v-loading="loading" class="overflow-hidden" style="width: 838px" v-model:visible="visible">
    <div class="flex flex-column overflow-hidden pt-2 h-100">
      ...
      <div class="flex position-relative">
        ...
        <ElTabs v-model:value="tab" class="data-server__tabs flex-1" @tab-click="tabChanged">
      ...
      >
        ...
        <ElFormItem class="flex-1 mt-4" size="small" :label="$t('daas_data_server_drawer_quanxianfanwei')" prop="acl">
          <ElSelect v-model:value="form.acl" multiple :disabled="!isEdit" @change="aclChanged">
        ...
        <ElTable class="flex-1" :data="isEdit ? form.params : data.params">
          ...
          <ElTableColumn v-if="debugParams" :label="$t('daas_data_server_drawer_canshuzhi')" min-width="100">
