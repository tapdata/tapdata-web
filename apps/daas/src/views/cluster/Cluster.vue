                  ...
                  <el-row :gutter="16" class="data-list">
                    ...
                    <el-col :span="4">
                      <span
                        ...
                        >{{ $t('cluster_' + item.management.status) }}</span
                      >
                    </el-col>
                    <el-col :span="4">
                      <span
                  ...
                  <el-row :gutter="16" class="data-list">
                    ...
                    <el-col :span="4">
                      <span
                        ...
                        >{{ $t('cluster_' + item.engine.status) }}</span
                      >
                    </el-col>
                    <el-col :span="4">
                      <span
                  ...
                  <el-row :gutter="16" class="data-list">
                    ...
                    <el-col :span="4">
                      <span
                        ...
                        >{{ $t('cluster_' + item.apiServer.status) }}</span
                      >
                    </el-col>
                    <el-col :span="4">
                      <span
...
export default {
  ...
  methods: {
    ...
    delConfirm(item) {
      ...
      let message = h('p', [
        this.$t('cluster_del_delete_or_not') + ' ' + agentName,
      ])
    ...
    submitEditAgent() {
      if (this.agentName === '') {
        ...
        this.$message.error(
          this.$t('cluster_server_name') + this.$t('cluster_none_text')
        )
        return
      }
      let data = {
