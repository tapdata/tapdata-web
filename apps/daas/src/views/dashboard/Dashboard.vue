...
export default {
  ...
  data() {
    return {
      ...
      verifyBarData: [
        {
          name: this.$t('dashboard_total'),
          value: 0,
          key: 'total',
          color: '#2EA0EA',
        },
        {
          name: this.$t('dashboard_diff'),
          value: 0,
          key: 'diff',
          color: '#2EA0EA',
        },
        {
          name: this.$t('dashboard_can'),
          value: 0,
          key: 'can',
          color: '#2EA0EA',
        },
        {
          name: this.$t('dashboard_error'),
          value: 0,
          key: 'error',
          color: '#2EA0EA',
        },
      ...
      taskApi
        ...
        .then((data) => {
          if (data) {
            ...
            self.validBarData = this.handleChart(
              data.chart5,
              self.verifyBarData
            )
