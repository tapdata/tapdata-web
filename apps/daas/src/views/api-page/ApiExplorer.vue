...
<template>
  <section class="apiserver-wrap h-100">
    ...
    <BrowseQuery
      ...
      :dialog-visible="showFilterDialog"
      @back-show-column="backShowColumn"
      @back-dialog-visible="backDialogVisible"
    />
    <!-- 创建 -->
    <el-dialog
      width="600px"
    ...
    >
      <div class="create-dialog-box">
        <JsEditor v-model:value="jsonDoc" height="200"/>
      </div>
      ...
      <template #footer>
        <span class="dialog-footer">
          <ElButton @click="openCreateDialog = false">{{
            $t('public_button_cancel')
          }}</ElButton>
          <ElButton @click="formatJson()">{{
