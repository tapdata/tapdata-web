<template>
  <section class="history-list-wrap">
    <div class="history-head">
      <div>
        {{ $t('metadata_details_version_currentVersion') }} V{{
          currentVersionNum
        }}
      </div>
    ...
    <div class="attributes-table">
      <div class="left-table">
        ...
        >
          <el-table-column :label="$t('metadata_details_attrName')" prop="key">
            <template v-slot="scope">
              <div v-if="scope.row.result !== 'del'">
                <span
                  :class="{ activeColor: scope.row.result !== 'eq' }"
                  v-if="!scope.row.isCustom"
                  >{{ $t('metadata_details_' + scope.row.key) }}</span
                >
                <span
                  :class="{ activeColor: scope.row.result !== 'eq' }"
                  v-else
          ...
          <el-table-column
            :label="$t('metadata_details_attrKey')"
            prop="baseValue"
          >
          </el-table-column>
          <el-table-column :label="$t('metadata_details_attrName')" prop="key">
      ...
      <div class="field-table">
        ...
        >
          <el-table-column
            ...
            prop="base_alias_name"
          >
            <template v-slot="scope">
              <span
                :class="{ activeColor: scope.row.alias_name_result !== 'eq' }"
              >
          ...
          <el-table-column
            :label="$t('metadata_details_name')"
            prop="base_field_name"
          >
            <template v-slot="scope">
              <span
                :class="{ activeColor: scope.row.field_name_result !== 'eq' }"
              >
          ...
          <el-table-column
            :label="$t('metadata_details_data_type')"
            prop="base_java_type"
          >
            <template v-slot="scope">
              <span
                :class="{ activeColor: scope.row.java_type_result !== 'eq' }"
              >
          ...
          <el-table-column
            :label="$t('metadata_details_precision')"
            prop="base_precision"
          >
            <template v-slot="scope">
              <span
                :class="{ activeColor: scope.row.precision_result !== 'eq' }"
              >
          ...
          <el-table-column
            :label="$t('metadata_details_columnSize')"
            prop="base_columnSize"
          >
            <template v-slot="scope">
              <span
                :class="{ activeColor: scope.row.precision_result !== 'eq' }"
          ...
          <el-table-column
            :label="$t('metadata_details_scale')"
            prop="base_scale"
          >
            <template v-slot="scope">
          ...
          <el-table-column
            :label="$t('metadata_details_autoincrement')"
            prop="base_autoincrement"
          >
            <template v-slot="scope">
              <span
          ...
          <el-table-column
            :label="$t('metadata_details_primary_key_position')"
            prop="base_primary_key_position"
          >
            <template v-slot="scope">
              <span
          ...
          <el-table-column
            :label="$t('metadata_details_foreign_key_position')"
            prop="base_foreign_key_position"
          >
            <template v-slot="scope">
              <span
          ...
          <el-table-column
            :label="$t('metadata_details_is_nullable')"
            prop="base_is_nullable"
          >
            <template v-slot="scope">
              <span
          ...
          <el-table-column
            :label="$t('metadata_details_unique')"
            prop="base_unique"
          >
            <template v-slot="scope">
              <span
        ...
        >
          ...
          <el-table-column
            :label="$t('metadata_details_primary_key_position')"
            prop="compare_primary_key_position"
          >
            <template v-slot="scope">
              <span
          ...
          <el-table-column
            :label="$t('metadata_details_foreign_key_position')"
            prop="compare_foreign_key_position"
          >
            <template v-slot="scope">
              <span
      ...
      metadataInstancesApi
        ...
        .then((data) => {
          ...
          this.fieldsItems.forEach((tableItem) => {
            ...
            if (tableItem.base_primary_key_position > 0)
              tableItem.base_primary_key_position = true
            if (tableItem.base_foreign_key_position > 0)
              tableItem.base_foreign_key_position = true
            if (tableItem.compare_primary_key_position > 0)
              tableItem.compare_primary_key_position = true
            if (tableItem.compare_foreign_key_position > 0)
              tableItem.compare_foreign_key_position = true
          })
        })
    },
  },
