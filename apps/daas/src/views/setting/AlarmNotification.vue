<template>
  <section class="flex flex-1 flex-column ml-4 mr-4 overflow-hidden">
    ...
    >
      ...
      <template v-slot:interval="scope">
        ...
        >
          ...
          <el-option
            :label="$t('dag_data_setting_second')"
            value="SECOND"
          ></el-option>
          <el-option :label="$t('dataFlow_min')" value="MINUTE"></el-option>
          <el-option
            :label="$t('dag_data_setting_hour')"
            value="HOUR"
          ></el-option>
    ...
    <footer class="flex justify-content-end mb-4">
      <el-button size="mini" @click="remoteMethod()">{{
        $t('button_cancel')
      }}</el-button>
    ...
    >
      ...
      >
        ...
        <template v-slot:valueSlot="scope">
          <span class="mr-2">{{
            $t('daas_setting_alarmnotification_lianxu')
          }}</span>
          <el-input-number
            :controls="false"
            style="width: 100px"
          ...
          <span class="ml-2 mr-2">
            {{ $t('daas_setting_alarmnotification_gedian') }}</span
          >
          <el-select
            style="width: 100px"
            class="mr-2"
          ...
          ></el-input-number>
          <span class="ml-2">{{
            $t('daas_setting_alarmnotification_msshigaojing')
          }}</span>
        </template>
      </VTable>
    ...
    return {
      ...
      keyMapping: {
        ...
        TASK_STATUS_STOP: i18n.t(
          'daas_setting_alarmnotification_dangrenwutingzhi'
        ),
        ...
        SYSTEM_FLOW_EGINGE_DOWN: i18n.t(
          'daas_setting_alarmnotification_dangrenwustop'
        ),
      },
      alarmRulesColumns: [
        {
