export default {
  ...
  setting_Login_Single_Session_doc: 'Once enabled, only a single session of login is allowed for the same account',
  setting_Login_Brief_Tips: 'Login brief tips',
  setting_Login_Brief_Tips_doc: 'Once enabled, the login prompt will be simplified',
  ...
  app_signIn_email_invalid: 'Email or password is incorrect, please check and re-enter.',
