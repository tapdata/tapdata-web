export default {
  ...
  ai_assistant_one_chat_demo: 'One chat demo',
  ...
  ai_assistant_result_connection: 'Connection',
  ai_assistant_result_task: 'Task',
  ai_assistant_result_table: 'Table',
  ai_assistant_result_model: 'Model',
  ai_assistant_open_table: 'Open table',
  ai_assistant_open_new_tab: 'Open in new tab',
  ai_assistant_reply_placeholder: 'Reply...',
  ai_assistant_skills: 'Skills',
  ai_assistant_config_storage_tip:
    'For this demo, configuration is stored in this browser.',
  ai_assistant_base_url: 'Base URL',
  ai_assistant_auth_token: 'API Key',
  ai_assistant_model: 'Model',
  ai_assistant_worked_seconds: 'Worked for {0} seconds',
  ai_assistant_tool_call_start: 'Calling tool {0}',
  ai_assistant_tool_call_result: 'Tool {0} completed',
  ai_assistant_tool_status_running: 'Calling',
