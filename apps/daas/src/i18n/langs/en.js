export default {
  ...
  page_title_function: 'Function management',
  ...
  page_title_cluster: 'Cluster Management',
  page_title_process: 'Process management',
  ...
  verify_check_frequency: 'check frequency',
  verify_single_repeating_verify: 'Single/Repeat Verification',
  verify_is_enabled: 'Whether enabled',
  verify_result: 'Verification result',
  verify_single: 'Single verification',
  verify_repeating: 'Repeat verification',
  verify_row_verify: 'Quick count verification',
  verify_content_verify: 'Table full field value verification',
  verify_joint_verify: 'Associated field value verification',
  ...
  notify_sync: 'Sync task',
  notify_migration: 'Migration task',
  notify_notice_type: 'Please select a message type',
  notify_notice_level: 'Please select the message level',
  notify_manage_sever: 'Management side',
  notify_inspect: 'Check task',
  notify_ddl_deal: 'DDL processing',
  notify_notify_source_name: 'source connection',
  notify_notify_database_name: 'Database name',
  ...
  role_name_SYNC_job_creation: 'Create task',
