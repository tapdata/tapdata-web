export default {
  ...
  // 共享緩存
  shared_cache_placeholder_task_name:
    'Please enter the cache task name to search',
  shared_cache_placeholder_connection_name:
    'Please enter the connection name to search',
