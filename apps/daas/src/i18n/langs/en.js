export default {
  ...
  page_title_workflow: 'Workflow',
  page_title_workflow_create: 'Create Workflow',
  page_title_workflow_edit: 'Edit Workflow',
  page_title_workflow_runs: 'Workflow Runs',
  page_title_workflow_run_detail: 'Workflow Run Detail',
  ...
  page_title_data_import_export: 'Project Import Export',
  page_title_project_management: 'Project Management',

  // -- Data Import Export
  data_import_export_group_management: 'Project Management',
  data_import_export_groups: 'Projects',
  data_import_export_selected: 'Selected',
  data_import_export_available: 'Available',
  data_import_export_search_group: 'Search projects...',
  data_import_export_search_name: 'Search name',
  data_import_export_no_group: 'No projects',
  data_import_export_no_selected_resource: 'No selected resources',
  data_import_export_add_group: 'Add Project',
  data_import_export_edit_group: 'Edit Project',
  data_import_export_delete_group: 'Delete Project',
  data_import_export_delete_group_confirm:
    'Are you sure to delete project "{name}"?',
  data_import_export_delete_confirm_title: 'Delete Confirmation',
  data_import_export_group_name_required: 'Project name cannot be empty',
  data_import_export_group_name_placeholder: 'Please enter project name',
  data_import_export_select_all_available: 'Select All Available',
  data_import_export_add_selected: 'Add Selected',
  data_import_export_remove_selected: 'Remove',
  data_import_export_clean_nonexistent: 'Clean Nonexistent',
  data_import_export_nonexistent: 'Nonexistent',
  data_import_export_items: 'items',
  data_import_export_select_group_tip: 'Please select a project',
  data_import_export_sync_task: 'Transformation Task',
  data_import_export_migrate_task: 'Migrate Task',
  data_import_export_module: 'Module',
  data_import_export_import: 'Import',
  data_import_export_export: 'Export',
  data_import_export_importing: 'Importing',
  data_import_export_exporting: 'Exporting',
  data_import_export_completed: 'Completed',
  data_import_export_failed: 'Failed',
  data_import_export_operator: 'Operator',
  data_import_export_operation_time: 'Operation Time',
  data_import_export_view_detail: 'View Detail',
  data_import_export_record_detail: 'Record Detail',
  data_import_export_import_record_detail: 'Import Record Detail',
  data_import_export_export_record_detail: 'Export Record Detail',
  data_import_export_resource_preview: 'Resource Preview',
  data_import_export_click_group_to_view:
    'Click project on the left to view resources',
  data_import_export_resource_count: 'resources',
  ...
  data_import_export_export_group: 'Export Project',
  data_import_export_select_group: 'Select Project',
  data_import_export_rerun: 'Rerun',
  data_import_export_git_config: 'Git Configuration',
  data_import_export_git_repo_type: 'Repository Type',
  ...
  dashboard_odh_agent_cluster: 'Cluster Status',
  dashboard_odh_nodes_total: '{0} Nodes Total',
  dashboard_odh_agent_name: 'Agent Name',
  dashboard_odh_status: 'Status',
  dashboard_odh_cpu_usage: 'Flow Engine CPU Usage',
  dashboard_odh_memory_usage: 'Flow Engine Memory Usage',
  ...
  apiaudit_parameter: 'Request Parameters',
  apiaudit_link: 'Link',
  ...
  apiaudit_overview: 'Overview',
  apiaudit_phase: 'Phase',
  apiaudit_duration: 'Duration',
  apiaudit_phase_api: 'API Processing',
  apiaudit_phase_db: 'Database Execution',
  apiaudit_phase_response: 'Response Formatting',
  apiaudit_total: 'Total',
  apiaudit_execution_window: 'Execution Window',
  apiaudit_response_size: 'Response Size',
  apiaudit_total_time: 'Total Time',
  apiaudit_api_time: 'API Time',
  apiaudit_db_time: 'DB Time',
  apiaudit_match_rows: 'Match Rows',
  apiaudit_return_rows: 'Return Rows',
  apiaudit_visitor_ip: 'Visitor IP',
  //Dag
  //Task edit缓存节点提示
  ...
  audit_event_admin: 'Admin Operation',
  audit_event_config: 'Configuration Change',
  audit_event_service: 'Service Lifecycle',
  audit_event_other: 'Other User Operation',
  audit_outcome: 'Outcome',
  audit_outcome_success: 'Success',
  audit_outcome_failure: 'Failure',
  audit_user_id: 'User ID',
  audit_keyword: 'Search action, object, failure reason, etc.',
  audit_source_ip: 'Source IP',
  audit_time: 'Time',
  audit_action: 'Action',
  audit_object: 'Object',
  audit_detail: 'Details',
  audit_failure_reason: 'Failure Reason',
  audit_login_failure_credential_parse: 'Invalid login credential format',
  audit_login_failure_external_identity: 'External identity authentication failed',
  audit_login_failure_credentials: 'Incorrect account or password',
  audit_login_failure_pending_approval: 'User account is pending approval',
  audit_login_failure_user_disabled: 'User account is disabled',
  audit_login_failure_too_many_attempts: 'Too many failed login attempts; try again later',
  audit_service_failure_abnormal_stop_detected: 'Abnormal service stop detected',
  audit_service_failure_abnormal_stop_handling: 'Failed to handle abnormal service stop',
  audit_service_failure_operation: 'Service operation failed',
  audit_service_failure_cluster_node_not_found: 'No matching cluster node found',
  audit_service_failure_cluster_operation: 'Cluster service operation failed',
  audit_service_failure_stop: 'Failed to stop service',
  audit_service_failure_status_update: 'Failed to update service status',
  audit_connection_failure_test: 'Connection test failed',
  audit_connection_failure_load_schema: 'Schema loading failed',
  audit_connection_failure_agent_unavailable: 'No compute node is available',
  audit_change_summary: 'Change Summary',
  audit_service_node: 'Service Node',
  audit_event_id: 'Event ID',
  audit_login_method: 'Login Method',
  audit_message_user: 'User',
  audit_message_action: 'performed',
  audit_action_login_system: 'logged in to the system',
  audit_action_logout_system: 'logged out of the system',
  audit_action_save: 'saved',
  audit_action_create_user: 'created user',
  audit_action_update_user: 'updated user',
  audit_action_disable_user: 'disabled user',
  audit_action_enable_user: 'enabled user',
  audit_action_grant_role: 'granted user',
  audit_action_revoke_role: 'revoked from user',
  audit_action_test_connection: 'tested connection',
  audit_action_load_schema: 'loaded connection schema',
  audit_role: 'role',
  audit_action_abnormal_stop: 'detected abnormal service stop',
  audit_action_restart_service: 'restarted',
  audit_cluster_api_server: 'API Server',
  audit_cluster_custom_component: 'Service Monitor ({componentType})',
  audit_cluster_component_instance: '{component} ({instance})',
  audit_system_configuration: 'system configuration',
  audit_alarm_configuration: 'alert settings',
  audit_copy_as: 'as',
  audit_unknown: 'Unknown',
  audit_unauthenticated: 'Unauthenticated',
  audit_unavailable: 'Unavailable',
  daas_cluster_cluster_lianjieshuliang: 'Number of connections',
  daas_cluster_cluster_lianjieshuliang_detail: 'Outbound Connection Details',
  daas_cluster_cluster_mubiaoIPhe: 'Target IP and port',
  daas_cluster_cluster_lianjiezongshu: 'Flow Engine TCP Connctions',
  ...
  daas_role_role_no_matching_module: 'No matching modules',
  ...
  daas_cluster_cluster_lianjieshuliang_detail: 'Flow Engine TCP Connections',
  daas_cluster_cluster_view: 'Cluster View',
  daas_cluster_component_view: 'Component View',
  daas_cluster_engine_hostname: 'Hostname/IP',
  daas_cluster_connection_count: 'TCP Connection Count',
  daas_cluser_keyword_placeholder: 'Search for hostnames',
  daas_task_rebalance_button: 'Task Rebalance',
  daas_task_rebalance_title: 'Task Rebalance Plan',
  daas_task_rebalance_subtitle:
    'Drag task cards onto a target engine to adjust the task distribution across engines',
  daas_task_rebalance_online: 'Online',
  daas_task_rebalance_offline: 'Offline',
  daas_task_rebalance_memory: 'Memory Usage',
  daas_task_rebalance_task_count: 'Tasks',
  daas_task_rebalance_legend_move: 'Tasks to be moved',
  daas_task_rebalance_legend_locked: 'Tasks that cannot be rebalanced',
  daas_task_rebalance_cancel: 'Cancel',
  ...
  daas_task_rebalance_reason_status_error:
    'The task is not running and cannot be migrated',
  daas_task_rebalance_reason_manual_agent:
    'A fixed engine is specified and cannot be migrated',
  daas_task_rebalance_reason_incremental:
    'Initial sync in progress, cannot be migrated',
  daas_task_rebalance_history_title: 'Task Rebalance Records',
  daas_task_rebalance_history_list_title: 'History',
  daas_task_rebalance_history_empty: 'No rebalance records',
  daas_task_rebalance_history_empty_desc:
    'Records will appear here after a rebalance',
  daas_task_rebalance_history_detail_empty: 'Select a record on the left',
  daas_task_rebalance_history_task_total: '{count} tasks',
  daas_task_rebalance_history_record_creating: 'Creating',
  daas_task_rebalance_history_record_running: 'Running',
  daas_task_rebalance_history_record_done: 'Completed',
  daas_task_rebalance_history_record_partial: 'Partially Completed',
  daas_task_rebalance_history_record_cancelled: 'Cancelled',
  daas_task_rebalance_history_record_failed: 'Failed',
  daas_task_rebalance_history_job_pending: 'Pending',
  daas_task_rebalance_history_job_starting: 'Starting',
  daas_task_rebalance_history_job_stopping: 'Stopping',
  daas_task_rebalance_history_job_ok: 'Completed',
  daas_task_rebalance_history_job_cancelled: 'Cancelled',
  daas_task_rebalance_history_job_invalid_agent: 'Invalid Agent',
  daas_task_rebalance_history_job_status_error: 'Status Error',
  daas_task_rebalance_history_job_stop_timeout: 'Stop Timeout',
  daas_task_rebalance_history_job_start_timeout: 'Start Timeout',
  daas_task_rebalance_history_job_failed: 'Failed',
  daas_task_rebalance_history_stat_success: 'Success',
  daas_task_rebalance_history_stat_failed: 'Failed',
  daas_task_rebalance_history_stat_skipped: 'Skipped',
  daas_task_rebalance_history_stat_running: 'Running',
  daas_task_rebalance_history_stat_pending: 'Pending',
  daas_task_rebalance_history_col_task: 'Task Name',
  daas_task_rebalance_history_col_source: 'Source Engine',
  daas_task_rebalance_history_col_target: 'Target Engine',
  daas_task_rebalance_history_col_status: 'Status',
  daas_task_rebalance_history_col_error: 'Error',
  daas_task_rebalance_history_col_action: 'Action',
  daas_task_rebalance_history_cancel: 'Cancel',
  daas_task_rebalance_history_cancel_remaining: 'Cancel Remaining',
  daas_task_rebalance_history_cancel_remaining_confirm:
    'Cancel the remaining {count} pending tasks? This cannot be undone.',
  daas_task_rebalance_history_cancel_success: 'Task cancelled',
  daas_task_rebalance_history_cancel_remaining_success:
    '{count} tasks cancelled',
  daas_task_rebalance_history_progress: 'Execution Progress',
  page_title_task_rebalance: 'Task Rebalance',
...
{'}'} `,
  ...
  api_monitor_server_rps_title_unit: 'Requests/Second',
  ...
  api_monitor_server_failure_rate: 'Failure Rate',
  ...
  api_monitor_connection_pool: 'DB Connection Pool Usage',
  api_monitor_connection_pool_max: 'DB MAX CONNECTIONS',
  api_monitor_connection_pool_used: 'DB ACTIVE CONNECTIONS',
