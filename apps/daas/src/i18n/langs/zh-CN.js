export default {
  ...
  page_title_workflow_create: '创建工作流',
  page_title_workflow_edit: '编辑工作流',
  page_title_workflow_runs: '工作流运行记录',
  page_title_workflow_run_detail: '工作流运行详情',
  ...
  page_title_data_import_export: '项目导入导出',
  page_title_project_management: '项目管理',

  // -- 数据导入导出
  data_import_export_group_management: '项目管理',
  data_import_export_groups: '项目',
  data_import_export_selected: '已选',
  data_import_export_available: '可用资源',
  data_import_export_search_group: '搜索项目...',
  data_import_export_search_name: '搜索名称',
  data_import_export_no_group: '暂无项目',
  data_import_export_no_selected_resource: '暂无选中资源',
  data_import_export_add_group: '新增项目',
  data_import_export_edit_group: '编辑项目',
  data_import_export_delete_group: '删除项目',
  data_import_export_delete_group_confirm: '确定要删除项目"{name}"吗？',
  data_import_export_delete_confirm_title: '删除确认',
  data_import_export_group_name_required: '项目名称不能为空',
  data_import_export_group_name_placeholder: '请输入项目名称',
  data_import_export_select_all_available: '全选可用',
  data_import_export_add_selected: '添加已选',
  data_import_export_remove_selected: '移除',
  data_import_export_clean_nonexistent: '清理不存在',
  data_import_export_nonexistent: '不存在',
  data_import_export_items: '项',
  data_import_export_select_group_tip: '请选择一个项目',
  data_import_export_sync_task: '开发任务',
  data_import_export_migrate_task: '复制任务',
  data_import_export_module: '模块',
  data_import_export_import: '导入',
  data_import_export_export: '导出',
  data_import_export_importing: '导入中',
  data_import_export_exporting: '导出中',
  data_import_export_completed: '已完成',
  data_import_export_failed: '失败',
  data_import_export_operator: '操作人',
  data_import_export_operation_time: '操作时间',
  data_import_export_view_detail: '查看详情',
  data_import_export_record_detail: '记录详情',
  data_import_export_import_record_detail: '导入记录详情',
  data_import_export_export_record_detail: '导出记录详情',
  data_import_export_resource_preview: '资源预览',
  data_import_export_click_group_to_view: '请在左侧点击项目查看资源',
  data_import_export_resource_count: '个资源',
  ...
  data_import_export_export_group: '导出项目',
  data_import_export_select_group: '选择项目',
  data_import_export_rerun: '重跑',
  data_import_export_git_config: 'Git 配置',
  data_import_export_git_repo_type: '仓库类型',
  data_import_export_git_repo_url: '仓库地址',
  data_import_export_git_repo_url_required: '仓库地址不能为空',
  data_import_export_git_token: 'Token',
  data_import_export_git_token_placeholder: '请输入 Personal Access Token',
  data_import_export_git_username: '用户名',
  ...
  data_import_export_branch_name_placeholder: '请输入分支名',
  data_import_export_pr_title: 'PR 标题',
  data_import_export_pr_title_placeholder: '请输入 PR 标题',
  data_import_export_pr_description: 'PR 描述',
  data_import_export_pr_description_placeholder: '请输入 PR 描述',
  data_import_export_select_file: '请选择要上传的文件',
  data_import_export_import_success: '导入成功',
  data_import_export_import_failed: '导入失败',
  ...
  dashboard_odh_memory_usage: '引擎内存使用率',
  ...
  apiaudit_overview: '概览',
  apiaudit_phase: '阶段',
  apiaudit_duration: '耗时',
  apiaudit_phase_api: 'API 处理',
  apiaudit_phase_db: '数据库执行',
  apiaudit_phase_response: '响应生成',
  apiaudit_total: '总计',
  apiaudit_execution_window: '执行时间窗口',
  apiaudit_response_size: '响应大小',
  apiaudit_total_time: '总耗时',
  apiaudit_api_time: 'API 耗时',
  apiaudit_db_time: '数据库耗时',
  apiaudit_match_rows: '匹配行数',
  apiaudit_return_rows: '返回行数',
  apiaudit_visitor_ip: '访问 IP',
  ...
  setting_Task_CPU_and_Memory_Metrics_Statistics: '任务CPU&内存指标统计',
  ...
  audit_log: '审计日志',
  audit_event_type: '事件类型',
  audit_event_login: '登录事件',
  audit_event_admin: '管理员操作',
  audit_event_config: '配置变更',
  audit_event_service: '服务生命周期',
  audit_event_other: '其他用户操作',
  audit_outcome: '结果',
  audit_outcome_success: '成功',
  audit_outcome_failure: '失败',
  audit_user_id: 'User ID',
  audit_keyword: '按动作、对象、失败原因等关键词搜索',
  audit_source_ip: '来源 IP',
  audit_time: '操作时间',
  audit_action: '动作',
  audit_object: '对象',
  audit_detail: '详情',
  audit_failure_reason: '失败原因',
  audit_login_failure_credential_parse: '登录凭据格式无效',
  audit_login_failure_external_identity: '外部身份认证失败',
  audit_login_failure_credentials: '账号或密码不正确',
  audit_login_failure_pending_approval: '用户账号待审核',
  audit_login_failure_user_disabled: '用户账号已禁用',
  audit_login_failure_too_many_attempts: '登录失败次数过多，请稍后重试',
  audit_service_failure_abnormal_stop_detected: '检测到服务异常停止',
  audit_service_failure_abnormal_stop_handling: '服务异常停止处理失败',
  audit_service_failure_operation: '服务操作失败',
  audit_service_failure_cluster_node_not_found: '未找到匹配的集群节点',
  audit_service_failure_cluster_operation: '集群服务操作失败',
  audit_service_failure_stop: '服务停止失败',
  audit_service_failure_status_update: '服务状态更新失败',
  audit_connection_failure_test: '连接测试失败',
  audit_connection_failure_load_schema: '模型加载失败',
  audit_connection_failure_agent_unavailable: '没有可用的计算节点',
  audit_change_summary: '变更摘要',
  audit_service_node: '服务节点',
  audit_event_id: '事件 ID',
  audit_login_method: '登录方式',
  audit_message_user: '用户',
  audit_message_action: '执行了',
  audit_action_login_system: '登录了系统',
  audit_action_logout_system: '退出了系统',
  audit_action_save: '保存了',
  audit_action_create_user: '创建了用户',
  audit_action_update_user: '更新了用户',
  audit_action_disable_user: '禁用了用户',
  audit_action_enable_user: '启用了用户',
  audit_action_grant_role: '授予了用户',
  audit_action_revoke_role: '撤销了用户',
  audit_action_test_connection: '测试了连接',
  audit_action_load_schema: '加载了连接模型',
  audit_role: '角色',
  audit_action_abnormal_stop: '检测到服务异常停止',
  audit_action_restart_service: '重启了',
  audit_cluster_api_server: 'API Server',
  audit_cluster_custom_component: '服务监控（{componentType}）',
  audit_cluster_component_instance: '{component}（{instance}）',
  audit_system_configuration: '系统设置',
  audit_alarm_configuration: '告警设置',
  audit_copy_as: '为',
  audit_unknown: '未知',
  audit_unauthenticated: '未认证',
  ...
  daas_cluster_cluster_lianjiezongshu: '引擎 TCP 连接总数',
  ...
  daas_role_role_no_matching_module: '没有匹配的模块',
  ...
  daas_cluster_cluster_lianjieshuliang_detail: '引擎 TCP 连接',
  daas_cluster_cluster_view: '集群视图',
  daas_cluster_component_view: '组件视图',
  daas_cluster_engine_hostname: '主机名/IP',
  daas_cluster_connection_count: 'TCP 连接数',
  daas_cluser_keyword_placeholder: '搜索主机名',
  daas_task_rebalance_button: '任务调度均衡',
  daas_task_rebalance_title: '任务均衡方案',
  daas_task_rebalance_subtitle: '拖动任务卡片到目标引擎，调整各引擎的任务分布',
  daas_task_rebalance_online: '在线',
  daas_task_rebalance_offline: '离线',
  daas_task_rebalance_memory: '内存使用率',
  daas_task_rebalance_task_count: '任务数',
  daas_task_rebalance_legend_move: '将被调走的任务',
  daas_task_rebalance_legend_locked: '不可均衡的任务',
  daas_task_rebalance_cancel: '取消',
  daas_task_rebalance_confirm: '确认均衡',
  daas_task_rebalance_create: '创建均衡',
  daas_task_rebalance_empty: '暂无可均衡的任务',
  daas_task_rebalance_create_success: '均衡方案已创建，开始执行任务迁移',
  ...
  daas_task_rebalance_reason_manual_agent: '已指定固定引擎，无法迁移',
  daas_task_rebalance_reason_incremental: '全量同步中，无法迁移',
  daas_task_rebalance_history_title: '任务均衡记录',
  daas_task_rebalance_history_list_title: '历史记录',
  daas_task_rebalance_history_empty: '暂无均衡记录',
  daas_task_rebalance_history_empty_desc: '任务均衡后记录将显示在这里',
  daas_task_rebalance_history_detail_empty: '请在左侧选择一条记录',
  daas_task_rebalance_history_task_total: '{count} 个任务',
  daas_task_rebalance_history_record_creating: '创建中',
  daas_task_rebalance_history_record_running: '执行中',
  ...
  daas_task_rebalance_history_record_failed: '失败',
  daas_task_rebalance_history_job_pending: '等待中',
  daas_task_rebalance_history_job_starting: '启动中',
  ...
  daas_task_rebalance_history_job_status_error: '状态异常',
  daas_task_rebalance_history_job_stop_timeout: '停止超时',
  daas_task_rebalance_history_job_start_timeout: '启动超时',
  daas_task_rebalance_history_job_failed: '失败',
  daas_task_rebalance_history_stat_success: '成功',
  daas_task_rebalance_history_stat_failed: '失败',
  daas_task_rebalance_history_stat_skipped: '跳过',
  daas_task_rebalance_history_stat_running: '运行中',
  daas_task_rebalance_history_stat_pending: '等待中',
  daas_task_rebalance_history_col_task: '任务名称',
  daas_task_rebalance_history_col_source: '源引擎',
  daas_task_rebalance_history_col_target: '目标引擎',
  daas_task_rebalance_history_col_status: '状态',
  daas_task_rebalance_history_col_error: '错误原因',
  daas_task_rebalance_history_col_action: '操作',
  daas_task_rebalance_history_cancel: '取消',
  daas_task_rebalance_history_cancel_remaining: '取消剩余任务',
  daas_task_rebalance_history_cancel_remaining_confirm:
    '确定取消剩余 {count} 个等待中的任务吗？此操作不可撤销。',
  daas_task_rebalance_history_cancel_success: '任务已取消',
  daas_task_rebalance_history_cancel_remaining_success: '已取消 {count} 个任务',
  daas_task_rebalance_history_progress: '执行进度',
  page_title_task_rebalance: '任务均衡',
...
{'}'}`,
  ...
  api_monitor_server_title: 'API 服务器监控',
  api_monitor_server_detail_title: '服务器详细监控信息',
  api_monitor_server_rps_title: 'RPS 统计',
  api_monitor_server_rps_title_unit: '请求/秒',
  api_monitor_server_error_rate_title: '错误率统计',
  api_monitor_server_response_time_title: '请求延时分位数',
  api_monitor_server_api_calls_title: 'API 调用统计',
  api_monitor_server_api_name: 'API 名称',
  api_monitor_server_call_count: '调用次数',
  api_monitor_server_failure_count: '失败次数',
  api_monitor_server_failure_rate: '失败率',
  api_monitor_server_recent_10_minutes: '最近10分钟',
  api_monitor_server_recent_30_minutes: '最近30分钟',
  api_monitor_server_recent_1_hour: '最近1小时',
  ...
  api_monitor_connection_pool: '数据库连接池使用情况',
  api_monitor_connection_pool_max: '数据库最大连接数',
  api_monitor_connection_pool_used: '数据库活跃连接数',
