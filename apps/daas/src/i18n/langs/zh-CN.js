export default {
  ...
  // -- 数据导入导出
  data_import_export_group_management: '分组管理',
  data_import_export_groups: '分组',
  data_import_export_selected: '已选',
  data_import_export_available: '可用资源',
  data_import_export_search_group: '搜索分组...',
  data_import_export_search_name: '搜索名称',
  data_import_export_no_group: '暂无分组',
  data_import_export_no_selected_resource: '暂无选中资源',
  data_import_export_add_group: '新增分组',
  data_import_export_edit_group: '编辑分组',
  data_import_export_delete_group: '删除分组',
  data_import_export_delete_group_confirm: '确定要删除分组"{name}"吗？',
  data_import_export_delete_confirm_title: '删除确认',
  data_import_export_group_name_required: '分组名称不能为空',
  data_import_export_group_name_placeholder: '请输入分组名称',
  ...
  data_import_export_select_group_tip: '请选择一个分组',
  ...
  data_import_export_click_group_to_view: '请在左侧点击分组查看资源',
