export default {
  ...
  daas_external_storage_list_querenshanchuwai: '确认删除外存？',
  daas_external_storage_list_qingshurucunchu: '请输入存储路径',
  daas_external_storage_list_qingshuruwaicun: '请输入外存名称',
