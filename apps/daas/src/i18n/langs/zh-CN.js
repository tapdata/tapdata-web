export default {
  ...
  connection_form_dameng_database_owner_tip: '逗号分隔的表达式列表，用*表示任意长度的任意字符',
  connection_form_hazecast_options_target_tips: "connection_form_hazecast_options_target:'Target',",
  connection_form_hazecast_name_rules: '中英文开头, 1-100个字符，包括中英文、数字、下划线、下划线、空格',
  task_form_error_name_Duplicate: '任务名称已存在，请重新输入',
  ask_form_source_type_check: '请选择来源类型',
  migrate_select_connection_tip:
    '如果您还没有添加数据源，请点击添加数据源按钮添加。为了方便您的测试，我们建议数据源的数量至少为2',
  share_list_connection_search: '连接名称搜索',
  share_list_dig_setting: '挖掘设置',
  user_list_activity_error: '激活失败',
  ...
  editor_cell_link_pcb_Fieldsselected: '待选字段ed',
  editor_cell_link_pcb_Selectedfield: '选中字段',
  editor_cell_link_pcb_Moveup: '上移',
  editor_cell_link_pcb_Movedown: '下移',
  editor_cell_link_pcb_Notmoveuptip: '没有上移空间',
  editor_cell_link_pcb_Notmovedowntip: '没有下移空间',
  editor_cell_link_pcb_Onlyonepiece: '只能选择一条数据上移和down',
  dataForm_error_connectionurl: '连接名已经存在。',
  relations_field: '字段',
  relations_attributes: '属性',
  dialog_jobSchedule_runDay: '每天2点运行',
  guide_task_type_custom_tips:
    '数据同步侧重于表级数据处理和传输，满足用户需求实现多表（数据集）、多级数据之间的多表集成、数据拆分、关联映射、字段增减合并、内容过滤、数据实时同步聚合处理JS处理等功能。在不影响用户业务的情况下，满足用户对远程或本地数据容灾、跨实例数据同步、查询报表分发、实时数仓管理等多种业务场景的需求。 ',
