export default {
  ...
  menu_title_connections: '连接管理',
  menu_title_dataSync: 'Data synchronization',
  menu_title_dataTransmission: '数据管道',
  menu_title_dataFlows: 'Data collection',
  menu_title_dataFlowsAll: 'All tasks',
  menu_title_dataFlowsRunning: 'Running tasks',
  menu_title_dataFlowsError: 'Error task',
  menu_title_dataFlowsPaused: 'Paused task',
  menu_title_dataFlowsDraft: 'Editing tasks',
  menu_title_dataGovernance: 'Data Governance',
  menu_title_metadataDefinition: 'Metadata management',
  menu_title_metadata: '元数据管理',
  menu_title_metadataSearch: 'Metadata search',
  menu_title_dataQuality: 'Data Quality',
  menu_title_timeToLive: 'Life cycle management',
  menu_title_dataMap: 'Data Map',
  menu_title_dataRules: 'Data Rules',
  menu_title_dictionary: 'dictionary template',
  menu_title_dataPublish: 'Data Publish',
  menu_title_modules: 'API Release',
  menu_title_dataExplorer: 'API Data Explorer',
  menu_title_apiDocAndTest: 'API Documentation and Test',
  menu_title_apiAnalysis: 'API Statistical Analysis',
  menu_title_applications: 'API Client',
  menu_title_apiServers: 'API Servers',
  menu_title_dataCollect: 'Data collection (old version)',
  menu_title_system: '系统管理',
  menu_title_tasks: 'Scheduling tasks',
  menu_title_taskHistories: 'Scheduling History',
  menu_title_agentdownload: 'Agent download',
  menu_title_clusterManagement: 'Cluster Management',
  menu_title_agentManagement: 'Agent Management',
  menu_title_agents: 'Process management',
  menu_title_serversOversee: 'Operation and maintenance',
  menu_title_users: 'User Management',
  menu_title_journal: 'User operation log',
  menu_title_roles: 'Roles management',
  menu_title_settings: 'System Settings',
  menu_title_favorite: 'My Favorites',
  menu_title_dataVerification: '数据校验',
  menu_title_delFavMenu: 'Delete Favorites',
  menu_title_license: 'License management',
  menu_title_licenseBefore: 'Reminder: License remaining',
  menu_title_licenseAfter: 'days expires',
  menu_title_licenseAfterOneDay: 'days expires',
  menu_title_licenseDate: 'license expiration time',
  menu_title_dataFlowsCustom: '数据开发',
  menu_title_dataFlowsClusterClone: '数据复制',
  menu_title_topology: 'Network topology',
  menu_title_sharedMining: '共享挖掘',
  menu_title_connection: '连接管理',
  menu_title_data_pipeline: '数据管道',
  menu_title_data_copy: '数据复制',
  menu_title_data_develop: '数据开发',
  menu_title_data_find: '数据发现',
  menu_title_data_catalogue: '数据目录',
  menu_title_data_search: '数据搜索',
  menu_title_data_service: '数据服务',
  menu_title_api_publish: 'API发布',
  menu_title_api_browse: 'API浏览',
  menu_title_api_test: 'API测试',
  menu_title_api_statistics: 'API统计',
  menu_title_api_audit: 'API审计',
  menu_title_api_monitor: 'API监控',
  menu_title_schedule: '调度任务',
  menu_title_cluster: '集群管理',
  menu_title_process: '进程管理',
  menu_title_user: '用户管理',
  menu_title_role: '角色管理',
  menu_title_setting: '系统设置',
