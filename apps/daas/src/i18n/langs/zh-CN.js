export default {
  ...
  task_info_table_number: '计划全量同步表数量',
  task_info_completed: '已完成全量同步表数量',
  ...
  role_page_function_manager: '函数管理',
  role_page_custom_node: '自定义节点模块',
  role_page_shared_cache: '共享缓存',
  role_page_data_search: '数据搜索',
