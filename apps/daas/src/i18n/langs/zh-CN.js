export default {
  ...
  ai_assistant_one_chat_demo: '单会话演示',
  ai_assistant_remote: '已连接',
  ai_assistant_demo: 'Demo 模式',
  ai_assistant_llm_config: 'LLM 配置',
  ai_assistant_empty_title: '今天想让 TapData 做什么？',
  ai_assistant_prompt_create_connection: '创建一个 MySQL 连接',
  ai_assistant_prompt_create_task: '基于连接创建复制任务',
  ai_assistant_prompt_preview_table: '查看 user 表数据',
  ai_assistant_sample_user:
    '创建一个 MySQL 连接 demo_mysql，然后预览 user 表的数据。',
  ai_assistant_result_connection: '连接',
  ai_assistant_result_task: '任务',
  ai_assistant_result_table: '表',
  ai_assistant_result_model: '模型',
  ai_assistant_open_table: '打开表',
  ai_assistant_open_new_tab: '新标签页打开',
  ai_assistant_reply_placeholder: 'Reply...',
  ai_assistant_skills: 'Skills',
  ai_assistant_config_storage_tip: 'Demo 阶段配置保存在本地浏览器。',
  ai_assistant_base_url: 'Base URL',
  ai_assistant_auth_token: 'API Key',
  ai_assistant_model: 'Model',
  ai_assistant_worked_seconds: '已处理 {0}s',
  ai_assistant_tool_call_start: '调用工具 {0}',
  ai_assistant_tool_call_result: '工具 {0} 返回成功',
  ai_assistant_tool_status_running: '调用中',
  ai_assistant_tool_status_success: '已完成',
  ai_assistant_tool_status_error: '失败',
  ai_assistant_tool_result_count: '{0} 个结果',
  ai_assistant_error_no_stream: '响应没有可读取的流',
  ai_assistant_empty_response: '请求已完成，但没有收到内容。',
  ai_assistant_error_response: '请求失败：{0}',
  ai_assistant_error_send: '发送失败',
