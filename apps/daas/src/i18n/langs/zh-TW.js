export default {
  ...
  connection_form_dameng_database_owner_tip: '逗號分隔的表達式列表，用*表示任意長度的任意字符',
  connection_form_hazecast_options_target_tips: "connection_form_hazecast_options_target:'Target',",
  connection_form_hazecast_name_rules: '中英文開頭, 1-100個字符，包括中英文、數字、下劃線、下劃線、空格',
  task_form_error_name_Duplicate: '任務名稱已存在，請重新輸入',
  ask_form_source_type_check: '請選擇來源類型',
  migrate_select_connection_tip:
    '如果您還沒有添加數據源，請點擊添加數據源按鈕添加。為了方便您的測試，我們建議數據源的數量至少為2',
  share_list_connection_search: '連接名稱搜索',
  share_list_dig_setting: '挖掘設置',
  user_list_activity_error: '激活失敗',
  ...
  editor_cell_link_pcb_Fieldsselected: '待選字段ed',
  editor_cell_link_pcb_Selectedfield: '選中字段',
  editor_cell_link_pcb_Moveup: '上移',
  editor_cell_link_pcb_Movedown: '下移',
  editor_cell_link_pcb_Notmoveuptip: '沒有上移空間',
  editor_cell_link_pcb_Notmovedowntip: '沒有下移空間',
  editor_cell_link_pcb_Onlyonepiece: '只能選擇一條數據上移和down',
  dataForm_error_connectionurl: '連接名已經存在。',
  relations_field: '字段',
  relations_attributes: '屬性',
  dialog_jobSchedule_runDay: '每天2點運行',
  guide_task_type_custom_tips:
    '數據同步側重於表級數據處理和傳輸，滿足用戶需求實現多表（數據集）、多級數據之間的多表集成、數據拆分、關聯映射、字段增減合併、內容過濾、數據實時同步聚合處理JS處理等功能。在不影響用戶業務的情況下，滿足用戶對遠程或本地數據容災、跨實例數據同步、查詢報表分發、實時數倉管理等多種業務場景的需求。 ',
