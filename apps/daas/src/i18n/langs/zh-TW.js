export default {
  ...
  page_title_ai_assistant: 'AI Assistant',
  ai_assistant_one_chat_demo: '單會話演示',
  ai_assistant_remote: '已連接',
  ai_assistant_demo: 'Demo 模式',
  ai_assistant_llm_config: 'LLM 配置',
  ai_assistant_empty_title: '今天想讓 TapData 做什麼？',
  ai_assistant_prompt_create_connection: '創建一個 MySQL 連接',
  ai_assistant_prompt_create_task: '基於連接創建複製任務',
  ai_assistant_prompt_preview_table: '查看 user 表數據',
  ai_assistant_sample_user:
    '創建一個 MySQL 連接 demo_mysql，然後預覽 user 表的數據。',
  ai_assistant_result_connection: '連接',
  ai_assistant_result_task: '任務',
  ai_assistant_result_table: '表',
  ai_assistant_result_model: '模型',
  ai_assistant_open_table: '打開表',
  ai_assistant_open_new_tab: '在新標籤頁打開',
  ai_assistant_reply_placeholder: 'Reply...',
  ai_assistant_skills: 'Skills',
  ai_assistant_config_storage_tip: 'Demo 階段配置保存在本地瀏覽器。',
  ai_assistant_base_url: 'Base URL',
  ai_assistant_auth_token: 'API Key',
  ai_assistant_model: 'Model',
  ai_assistant_worked_seconds: '已處理 {0}s',
  ai_assistant_tool_call_start: '調用工具 {0}',
  ai_assistant_tool_call_result: '工具 {0} 返回成功',
  ai_assistant_tool_status_running: '調用中',
  ai_assistant_tool_status_success: '已完成',
  ai_assistant_tool_status_error: '失敗',
  ai_assistant_tool_result_count: '{0} 個結果',
  ai_assistant_error_no_stream: '響應沒有可讀取的流',
  ai_assistant_empty_response: '請求已完成，但沒有收到內容。',
  ai_assistant_error_response: '請求失敗：{0}',
  ai_assistant_error_send: '發送失敗',
