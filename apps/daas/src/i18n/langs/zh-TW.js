export default {
  ...
  task_info_table_number: '計劃全量同步表數量',
  task_info_completed: '已完成全量同步表數量',
  ...
  role_page_log_collector: '共享挖掘',
  role_page_function_manager: '函數管理',
  role_page_custom_node: '自定義節點',
  role_page_shared_cache: '共享緩存',
  role_page_data_search: '數據搜索',
  ...
  role_module_meun_shared_cache: '共享挖掘',
