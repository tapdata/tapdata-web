export default {
  ...
  page_title_exception_events: '異常事件',
  ...
  page_title_workflow: '工作流',
  page_title_workflow_create: '創建工作流',
  page_title_workflow_edit: '編輯工作流',
  page_title_workflow_runs: '工作流運行記錄',
  page_title_workflow_run_detail: '工作流運行詳情',
  ...
  page_title_data_import_export: '項目導入導出',
  page_title_project_management: '項目管理',

  // -- 數據導入導出
  data_import_export_group_management: '項目管理',
  data_import_export_groups: '項目',
  data_import_export_selected: '已選',
  data_import_export_available: '可用資源',
  data_import_export_search_group: '搜索項目...',
  data_import_export_search_name: '搜索名稱',
  data_import_export_no_group: '暫無項目',
  data_import_export_no_selected_resource: '暫無選中資源',
  data_import_export_add_group: '新增項目',
  data_import_export_edit_group: '編輯項目',
  data_import_export_delete_group: '刪除項目',
  data_import_export_delete_group_confirm: '確定要刪除項目"{name}"嗎？',
  data_import_export_delete_confirm_title: '刪除確認',
  data_import_export_group_name_required: '項目名稱不能為空',
  data_import_export_group_name_placeholder: '請輸入項目名稱',
  data_import_export_select_all_available: '全選可用',
  data_import_export_add_selected: '添加已選',
  data_import_export_remove_selected: '移除',
  data_import_export_clean_nonexistent: '清理不存在',
  data_import_export_nonexistent: '不存在',
  data_import_export_items: '項',
  data_import_export_select_group_tip: '請選擇一個項目',
  data_import_export_sync_task: '開發任務',
  data_import_export_migrate_task: '複製任務',
  data_import_export_module: '模塊',
  data_import_export_import: '導入',
  data_import_export_export: '導出',
  data_import_export_importing: '導入中',
  data_import_export_exporting: '導出中',
  data_import_export_completed: '已完成',
  data_import_export_failed: '失敗',
  data_import_export_operator: '操作人',
  data_import_export_operation_time: '操作時間',
  data_import_export_view_detail: '查看詳情',
  data_import_export_record_detail: '記錄詳情',
  data_import_export_import_record_detail: '導入記錄詳情',
  data_import_export_export_record_detail: '導出記錄詳情',
  data_import_export_resource_preview: '資源預覽',
  data_import_export_click_group_to_view: '請在左側點擊項目查看資源',
  data_import_export_resource_count: '個資源',
  data_import_export_action_imported: '已導入',
  data_import_export_action_exported: '已導出',
  data_import_export_action_replaced: '已替換',
  data_import_export_action_no_update: '無需更新',
  data_import_export_action_importing: '導入中',
  data_import_export_action_errored: '錯誤',
  data_import_export_action_skipped: '已跳過',
  data_import_export_import_group: '導入項目',
  data_import_export_export_group: '導出項目',
  data_import_export_select_group: '選擇項目',
  data_import_export_rerun: '重跑',
  data_import_export_git_config: 'Git 配置',
  data_import_export_git_repo_type: '倉庫類型',
  data_import_export_git_repo_url: '倉庫地址',
  data_import_export_git_repo_url_required: '倉庫地址不能為空',
  data_import_export_git_token: 'Token',
  data_import_export_git_token_placeholder: '請輸入 Personal Access Token',
  data_import_export_git_username: '用戶名',
  data_import_export_git_username_placeholder: '請輸入用戶名',
  data_import_export_git_password: '密碼',
  data_import_export_git_password_placeholder: '請輸入密碼',
  ...
  dashboard_odh_cpu_usage: '引擎 CPU 使用率',
  dashboard_odh_memory_usage: '引擎記憶體使用率',
  ...
  apiaudit_overview: '概覽',
  apiaudit_phase: '階段',
  apiaudit_duration: '耗時',
  apiaudit_phase_api: 'API 處理',
  apiaudit_phase_db: '資料庫執行',
  apiaudit_phase_response: '響應生成',
  apiaudit_total: '總計',
  apiaudit_execution_window: '執行時間視窗',
  apiaudit_response_size: '響應大小',
  apiaudit_total_time: '總耗時',
  apiaudit_api_time: 'API 耗時',
  apiaudit_db_time: '資料庫耗時',
  apiaudit_match_rows: '匹配行數',
  apiaudit_return_rows: '回傳行數',
  apiaudit_visitor_ip: '訪問 IP',
  // 連接
  ...
  audit_log: '審計日誌',
  audit_event_type: '事件類型',
  audit_event_login: '登入事件',
  audit_event_admin: '管理員操作',
  audit_event_config: '設定變更',
  audit_event_service: '服務生命週期',
  audit_event_other: '其他用戶操作',
  audit_outcome: '結果',
  audit_outcome_success: '成功',
  audit_outcome_failure: '失敗',
  audit_user_id: 'User ID',
  audit_keyword: '按動作、對象、失敗原因等關鍵字搜尋',
  audit_source_ip: '來源 IP',
  audit_time: '操作時間',
  audit_action: '動作',
  audit_object: '對象',
  audit_detail: '詳情',
  audit_failure_reason: '失敗原因',
  audit_login_failure_credential_parse: '登入憑證格式無效',
  audit_login_failure_external_identity: '外部身分驗證失敗',
  audit_login_failure_credentials: '帳號或密碼不正確',
  audit_login_failure_pending_approval: '使用者帳號待審核',
  audit_login_failure_user_disabled: '使用者帳號已停用',
  audit_login_failure_too_many_attempts: '登入失敗次數過多，請稍後再試',
  audit_service_failure_abnormal_stop_detected: '偵測到服務異常停止',
  audit_service_failure_abnormal_stop_handling: '服務異常停止處理失敗',
  audit_service_failure_operation: '服務操作失敗',
  audit_service_failure_cluster_node_not_found: '找不到符合的叢集節點',
  audit_service_failure_cluster_operation: '叢集服務操作失敗',
  audit_service_failure_stop: '服務停止失敗',
  audit_service_failure_status_update: '服務狀態更新失敗',
  audit_connection_failure_test: '連線測試失敗',
  audit_connection_failure_load_schema: '模型載入失敗',
  audit_connection_failure_agent_unavailable: '沒有可用的計算節點',
  audit_change_summary: '變更摘要',
  audit_service_node: '服務節點',
  audit_event_id: '事件 ID',
  audit_login_method: '登入方式',
  audit_message_user: '用戶',
  audit_message_action: '執行了',
  audit_action_login_system: '登入了系統',
  audit_action_logout_system: '退出了系統',
  audit_action_save: '儲存了',
  audit_action_create_user: '建立了用戶',
  audit_action_update_user: '更新了用戶',
  audit_action_disable_user: '停用了用戶',
  audit_action_enable_user: '啟用了用戶',
  audit_action_grant_role: '授予了使用者',
  audit_action_revoke_role: '撤銷了使用者',
  audit_action_test_connection: '測試了連線',
  audit_action_load_schema: '載入了連線模型',
  audit_role: '角色',
  audit_action_abnormal_stop: '偵測到服務異常停止',
  audit_action_restart_service: '重啟了',
  audit_cluster_api_server: 'API Server',
  audit_cluster_custom_component: '服務監控（{componentType}）',
  audit_cluster_component_instance: '{component}（{instance}）',
  audit_system_configuration: '系統設定',
  audit_alarm_configuration: '告警設定',
  audit_copy_as: '為',
  audit_unknown: '未知',
  audit_unauthenticated: '未認證',
  audit_unavailable: '不可用',
  daas_cluster_cluster_lianjieshuliang: '連接數量',
  daas_cluster_cluster_lianjieshuliang_detail: '對外建立連結數詳情',
  daas_cluster_cluster_mubiaoIPhe: '目標IP和端口',
  daas_cluster_cluster_lianjiezongshu: '引擎 TCP 連接總數',
  ...
  daas_role_role_no_matching_module: '沒有匹配的模塊',
  ...
  daas_cluster_cluster_lianjieshuliang_detail: '引擎 TCP 連接',
  daas_cluster_cluster_view: '集群視圖',
  daas_cluster_component_view: '組件視圖',
  daas_cluster_engine_hostname: '主機名/IP',
  daas_cluster_connection_count: 'TCP 連接數',
  daas_cluser_keyword_placeholder: '搜索主機名',
  daas_task_rebalance_button: '任務調度均衡',
  daas_task_rebalance_title: '任務均衡方案',
  daas_task_rebalance_subtitle: '拖動任務卡片到目標引擎，調整各引擎的任務分佈',
  daas_task_rebalance_online: '在線',
  daas_task_rebalance_offline: '離線',
  daas_task_rebalance_memory: '內存使用率',
  daas_task_rebalance_task_count: '任務數',
  daas_task_rebalance_legend_move: '將被調走的任務',
  daas_task_rebalance_legend_locked: '不可均衡的任務',
  daas_task_rebalance_cancel: '取消',
  daas_task_rebalance_confirm: '確認均衡',
  daas_task_rebalance_create: '創建均衡',
  daas_task_rebalance_empty: '暫無可均衡的任務',
  daas_task_rebalance_create_success: '均衡方案已創建，開始執行任務遷移',
  ...
  daas_task_rebalance_reason_manual_agent: '已指定固定引擎，無法遷移',
  daas_task_rebalance_reason_incremental: '全量同步中，無法遷移',
  daas_task_rebalance_history_title: '任務均衡記錄',
  daas_task_rebalance_history_list_title: '歷史記錄',
  daas_task_rebalance_history_empty: '暫無均衡記錄',
  daas_task_rebalance_history_empty_desc: '任務均衡後記錄將顯示在這裡',
  daas_task_rebalance_history_detail_empty: '請在左側選擇一條記錄',
  daas_task_rebalance_history_task_total: '{count} 個任務',
  daas_task_rebalance_history_record_creating: '創建中',
  daas_task_rebalance_history_record_running: '執行中',
  daas_task_rebalance_history_record_done: '已完成',
  daas_task_rebalance_history_record_partial: '部分完成',
  daas_task_rebalance_history_record_cancelled: '已取消',
  daas_task_rebalance_history_record_failed: '失敗',
  daas_task_rebalance_history_job_pending: '等待中',
  daas_task_rebalance_history_job_starting: '啟動中',
  daas_task_rebalance_history_job_stopping: '停止中',
  daas_task_rebalance_history_job_ok: '已完成',
  daas_task_rebalance_history_job_cancelled: '已取消',
  daas_task_rebalance_history_job_invalid_agent: '引擎不可用',
  daas_task_rebalance_history_job_status_error: '狀態異常',
  daas_task_rebalance_history_job_stop_timeout: '停止超時',
  daas_task_rebalance_history_job_start_timeout: '啟動超時',
  daas_task_rebalance_history_job_failed: '失敗',
  daas_task_rebalance_history_stat_success: '成功',
  daas_task_rebalance_history_stat_failed: '失敗',
  daas_task_rebalance_history_stat_skipped: '跳過',
  daas_task_rebalance_history_stat_running: '運行中',
  daas_task_rebalance_history_stat_pending: '等待中',
  daas_task_rebalance_history_col_task: '任務名稱',
  daas_task_rebalance_history_col_source: '源引擎',
  daas_task_rebalance_history_col_target: '目標引擎',
  daas_task_rebalance_history_col_status: '狀態',
  daas_task_rebalance_history_col_error: '錯誤原因',
  daas_task_rebalance_history_col_action: '操作',
  daas_task_rebalance_history_cancel: '取消',
  daas_task_rebalance_history_cancel_remaining: '取消剩餘任務',
  daas_task_rebalance_history_cancel_remaining_confirm:
    '確定取消剩餘 {count} 個等待中的任務嗎？此操作不可撤銷。',
  daas_task_rebalance_history_cancel_success: '任務已取消',
  daas_task_rebalance_history_cancel_remaining_success: '已取消 {count} 個任務',
  daas_task_rebalance_history_progress: '執行進度',
  page_title_task_rebalance: '任務均衡',
...
{'}'}`,
  ...
  api_monitor_server_title: 'API 服務器監控',
  api_monitor_server_detail_title: '服務器詳細監控信息',
  api_monitor_server_rps_title: 'RPS 統計',
  api_monitor_server_rps_title_unit: '請求/秒',
  api_monitor_server_error_rate_title: '錯誤率統計',
  api_monitor_server_response_time_title: '請求延時分位數',
  api_monitor_server_api_calls_title: 'API 調用統計',
  api_monitor_server_api_name: 'API 名稱',
  api_monitor_server_call_count: '調用次數',
  api_monitor_server_failure_count: '失敗次數',
  api_monitor_server_failure_rate: '失敗率',
  api_monitor_server_recent_10_minutes: '最近10分鐘',
  api_monitor_server_recent_30_minutes: '最近30分鐘',
  api_monitor_server_recent_1_hour: '最近1小時',
  api_monitor_server_recent_1_day: '最近1天',
  ...
  api_monitor_api_path: 'API 路徑',
  api_monitor_total_calls: '總調用數',
  api_monitor_avg_latency: '平均耗時',
  api_monitor_p95_latency: 'P95 延遲',
  ...
  // 時間範圍選擇器
  api_monitor_time_range_5m: '最近5分鐘',
  api_monitor_time_range_15m: '最近15分鐘',
  api_monitor_time_range_1h: '最近1小時',
  api_monitor_time_range_6h: '最近6小時',
  api_monitor_time_range_12h: '最近12小時',
  api_monitor_time_range_24h: '最近24小時',
  api_monitor_time_range_7d: '最近7天',
  api_monitor_time_range_14d: '最近14天',
  api_monitor_time_range_30d: '最近30天',
  api_monitor_time_range_custom: '自定義時間',
  api_monitor_time_range_placeholder: '選擇時間範圍',
  api_monitor_time_range_start: '開始時間',
  api_monitor_time_range_end: '結束時間',
  api_monitor_time_range_to: '至',
  api_monitor_time_range_max_30_days: '自定義時間範圍不能超過30天',

  // API 詳情頁
  api_monitor_api_detail_title: 'API 詳情',
  api_monitor_server_distribution: '各 Server 表現分佈',
  ...
  api_monitor_connection_pool: '資料庫連接池使用情況',
  api_monitor_connection_pool_max: '資料庫最大連線數',
  api_monitor_connection_pool_used: '資料庫活躍連線數',
  ...
  api_monitor_memory_usage_trend: '記憶體使用率 (%)',
  api_monitor_request_error_trend: '請求數 & 錯誤率趨勢',
  api_monitor_latency_trend: '延遲趨勢 (Avg/P95/P99)',
  api_monitor_top_api_list: 'Top API 列表',
  api_monitor_worker_diagnosis: 'Worker 資源診斷',
  api_monitor_cpu_distribution: 'CPU 分佈：最小值 {min}% ~ 最大值 {max}%',
  api_monitor_worker_name: 'Worker 名稱',
  api_monitor_worker_cpu_usage: 'Worker CPU 使用率',
  api_monitor_worker_memory_usage: 'Worker 記憶體使用率',
  api_monitor_no_worker_data: '暫無 Worker 數據',
