export default {
  ...
  page_title_data_import_export: '數據導入導出',

  // -- 數據導入導出
  data_import_export_group_management: '分組管理',
  data_import_export_groups: '分組',
  data_import_export_selected: '已選',
  data_import_export_available: '可用資源',
  data_import_export_search_group: '搜索分組...',
  data_import_export_search_name: '搜索名稱',
  data_import_export_no_group: '暫無分組',
  data_import_export_no_selected_resource: '暫無選中資源',
  data_import_export_add_group: '新增分組',
  data_import_export_edit_group: '編輯分組',
  data_import_export_delete_group: '刪除分組',
  data_import_export_delete_group_confirm: '確定要刪除分組"{name}"嗎？',
  data_import_export_delete_confirm_title: '刪除確認',
  data_import_export_group_name_required: '分組名稱不能為空',
  data_import_export_group_name_placeholder: '請輸入分組名稱',
  ...
  data_import_export_select_group_tip: '請選擇一個分組',
  ...
  data_import_export_click_group_to_view: '請在左側點擊分組查看資源',
