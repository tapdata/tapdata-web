export default {
  ...
  webhook_custom_template_tip: `{
    ...
    "actionData": {
        ...
        "component":"\${actionData.component}",//引擎告警組件固定為引擎FE
        "type":"\${actionData.type}",//告警類型 同步任務告警、共享緩存告警、共享挖掘告警、數據校驗告警、精准延遲告警
  ...
  webhook_custom_template_ph: '自定義模板內容，支持參數填充模板，如：${alarm.name}',
